 ...
 */let me=class extends ae{#c=!1;get isopen(){return this.#c}set isopen(t){this.#c=t}#a=-1;get selected(){return this.#a}set selected(t){this.#a=t}filtered=[];toField(){}toValue(){this.selected>=0&&(this.value=this.filtered[this.selected].value)}focusout(t){super.focusout(t)}alignFromValue(){if(this.queryElem)if($t(this.value)||$t(this.enums))this.queryElem.value="",this.selected=-1;else{const t=this.enums.find((t=>t.value==this.value));this.queryElem.value=t?t.title:"",this.selected=t?0:-1}else this.selected=-1}firstUpdated(t){super.firstUpdated(t),this.alignFromValue()}renderEnum(){if(this.enums==ne)return Y`
            ...
            </div>`}rgbaToHex(t){const e=t.match(be);if(!e)throw new Error("Invalid RGBA format");const[,s,i,r,n]=e.map(Number),o=t=>{const e=t.toString(16);return 1===e.length?"0"+e:e};return`#${`${o(s)}${o(i)}${o(r)}`}`}async eyedropper(){this.eventStop();try{const t=new window.EyeDropper,e=await t.open(),s=this.rgbaToHex(e.sRGBHex);this.value=s}catch(t){}}};ge=t([e("fz-color")],ge);
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const $e=t=>t??Q;let ve=class extends re{toField(){if(gt(this.input)){const t=/\d\d\d\d-\d\d-\d\d/;this.input.valueAsDate=t.test(this.value)?new Date(this.value):null}}toValue(){gt(this.input)&&(this.value=gt(this.input.valueAsDate)?function(t=new Date){return t.toISOString().substring(0,10)}(this.input.valueAsDate):void 0)}renderInput(){return Y`<input
        ...
        />`}get min(){return this.schema?.minimum}get max(){return this.schema?.maximum}};ye=t([e("fz-datetime")],ye);let we=class extends re{toField(){gt(this.input)&&(this.input.valueAsDate=new Date(this.value))}toValue(){gt(this.input)&&(this.value=gt(this.input.valueAsDate)?function(t=new Date){return t.toISOString().substring(11,19)}(this.input.valueAsDate):void 0)}renderInput(){return Y`
            ...
            <textarea  
                ...
                rows="5"
                class="form-control ${this.validation}" 
            ></textarea>`}get minlength(){return this.schema?.minLength}get maxlength(){return this.schema?.maxLength}get pattern(){return this.schema?.pattern}};xe=t([e("fz-textarea")],xe);let ke=class extends re{static get styles(){return[...super.styles,a`
            input[type="color"] {
                height: 38px
        ...
        `}tryChange(t){this.readonly?t.preventDefault():this.change()}toField(){if(!$t(this.input))if(!0===wt(this.value))this.input.indeterminate=!1,this.input.checked=this.value;else this.input.indeterminate=!0,this.input.checked=!1}toValue(){$t(this.input)||(this.input.indeterminate?this.value=this.schema.nullAllowed?null:void 0:this.value=!!this.input.checked)}};_e=t([e("fz-boolean")],_e);let Ee=class extends re{static get styles(){return[...super.styles,a`
            ...
            }`]}toField(){if(gt(this.input))if(yt(this.value)){if(this.input.valueAsNumber===this.value)return;this.input.valueAsNumber=this.value}else this.input.value=""}toValue(){gt(this.input)&&(this.value=yt(this.input.valueAsNumber)?this.input.valueAsNumber:void 0)}renderInput(){return Y`
            <div class="input-group">
                <input 
                    id="input"
                    type="number" 
                    ...
                    class="form-control ${this.validation}" 
                />
            </div>`}get max(){return yt(this.schema?.maximum)?this.schema.maximum:yt(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return yt(this.schema?.minimum)?this.schema.minimum:yt(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}keypress(t){}get step(){return yt(this.schema.multipleOf)?this.schema.multipleOf:void 0}};Ee=t([e("fz-float")],Ee);let Oe=class extends re{toField(){gt(this.input)&&(this.input.valueAsNumber=yt(this.value)?Math.floor(this.value):NaN)}toValue(){gt(this.input)&&(this.value=yt(this.input.valueAsNumber)?this.input.valueAsNumber:void 0)}static get styles(){return[...super.styles,a`
          ...
          `]}renderInput(){return Y`
            ...
            </div>`}get max(){return yt(this.schema?.maximum)?this.schema.maximum:yt(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return yt(this.schema?.minimum)?this.schema.minimum:yt(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}};Oe=t([e("fz-range")],Oe);let Ie=class extends re{watchId;toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=gt(this.input.value)?this.input.value:void 0)}static get styles(){return[...super.styles,a`
            input[type="color"] {
                height: 38px
            }`]}renderInput(){return Y`
            <div class="input-group ${this.validation}">
            ...
            <div class="input-group">
                <input 
                    ...
                    autocomplete=off  spellcheck="false"
                />
            </div>`}get max(){return yt(this.schema?.maximum)?this.schema.maximum:yt(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return yt(this.schema?.minimum)?this.schema.minimum:yt(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}keypress(t){}get step(){return yt(this.schema.multipleOf)?this.schema.multipleOf:1}};Ce=t([e("fz-integer")],Ce);let je=class extends re{toField(){gt(this.input)&&(this.input.value=String(this.schema.const??""))}toValue(){this.value=this.schema.const}renderInput(){return Y`<div class="input-group ${this.validation}">${this.value}</div>`}connectedCallback(){super.connectedCallback(),this.value!==this.schema.const&&(this.value=this.schema.const)}};je=t([e("fz-const")],je);const Ae=[];for(let t=0;t<256;++t)Ae.push((t+256).toString(16).slice(1));let Fe;const Ne=new Uint8Array(16);const Me={};function Re(t,e,s){let i;{const t=Date.now(),r=function(){if(!Fe){if("undefined"==typeof crypto||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");Fe=crypto.getRandomValues.bind(crypto)}return Fe(Ne)}();!function(t,e,s){t.msecs??=-1/0,t.nsecs??=0,e===t.msecs?(t.nsecs++,t.nsecs>=1e4&&(t.node=void 0,t.nsecs=0)):e>t.msecs?t.nsecs=0:e<t.msecs&&(t.node=void 0);t.node||(t.node=s.slice(10,16),t.node[0]|=1,t.clockseq=16383&(s[8]<<8|s[9]));t.msecs=e}(Me,t,r),i=function(t,e,s,i,r,n,o=0){if(t.length<16)throw new Error("Random bytes length must be >= 16");if(n){if(o<0||o+16>n.length)throw new RangeError(`UUID byte range ${o}:${o+15} is out of buffer bounds`)}else n=new Uint8Array(16),o=0;e??=Date.now(),s??=0,i??=16383&(t[8]<<8|t[9]),r??=t.slice(10,16);const a=(1e4*(268435455&(e+=122192928e5))+s)%4294967296;n[o++]=a>>>24&255,n[o++]=a>>>16&255,n[o++]=a>>>8&255,n[o++]=255&a;const h=e/4294967296*1e4&268435455;n[o++]=h>>>8&255,n[o++]=255&h,n[o++]=h>>>24&15|16,n[o++]=h>>>16&255,n[o++]=i>>>8|128,n[o++]=255&i;for(let t=0;t<6;++t)n[o++]=r[t];return n}(r,Me.msecs,Me.nsecs,Me.clockseq,Me.node,e,s)}return e??function(t,e=0){return(Ae[t[e+0]]+Ae[t[e+1]]+Ae[t[e+2]]+Ae[t[e+3]]+"-"+Ae[t[e+4]]+Ae[t[e+5]]+"-"+Ae[t[e+6]]+Ae[t[e+7]]+"-"+Ae[t[e+8]]+Ae[t[e+9]]+"-"+Ae[t[e+10]]+Ae[t[e+11]]+Ae[t[e+12]]+Ae[t[e+13]]+Ae[t[e+14]]+Ae[t[e+15]]).toLowerCase()}(i)}var Ue;let Te=class extends re{static{Ue=this}toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=gt(this.input.value)?this.input.value:void 0)}static docTypes=["image/png","image/jpeg","image/gif","text/plain","application/pdf","application/msword","application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/vnd.ms-excel","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","application/vnd.ms-powerpoint","application/vnd.openxmlformats-officedocument.presentationml.presentation","application/vnd.oasis.opendocument.text","application/vnd.oasis.opendocument.spreadsheet","application/vnd.oasis.opendocument.presentation","application/vnd.oasis.opendocument.graphics"];photoModal;url="";filename;get hasPreview(){return!!this.schema.preview}get mimetype(){return this.schema.mimetype?this.schema.mimetype:Ue.docTypes.join(", ")}get store(){return this.form.store}static get styles(){return[...super.styles,a`
                .fileUpload {
                    position: relative;
                    overflow: hidden;
                    margin: 0px;
        ...
        `];async firstUpdated(t){super.firstUpdated(t)}render(){if(Le){const t=Le.render(this.markdown);return Y`${de(t)}`}return Y`<div> Loading ...</div>`}static async loadMarkdownIt(t){await async function(t){if($t(Le)&&t){const t=await import("./markdown-dynamic.min.js");Le=new t.default({html:!0,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!0,typographer:!0,quotes:"\"\"''",highlight:function(t,e){return""}}),function(t,e,s,i){const r=t.renderer.rules.table_open||function(t,e,s,i,r){return r.renderToken(t,e,s)};t.renderer.rules[`${e}_open`]=(t,e,n,o,a)=>{const h=t[e],l=h.attrIndex(s);return l<0?h.attrPush([s,i]):h.attrs&&(h.attrs[l][1]+=` ${i}`),r(t,e,n,o,a)}}(Le,"table","class","table table-striped table-responsive"),function(t,e,s){const i=t.renderer.rules.image||function(t,e,s,i,r){return r.renderToken(t,e,s)};t.renderer.rules.image=function(t,r,n,o,a){const h=t[r];return h.attrGet("width")||h.attrSet("width",`${e}`),h.attrGet("height")||h.attrSet("height",`${s}`),i(t,r,n,o,a)}}(Le,100,100)}}(t)}};t([_({attribute:"markdown",type:String,reflect:!0})],De.prototype,"markdown",void 0),De=t([e("markdown-it")],De);let Pe=class extends re{toField(){}toValue(){}renderInput(){return Y``}renderField(){return Y`
            <div class="form-group row ${this.validation}"><markdown-it .markdown="${this.value??""}"></markdown-it></div>
        `}};Pe=t([e("fz-markdown")],Pe);let qe=class extends re{toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=gt(this.input.value)?this.input.value:this.empty)}renderInput(){return Y`
            <div class="input-group">
                <div class="form-control">${this.value}</div>
            </div>`}connectedCallback(){super.connectedCallback(),null==this.value&&(this.value=Re())}};qe=t([e("fz-uuid")],qe);const Ve=["fz-array","fz-enum-array","fz-object","fz-enum-check","fz-enum-select","fz-enum-typeahead","fz-picker","fz-boolean","fz-color","fz-const","fz-date","fz-datetime","fz-doc","fz-float","fz-integer","fz-location","fz-location","fz-mask","fz-markdown","fz-range","fz-signature","fz-string","fz-textarea","fz-time","fz-uuid"].join(",");class We extends se{get fields(){return[...this.shadowRoot?.querySelectorAll(Ve)??[]]}renderLabel(){const t=this.required?"*":"",e=`${this.label}${t}`;return Y`
            <label for="input" class="col-sm-3 col-form-label" @click="${this.labelClicked}">
                <div>${e}</div>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const{I:Je}=pt,Ge=()=>document.createComment(""),Ze=(t,e,s)=>{const i=t._$AA.parentNode,r=void 0===e?t._$AB:e._$AA;if(void 0===s){const e=i.insertBefore(Ge(),r),n=i.insertBefore(Ge(),r);s=new Je(e,n,t,t.options)}else{const e=s._$AB.nextSibling,n=s._$AM,o=n!==t;if(o){let e;s._$AQ?.(t),s._$AM=t,void 0!==s._$AP&&(e=t._$AU)!==n._$AU&&s._$AP(e)}if(e!==r||o){let t=s._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,r),t=e}}}return s},He=(t,e,s=t)=>(t._$AI(e,s),t),Ye={},Xe=t=>{t._$AP?.(!1,!0);let e=t._$AA;const s=t._$AB.nextSibling;for(;e!==s;){const t=e.nextSibling;e.remove(),e=t}},Qe=(t,e,s)=>{const i=new Map;for(let r=e;r<=s;r++)i.set(t[r],r);return i},ts=Qt(class extends te{constructor(t){if(super(t),t.type!==Xt)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;void 0===s?s=e:void 0!==e&&(i=e);const r=[],n=[];let o=0;for(const e of t)r[o]=i?i(e,o):o,n[o]=s(e,o),o++;return{values:n,keys:r}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const r=(t=>t._$AH)(t),{values:n,keys:o}=this.dt(e,s,i);if(!Array.isArray(r))return this.ut=o,n;const a=this.ut??=[],h=[];let l,c,d=0,u=r.length-1,p=0,f=n.length-1;for(;d<=u&&p<=f;)if(null===r[d])d++;else if(null===r[u])u--;else if(a[d]===o[p])h[p]=He(r[d],n[p]),d++,p++;else if(a[u]===o[f])h[f]=He(r[u],n[f]),u--,f--;else if(a[d]===o[f])h[f]=He(r[d],n[f]),Ze(t,h[f+1],r[d]),d++,f--;else if(a[u]===o[p])h[p]=He(r[u],n[p]),Ze(t,r[d],r[u]),u--,p++;else if(void 0===l&&(l=Qe(o,p,f),c=Qe(a,d,u)),l.has(a[d]))if(l.has(a[u])){const e=c.get(o[p]),s=void 0!==e?r[e]:null;if(null===s){const e=Ze(t,r[d]);He(e,n[p]),h[p]=e}else h[p]=He(s,n[p]),Ze(t,r[d],s),r[e]=null;p++}else Xe(r[u]),u--;else Xe(r[d]),d++;for(;p<=f;){const e=Ze(t,h[f+1]);He(e,n[p]),h[p++]=e}for(;d<=u;){const t=r[d++];null!==t&&Xe(t)}return this.ut=o,((t,e=Ye)=>{t._$AH=e})(t,h),X}});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let es=class extends We{static get styles(){return[...super.styles,a`
                ul {
                    max-height: 300px; 
                    overflow-y: scroll
                }
            ...
            </div>`}toggleItem(t){if(null==this.value&&(this.value=[]),this.value.includes(t)){const e=this.value.indexOf(t);e>=0&&this.value.splice(e,1)}else this.value.push(t)}getItems(){const t=this.schema.items?.enum,e=this.data;if(t)return t.reduce(((t,s)=>(this.evalExpr("filter",this.schema.items,s,e[this.key],-1)&&t.push({label:String(s),value:s}),t)),[]);const s=this.schema.items?.oneOf;return s?s.reduce(((t,e)=>(this.evalExpr("filter",e,e.const,this.data[this.key],-1)&&t.push({label:e.title??e.description??e.const,value:e.const}),t)),[]):[]}};es=t([e("fz-enum-array")],es);let ss=class extends Dt{modal;backdrop;validable=!1;#m="Dialogue";get modalTitle(){return this.#m}set modalTitle(t){this.#m=t}#b="Valider";get okLabel(){return this.#b}set okLabel(t){this.#b=t}#g="Annuler";get dismissLabel(){return this.#g}set dismissLabel(t){this.#g=t}static get styles(){return[...super.styles,a`
            .modal-body {
            ...
            `}stopEvent(t){t.preventDefault(),t.stopPropagation()}close(t){this.video&&(this.video?.pause(),this.video.srcObject=null);const e=t.detail;t.detail.dismissed||(t.detail.code=this.code),this.dispatchEvent(new CustomEvent("close",{detail:e})),this.modal?.valid(!1)}firstUpdated(){BarcodeDetector&&(this.detector=new BarcodeDetector({formats:rs})),this.modal=this.shadowRoot?.querySelector("fz-dialog"),this.video=this.shadowRoot?.querySelector("video"),this.video&&this.listen(this.video,"play",(t=>this.scan()))}async initCamera(){try{const t=await navigator.mediaDevices.getUserMedia({video:{facingMode:{exact:"environment"}}});this.video&&(this.video.srcObject=t)}catch(t){this.status=`Unable to initialize Camera : ${String(t)}`}}scan(){this.setState(is.scanning);const t=async()=>{try{(await this.detector.detect(this.video)).filter((t=>t.rawValue)).forEach((t=>{this.code=t.rawValue,this.setState(is.done)}))}catch(t){}},e=()=>{this.state===is.scanning&&(requestAnimationFrame(e),t())};e()}async open(){this.setState(is.notready),this.modal&&this.modal.open(),await this.initCamera()}setState(t){switch(this.state=t,this.modal?.valid(!1),t){case is.fail:this.status=`${this.state} ⇨ Pas de flux video`;break;case is.notready:this.status=`${this.state} ⇨ En initialisation`;break;case is.scanning:this.status=`${this.state} ⇨ Scannez`;break;case is.done:this.status=`${this.state} ⇨ Resultat: ${this.code}`,this.modal?.valid(!0)}}};var os;t([E()],ns.prototype,"state",null),ns=t([e("fz-barcode-dlg")],ns),function(t){t[t.notready=0]="notready",t[t.video=1]="video",t[t.lowres=2]="lowres",t[t.hires=3]="hires"}(os||(os={}));let as=class extends Dt{#u=os.video;get state(){return this.#u}set state(t){this.#u=t}modal;video;canvas;imageCapture;imageBitmap;status="Initializing";get isVideo(){return this.state===os.video}static get styles(){return[...super.styles,a`
            div {
                color: black
            }
            `]}render(){return Y`
            ...
            `}stopEvent(t){t.preventDefault(),t.stopPropagation()}close(t){this.video&&(this.video?.pause(),this.video.srcObject=null,this.imageCapture?.track.stop());const e=t.detail;this.canvas?.toBlob((s=>{if(!s)return;const i=URL.createObjectURL(s);t.detail.dismissed||(t.detail.imageBitmap=this.imageBitmap,t.detail.url=i,t.detail.blob=s),this.dispatchEvent(new CustomEvent("close",{detail:e})),this.imageBitmap=void 0,this.modal?.valid(!1)}),"image/png",.8)}firstUpdated(){this.modal=this.shadowRoot?.querySelector("fz-dialog"),this.video=this.shadowRoot?.querySelector("video"),this.canvas=this.shadowRoot?.querySelector("canvas")}getUserMedia(){navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}).then((t=>{if(this.video){this.video.srcObject=t;const e=t.getVideoTracks()[0];this.imageCapture=new ImageCapture(e),this.setState(os.video)}})).catch((t=>this.status=`Unable to initialize Camera : ${String(t)}`))}retry(t){t.preventDefault(),t.stopPropagation(),this.imageBitmap=void 0,this.modal?.valid(!1),this.setState(os.video)}takePhotoLowres(t){t.preventDefault(),t.stopPropagation(),this.imageCapture&&this.imageCapture.grabFrame().then((t=>{this.imageBitmap=t,this.modal?.valid(!0),this.drawCanvas(),this.setState(os.lowres)})).catch((t=>this.status=`Unable to grab Lowres photo : ${String(t)}`))}takePhotoHires(t){t.preventDefault(),t.stopPropagation(),this.imageCapture&&this.imageCapture.takePhoto().then((t=>createImageBitmap(t))).then((t=>{this.imageBitmap=t,this.modal?.valid(!0),this.drawCanvas(),this.setState(os.hires)})).catch((t=>this.status=`Unable to grab Hires photo : ${String(t)}`))}drawCanvas(){if(!this.canvas||!this.video||!this.imageBitmap)return;this.canvas.width=this.video.offsetWidth,this.canvas.height=this.video.offsetHeight;const t=Math.min(this.canvas.width/this.imageBitmap.width,this.canvas.height/this.imageBitmap.height),e=(this.canvas.width-this.imageBitmap.width*t)/2,s=(this.canvas.height-this.imageBitmap.height*t)/2;this.canvas.getContext("2d")?.clearRect(0,0,this.canvas.width,this.canvas.height),this.canvas.getContext("2d")?.drawImage(this.imageBitmap,0,0,this.imageBitmap.width,this.imageBitmap.height,e,s,this.imageBitmap.width*t,this.imageBitmap.height*t)}open(){this.setState(os.notready),this.modal&&this.modal.open(),this.getUserMedia()}setState(t){if(this.video&&this.canvas)switch(t){case os.notready:this.video.style.display="block",this.canvas.style.display="none",this.status="NOTREADY";break;case os.video:this.video.style.display="block",this.canvas.style.display="none",this.status="VIDEO";break;case os.lowres:this.video.style.display="none",this.canvas.style.display="block",this.status=`IMAGE LOWRES : ${this.imageBitmap?.width} x ${this.imageBitmap?.height} px`;break;case os.hires:this.video.style.display="none",this.canvas.style.display="block",this.status=`IMAGE HIRES : ${this.imageBitmap?.width} x ${this.imageBitmap?.height} px`}this.state=t}};t([E()],as.prototype,"state",null),as=t([e("fz-photo-dlg")],as);let hs=class extends Dt{#$;get reference(){return this.#$}set reference(t){this.#$=t}modal;arraySchema;itemSchema;array;index;pointer;refname;static get styles(){return[...super.styles,a`
            div {
                color: black
            }
            `]}render(){return Y`
            ...
            </fz-dialog>`}updated(t){this.reference?(this.pointer=this.reference?.pointer,this.array=this.reference?.target,this.refname=this.reference?.name,this.arraySchema=Ut(this.array)):(this.pointer=void 0,this.array=void 0,this.refname=void 0,this.arraySchema=void 0,this.itemSchema=void 0)}toggleDropdown(){const t=this.shadowRoot?.querySelector(".dropdown-menu");t?.style.setProperty("display","block"==t?.style.display?"none":"block")}addItem(t){this.itemSchema=t;const e=this.itemSchema._default(this.array);this.index=this.array?.length,this.array?.push(e),this.modal?.valid(),this.requestUpdate()}stopEvent(t){t.preventDefault(),t.stopPropagation()}close(t){const e=t.detail;if(!t.detail.dismissed){const e=this.shadowRoot?.getElementById("form-object");t.detail.value=e.value[this.refname??"id"],t.detail.abstract=e.abstract()}this.reference=void 0,this.stopEvent(t),this.dispatchEvent(new CustomEvent("close",{detail:e})),this.modal?.valid(!1)}firstUpdated(){this.modal=this.shadowRoot?.querySelector("fz-dialog")}open(){this.modal&&this.modal.open(),this.arraySchema?.homogeneous&&void 0===this.index&&this.arraySchema?.items&&this.addItem(this.arraySchema?.items)}};t([_({type:Object})],hs.prototype,"reference",null),hs=t([e("fz-item-dlg")],hs);class ls{static levels={DEBUG:0,INFO:1,WARN:2,ERROR:3,NONE:4};static registry=new Map;static set(...t){let e="NONE";for(const s of t)["DEBUG","INFO","WARN","ERROR","NONE"].includes(s)?e=s:FzLogger.registry.set(s,e)}static get(t,e){function s(t,e){let s=Object.getPrototypeOf(t??{});for(;s;){if(s.constructor?.name===e)return!0;s=Object.getPrototypeOf(s)}return!1}const i=[];for(const t in e)(s(e[t],"FzField")||s(e[t],"Schema"))&&i.push(`${t}: ${e[t].pointer}`);const r=(e,...s)=>{if(!(e=>{const s=FzLogger.registry.get(t);return null!=s&&FzLogger.levels[e]>=FzLogger.levels[s]})(e))return;((t,...e)=>{i.join(" ")})(s.shift(),...s)};return{debug:(...t)=>r("DEBUG",...t),info:(...t)=>r("INFO",...t),warn:(...t)=>r("WARN",...t),error:(...t)=>r("ERROR",...t),if:{debug:(t,...e)=>t&&r("DEBUG",...e),info:(t,...e)=>t&&r("INFO",...e),warn:(t,...e)=>t&&r("WARN",...e),error:(t,...e)=>t&&r("ERROR",...e)}}}}globalThis.FzLogger=ls;var cs={$schema:"http://json-schema.org/draft-07/schema#",$id:"http://json-schema.org/draft-07/schema-3s#",title:"Core schema meta-schema",definitions:{schemaArray:{type:"array",minItems:1,items:{$ref:"#"}},nonNegativeInteger:{type:"integer",minimum:0},nonNegativeIntegerDefault0:{allOf:[{$ref:"#/definitions/nonNegativeInteger"},{default:0}]},simpleTypes:{enum:["array","boolean","integer","null","number","object","string"]},stringArray:{type:"array",items:{type:"string"},uniqueItems:!0,default:[]}},type:["object","boolean"],properties:{$id:{type:"string",format:"uri-reference"},$schema:{type:"string",format:"uri"},$ref:{type:"string",format:"uri-reference"},$comment:{type:"string"},title:{type:"string"},description:{type:"string"},default:!0,readOnly:{type:"boolean",default:!1},examples:{type:"array",items:!0},multipleOf:{type:"number",exclusiveMinimum:0},maximum:{type:"number"},exclusiveMaximum:{type:"number"},minimum:{type:"number"},exclusiveMinimum:{type:"number"},maxLength:{$ref:"#/definitions/nonNegativeInteger"},minLength:{$ref:"#/definitions/nonNegativeIntegerDefault0"},pattern:{type:"string",format:"regex"},additionalItems:{$ref:"#"},items:{anyOf:[{$ref:"#"},{$ref:"#/definitions/schemaArray"}],default:!0},maxItems:{$ref:"#/definitions/nonNegativeInteger"},minItems:{$ref:"#/definitions/nonNegativeIntegerDefault0"},uniqueItems:{type:"boolean",default:!1},contains:{$ref:"#"},maxProperties:{$ref:"#/definitions/nonNegativeInteger"},minProperties:{$ref:"#/definitions/nonNegativeIntegerDefault0"},required:{$ref:"#/definitions/stringArray"},additionalProperties:{$ref:"#"},definitions:{type:"object",additionalProperties:{$ref:"#"},default:{}},properties:{type:"object",additionalProperties:{$ref:"#"},default:{}},patternProperties:{type:"object",additionalProperties:{$ref:"#"},propertyNames:{format:"regex"},default:{}},dependencies:{type:"object",additionalProperties:{anyOf:[{$ref:"#"},{$ref:"#/definitions/stringArray"}]}},propertyNames:{$ref:"#"},const:!0,enum:{type:"array",items:!0,minItems:1,uniqueItems:!0},type:{anyOf:[{$ref:"#/definitions/simpleTypes"},{type:"array",items:{$ref:"#/definitions/simpleTypes"},minItems:1,uniqueItems:!0}]},format:{type:"string"},contentMediaType:{type:"string"},contentEncoding:{type:"string"},if:{$ref:"#"},then:{$ref:"#"},else:{$ref:"#"},allOf:{$ref:"#/definitions/schemaArray"},anyOf:{$ref:"#/definitions/schemaArray"},oneOf:{$ref:"#/definitions/schemaArray"},not:{$ref:"#"}},default:!0};let ds,us,ps;class fs{get schemaValid(){return!0}get schemaErrors(){return[]}get valid(){return!0}validate(t){}get errors(){return[]}get map(){const t=new Map;for(const e of this.errors){let{instancePath:s,message:i,params:r,keyword:n}=e;"required"===n&&(s=`/${r.missingProperty}`,i="required"),t.has(s)||t.set(s,[]),t.get(s)?.push(i??"unidentified error")}return t}static get loaded(){return null!=ds}static getValidator(t){if(null==ds)return new ms(t);const e=new ds({allErrors:!0,allowUnionTypes:!0,strictSchema:!0,strictNumbers:!1,coerceTypes:!1,multipleOfPrecision:15});return ps(e),Vt.forEach((t=>e.addFormat(t,/./))),Wt.forEach((t=>e.addKeyword({keyword:t,valid:!0}))),new bs(e,t)}static async loadValidator(t=!1){t&&!fs.loaded&&await async function(t){t&&$t(ds)&&([ds,us,ps]=await Promise.all([(await import("./ajv-dynamic.min.js").then((function(t){return t.a}))).default,(await import("./ajv-dynamic.min.js").then((function(t){return t.i}))).default,(await import("./ajv-dynamic.min.js").then((function(t){return t.b}))).default]))}(t)}}class ms extends fs{constructor(t){super()}}class bs extends fs{ajv;dataParser;schemaParser;constructor(t,e){super(),this.ajv=t,this.schemaParser=this.ajv.compile(cs),this.schemaParser(e),us(this.schemaParser.errors),this.dataParser=this.ajv.compile(e)}get schemaValid(){return 0==(this.schemaParser.errors?.length??0)}get schemaErrors(){return this.schemaParser.errors??[]}get valid(){return 0==(this.dataParser.errors?.length??0)}validate(t){this.dataParser(t),us(this.dataParser.errors)}get errors(){return this.dataParser.errors??[]}}const gs=Symbol("FZ_FORM_SCHEMA"),$s=Symbol("FZ_FORM_PARENT"),vs=Symbol("FZ_FORM_KEY"),ys=Symbol("FZ_FORM_ROOT");class ws extends Jt{constructor(t){super(t,"nullable","upgrade",[])}appliable(t){return this.property in t}apply(t){t.nullable&&(void 0===t.type?t.type=["null"]:Array.isArray(t.type)?t.type=[...t.type,"null"]:t.type=[t.type,"null"]),t[this.property]=void 0}}class xs extends Jt{constructor(t){super(t,"$id","upgrade",[])}appliable(t){return this.property in t&&t.$id.includes("#")}apply(t){const[e,s]=t.$id.split("#");t.$id=e,t.$anchor=s}}class ks extends Jt{constructor(t){super(t,"dependencies","upgrade",[])}appliable(t){return this.property in t}apply(t){t.dependentRequired={...t[this.property]},t.dependencies=void 0}}class zs extends Jt{constructor(t){super(t,"items","upgrade",[])}appliable(t){return Array.isArray(t[this.property])}apply(t){t.prefixItems=t[this.property],t.items=void 0}}class Ss extends Jt{constructor(t){super(t,"additionalProperties","upgrade",[])}appliable(t){return!1===t.additionalProperties}apply(t){t.unevaluatedProperties=!1,t.additionalProperties=void 0}}class _s extends Jt{constructor(t){super(t,"$ref","upgrade",[])}appliable(t){return this.property in t}apply(t){t.$dynamicRef=t[this.property],t.$ref=void 0}}class Es{static implemented=["draft-07","2019-09","2020-12"];static unimplemented=["draft-06","draft-05","draft-04","draft-03","draft-02"];static DIALECT_DRAF_07="http://json-schema.org/draft-07/schema";static DIALECT_2019_09="https://json-schema.org/draft/2019-09/schema";static DIALECT_2020_12="https://json-schema.org/draft/2020-12/schema";root;dialect;steps;passes={upgrade:[],pre:[],post:[]};errors=[];constructor(t,e,s){if(this.root=t,this.dialect=this.extractDialect(e,t.$schema),Es.unimplemented.includes(this.dialect))throw Error(`schema dialect '${this.dialect}' not implemented (implmented are draft-07,2019-09 and 2020-12)`);this.steps=[new _s(this.root),new Ss(this.root),new ks(this.root),new xs(this.root),new zs(this.root),new ws(this.root),new Os(this.root),new Is(this.root),new Cs(this.root),new js(this.root),new As(this.root),new Fs(this.root,e),new Ns(this.root),new Ms(this.root),new Rs(this.root),new Us(this.root),new Ts(this.root),new Ls(this.root),new Ds(this.root),new Ps(this.root),new qs(this.root,s),new Vs(this.root,"abstract",Kt._abstractFunc()),new Ws(this.root,"case",(()=>!1)),new Ws(this.root,"visible",(()=>!0)),new Ws(this.root,"readonly",(()=>!1)),new Ws(this.root,"requiredIf",(()=>!1)),new Ws(this.root,"filter",(()=>!0)),new Bs(this.root,"rank",(()=>!0)),new Bs(this.root,"expression",(()=>"")),new Bs(this.root,"change",(()=>""))];for(const t of this.steps)this.passes[t.phase].push(t);this.passes.upgrade=this.topologicalSort(this.passes.upgrade),this.passes.pre=this.topologicalSort(this.passes.pre),this.passes.post=this.topologicalSort(this.passes.post)}extractDialect(t={dialect:Es.DIALECT_DRAF_07},e){switch(!0){case Es.unimplemented.some((t=>e?.startsWith(`http://json-schema.org/${t}/schema`))):return Es.unimplemented.find((t=>e?.includes(t)))??"draft-06";case e?.startsWith(Es.DIALECT_DRAF_07):return"draft-07";case e?.startsWith(Es.DIALECT_2019_09):return"2019-09";case e?.startsWith(Es.DIALECT_2020_12):return"2020-12";case t.dialect&&Es.implemented.includes(t.dialect):return t.dialect;default:return"draft-07"}}compile(){return this.errors=[],this.walkSchema(this.passes.pre,this.root),this.walkSchema(this.passes.post,this.root),Us.breakCycles(),this.errors}walkSchema(t,e,s,i){for(const r of t)try{r.appliable(e,s,i)&&r.apply(e,s,i)}catch(t){this.errors.push(String(t))}return e.properties?Object.entries(e.properties).forEach((([s,i])=>this.walkSchema(t,i,e,s))):e.items?(e.items.oneOf||e.items.allOf||e.items.anyOf,this.walkSchema(t,e.items,e,"*")):e.oneOf?e.oneOf.forEach((e=>this.walkSchema(t,e,s,i))):e.allOf?e.allOf.forEach((e=>this.walkSchema(t,e,s,i))):e.anyOf?e.anyOf.forEach((e=>this.walkSchema(t,e,s,i))):void 0}topologicalSort(t){function e(r,n){if(!i.has(r.property)){if(n.has(r.property))throw new Error(`Cycle in step dependencies: ${r.property}`);n.add(r.property);for(const s of r.after){const i=t.find((t=>t.property===s));i&&e(i,n)}n.delete(r.property),i.add(r.property),s.push(r)}}const s=[],i=new Set;for(const s of t)e(s,new Set);return s}}class Os extends Jt{constructor(t){super(t,"$ref","pre",[])}apply(t){const e=[];for(const[s,i]of Object.entries(t.properties??{}))i.$ref&&e.push({parent:t.properties??{},property:s});for(const[s,i]of(t.oneOf??[]).entries())i.$ref&&e.push({parent:t.oneOf??[],property:s});for(const[s,i]of(t.anyOf??[]).entries())i.$ref&&e.push({parent:t.anyOf??[],property:s});for(const[s,i]of(t.allOf??[]).entries())i.$ref&&e.push({parent:t.allOf??[],property:s});for(const t of e)t.parent[t.property]=this.definition(t.parent[t.property])}definition(t){const e=t.$ref;if(!e.startsWith("#/definitions/"))throw this.error(`only '/definitions/<name>' allowed => ${e}]`);if(null==this.root.definitions)throw this.error('No "definitions" property in root schema');const s=e.split("/")[2];if(null==this.root.definitions[s])throw this.error(`No definitions found in schema for ${e}`);const i=this.root.definitions[s],r=Object.assign({},i);return Object.entries(t).forEach((([t,e])=>"$ref"!==t&&(r[t]=e))),Kt.wrapSchema(r)}}class Is extends Jt{constructor(t){super(t,"parent","pre",[])}appliable(t){return!(this.property in t)}apply(t,e){t.parent=e}}class Cs extends Jt{constructor(t){super(t,"pointer","pre",[])}appliable(t){return!(this.property in t)}apply(t,e,s){t.pointer=e?`${e.pointer}/${s}`:""}}class js extends Jt{constructor(t){super(t,"root","pre",[])}appliable(t){return!(this.property in t)}apply(t){t.root=this.root}}class As extends Jt{static STRINGKW=["minLength","maxLength","pattern","format"];static NUMBERKW=["minimum","maximum","exclusiveMinimum","exclusiveMaximum","multipleOf"];static ARRAYKW=["items","additionalItems","minItems","maxItems","uniqueItems"];static OBJECTKW=["required","properties","additionalProperties","patternProperties","minProperties","maxProperties","dependencies"];static ALL=new Set(["string","integer","number","object","array","boolean","null"]);constructor(t){super(t,"basetype","pre",[])}appliable(t){return!(this.property in t)}apply(t,e,s){switch(t.target=[...this.infer(t)],t.target.length){case 2:if(!t.target.includes("null"))throw Error(`Second type must be "null" : ${jt(e,s)}`);t.basetype=t.target.find((t=>"null"!==t))??t.target[0],t.nullAllowed=!0;break;case 1:t.basetype=t.target[0],t.nullAllowed="null"==t.target[0];break;case 0:t.basetype="null",t.nullAllowed=!1;break;default:throw Error(`multiple types not implemented : ${jt(e,s)}`)}}infer(t){const e=["constKW","typeKW","enumKW","numberKW","stringKW","arrayKW","objectKW","notKW","allofKW","anyofKW","oneofKW"].map((e=>this[e](t))).filter((t=>null!=t)),s=e.some((t=>t.has("integer")));if(s)for(const t of e)t.has("number")&&(t.delete("number"),t.add("integer"));return Ot([As.ALL,...e])}allofKW(t){if(t.allOf){const e=t.allOf.map((t=>this.infer(t))).filter((t=>null!=t));return Ot(e)}}anyofKW(t){if(t.anyOf){const e=t.anyOf.map((t=>this.infer(t))).map((t=>t??As.ALL));return It(e)}}oneofKW(t){if(t.oneOf){const e=t.oneOf.map((t=>this.infer(t))).map((t=>t??As.ALL));return It(e)}}notKW(t){return t.not?(e=this.infer(t.not),s=As.ALL,null==e?new Set:new Set([...s].filter((t=>!e.has(t))))):void 0;var e,s}enumKW(t){if("enum"in t&&Array.isArray(t.enum)){const e=t.enum.map((t=>null==t?"null":Array.isArray(t)?"array":typeof t));return new Set(e)}}typeKW(t){if("type"in t)return new Set(Array.isArray(t.type)?t.type:[t.type])}constKW(t){if("const"in t){if(null==t.const)return new Set(["null"]);if(Array.isArray(t.const))return new Set(["array"]);const e=Number.isInteger(t.const)?"integer":typeof t.const;return new Set([e])}}arrayKW(t){return As.ARRAYKW.some((e=>e in t))?new Set(["array"]):void 0}numberKW(t){return As.NUMBERKW.some((e=>e in t))?new Set(["number"]):void 0}integerKW(t){return"integer"==t.type||kt(t.type)&&t.type.includes("integer")?new Set(["integer"]):void 0}objectKW(t){return As.OBJECTKW.some((e=>e in t))?new Set(["object"]):void 0}stringKW(t){return As.STRINGKW.some((e=>e in t))?new Set(["string"]):void 0}}class Fs extends Jt{preferNull;constructor(t,e){super(t,"empty","pre",["basetype"]),this.preferNull=e?.preferNull??!1}appliable(t){return!(this.property in t)}apply(t){t.empty=t.nullAllowed&&this.preferNull?null:void 0}}class Ns extends Jt{constructor(t){super(t,"isenum","pre",[])}appliable(t){return!(this.property in t)}apply(t){switch(t.isenum=!1,!0){case!_t(t):break;case!!t.enum:case t.oneOf&&t.oneOf.every((t=>"const"in t)):case t.anyOf&&t.anyOf.every((t=>"const"in t)):t.filter||(t.filter=()=>!0),t.isenum=!0}}}class Ms extends Jt{constructor(t){super(t,"isenumarray","pre",[])}appliable(t){return!(this.property in t)}apply(t){t.isenumarray=_t(t)&&function(t){if("array"===t.basetype&&t.uniqueItems){if(t.items?.oneOf)return!!t.items.oneOf.every((t=>"const"in t));if(t.items?.anyOf)return!!t.items?.anyOf.every((t=>"const"in t))}return!1}(t)}}class Rs extends Jt{constructor(t){super(t,"homogeneous","pre",["basetype"])}appliable(t){return!(this.property in t)&&"array"===t.basetype}apply(t){t.homogeneous=!t.items?.oneOf}}class Us extends Jt{static ALL=new Map;constructor(t){super(t,"trackers","pre",["pointer"])}appliable(t){return!(this.property in t)}apply(t){t.trackers=[],Us.ALL?.set(t.pointer,t.trackers)}static breakCycles(){if(null==Us.ALL)return;const t=Us.ALL,e=new Set,s=new Set,i=new Map;for(const[r,n]of t){function o(r){if(s.has(r)){let e=r;const s=new Set;for(;i.has(e)&&!s.has(e);)s.add(e),e=i.get(e);for(const e of s){const s=i.get(e);if(s&&t.has(s)){const i=t.get(s),r=i.indexOf(e);-1!==r&&i.splice(r,1)}}}else if(!e.has(r)){e.add(r),s.add(r);for(const e of t.get(r)||[])i.set(e,r),o(e);s.delete(r)}}0===n.length&&t.delete(r);for(const a of t.keys())e.has(a)||o(a);Us.ALL=void 0}}}class Ts extends Jt{constructor(t){super(t,"requiredIf","pre",["basetype"])}appliable(t){return"object"===t.basetype&&null!=t.properties&&null!=t.required}apply(t){t.required?.forEach((e=>{t.properties&&e in t.properties&&(t.properties[e].requiredIf="true")}))}}class Ls extends Jt{constructor(t){super(t,"field","pre",["basetype","isenum","isenumarray"])}appliable(t){return!(this.property in t)}apply(t){if("const"in t)return t.field="fz-const";if(t.from&&_t(t))return t.filter||(t.filter=()=>!0),t.field="fz-enum-select";if(t.isenum)switch(t.filter||(t.filter=()=>!0),!0){case t.enum&&t.enum?.length<=3:case t.oneOf&&t.oneOf?.length<=3:case t.anyOf&&t.anyOf?.length<=3:return t.field="fz-enum-check";case t.enum&&t.enum?.length<=20:case t.oneOf&&t.oneOf?.length<=20:case t.anyOf&&t.anyOf?.length<=20:return t.field="fz-enum-select";default:return t.field="fz-enum-typeahead"}switch(t.basetype){case"object":return t.field="fz-object";case"array":return t.isenumarray?(t.filter||(t.filter=()=>!0),t.field="fz-enum-array"):t.field="fz-array";case"integer":return t.minimum&&t.maximum&&t.maximum-t.minimum<=10?t.field="fz-range":t.field="fz-integer";case"number":return t.field="fz-float";case"boolean":return t.field="fz-boolean";case"string":if(t.mask)return t.field="fz-mask";switch(t.format){case"color":return t.field="fz-color";case"uuid":case"uuid":return t.field="fz-uuid";case"signature":return t.field="fz-signature";case"date":return t.field="fz-date";case"time":return t.field="fz-time";case"date-time":return t.field="fz-datetime";case"geo":return t.field="fz-location";case"doc":return t.field="fz-doc";case"markdown":return t.field="fz-markdown";case"asset":return t.field="fz-picker"}return!t.format&&t.maxLength&&t.maxLength>256?t.field="fz-textarea":t.field="fz-string"}return t.field="fz-error"}}class Ds extends Jt{constructor(t){super(t,"order","pre",["basetype"])}appliable(t){return!(this.property in t)&&"object"===t.basetype&&null!=t.properties}apply(t){const e=t.properties;if(!e)return;const s=new Map,i=new Map;let r=0;const n=Object.entries(e).map((([t,e])=>{e.tab&&!i.has(e.tab)&&i.set(e.tab,r);const n=e.tab?i.get(e.tab):r;e.group&&!s.has(e.group)&&s.set(e.group,r);return{tabnum:n,groupnum:e.group?s.get(e.group):r,fieldnum:r++,fieldname:t,schema:e,tabname:e.tab??"",groupname:e.group??""}}));n.sort(((t,e)=>{const s=Math.min(t.tabnum,t.groupnum,t.fieldnum)-Math.min(e.tabnum,e.groupnum,e.fieldnum);return 0===s?t.fieldnum-e.fieldnum:s})),t.order=n}}class Ps extends Jt{constructor(t){super(t,"collapsed","pre",["pointer"])}appliable(t){return!0}apply(t){if($t(t.collapsed))t.collapsed="false";else{const e=["never","allways","true","false"];if(!e.includes(t.collapsed))throw this.error(`${t.pointer} : collapsed must be one of [${e.join(", ")}]`)}}}class qs extends Jt{data;constructor(t,e){super(t,"from","post",["pointer","trackers"]),this.data=e}appliable(t){return gt(t.from)&&!zt(t.from)}apply(t){const e=t.from;t.from=()=>null;const s=e.pointer.replace(/\/[^/]+$/,""),i=e.pointer.substr(s.length+1);t._track(`$\`${s}\``),t.from=(t,r,n,o,a)=>{const h=Ct(this.data,n,o,s);return h?kt(h)?{pointer:s,name:i,target:h,schema:Ut(h),extend:!!e.extend}:[]:null}}}class Vs extends Jt{defunc;constructor(t,e,s){super(t,e,"post",[]),this.defunc=s}appliable(t){return this.property in t&&"string"==typeof t[this.property]}apply(t,e,s){const i=t[this.property];if(this.set(t,this.defunc),vt(i)){const e=`\n                ${this.sourceURL(t,s)}\n                try { \n                    return nvl\`${i}\`\n                } catch(e) {  \n                    console.error(\n                        \` eval for keyword "${this.property}" failed field:\${parent?.pointer ?? ""} -> \${property ?? ""}\n\`,\n                        \`    => \${String(e)}\`) \n                }\n                return ''\n            `;this.compileExpr(t,i,e)}}}class Ws extends Jt{defaultFunc;constructor(t,e,s){super(t,e,"post",[]),this.defaultFunc=s}appliable(t){return this.property in t&&!zt(t[this.property])}apply(t,e,s){const i=t[this.property];if(this.set(t,this.defaultFunc),$t(i)||wt(i))return this.set(t,(()=>i));if(!vt(i))return this.set(t,(()=>!!i));const r=`\n            ${this.sourceURL(t,s)}\n            try {  \n                const result = (${i}) \n                return result === null ? result : !!result\n            } catch(e) {  \n                console.error(\n                    \` eval for keyword "${this.property}" failed field:\${parent?.pointer ?? ""} -> \${property ?? ""}\n\`,\n                    \`    => \${String(e)}\`) \n            }\n            return true\n        `;this.compileExpr(t,i,r)}}class Bs extends Jt{defaultFunc;constructor(t,e,s){super(t,e,"post",[]),this.defaultFunc=s}appliable(t){return this.property in t&&"function"!=typeof t[this.property]}apply(t,e,s){const i=t[this.property];if(this.set(t,this.defaultFunc),!vt(i)&&!kt(i))return this.set(t,(()=>i));let r="return null";r=vt(i)?`return ${i}`:this.buildCode(i);const n=`\n            ${this.sourceURL(t,s)}\n            try {\n                ${r} \n            } catch(e) {  \n                console.error(\n                    \` eval for keyword "${this.property}" failed field:\${parent?.pointer ?? ""} -> \${property ?? ""}\n\`,\n                    \`    => \${String(e)}\`) }\n            return null\n        `;this.compileExpr(t,i,n)}}class Ks{data;schema;steps;errors=[];constructor(t,e){this.data=t,this.schema=e,this.steps=[(t,e,s,i)=>{(xt(e)||kt(e))&&(e[gs]=t,e[$s]=s,e[vs]=i,e[ys]=e)}]}compile(){return this.errors=[],this.walkData(this.schema,this.data),this.errors}walkData(t,e,s,i){if(null!=t&&null!=e){try{this.steps.forEach((r=>r(t,e,s,i)))}catch(t){this.errors.push(String(t))}if(kt(e))t.homogeneous?e.forEach(((s,i)=>this.walkData(t.items,s,e,i))):e.forEach(((s,i)=>{t.items?.oneOf?.forEach((t=>{t.case&&t.case(null,s,e,i,(()=>null))&&this.walkData(t,s,e,i)}))}));else if(xt(e)&&t.properties)for(const s in e){const i=t.properties[s],r=e[s];this.walkData(i,r,e,s)}else;}}}class Js{store;constructor(t){this.store=t}async put(t,e,s,i){try{return this.store.put?.(t,e,s,i)}catch(t){}}async remove(t){try{return this.store.remove?.(t)}catch(t){}}async get(t){try{return this.store.get?.(t)??null}catch(t){return}}}class Gs{store=new Map;async put(t,e,s,i){this.store.set(t,{uuid:t,blob:e,filename:s})}async remove(t){await this.store.delete(t)}async get(t){return this.store.get(t)}}var Zs;let Hs=Zs=class extends Dt{static get styles(){return[...super.styles]}i_root={content:{}};i_options={dialect:"draft-07",userdata:void 0};store=new Gs;asset;fieldMap=new Map;schemaMap=new Map;errorMap=new Map;submitted=!1;bootstrap=!1;useAjv=!1;useMarkdown=!1;#v=Zt;get sourceSchema(){return this.#v}set sourceSchema(t){this.#v=t}#y=!1;get actions(){return this.#y}set actions(t){this.#y=t}#w=!1;get readonly(){return this.#w}set readonly(t){this.#w=t}#x=!1;get checkIn(){return this.#x}set checkIn(t){this.#x=t}#k=!1;get checkOut(){return this.#k}set checkOut(t){this.#k=t}oninit=null;onready=null;onvaliddata=null;oninvaliddata=null;onvalidate=null;ondismiss=null;compiledSchema=Zt;validator=new ms(Zt);message="";constructor(){super()}get root(){return this.i_root.content}get valid(){return this.validator.validate(this.root),this.errorMap=this.validator.map,this.validator.valid}get schema(){return this.compiledSchema}set schema(t){this.validator=fs.getValidator(t),this.validator.schemaValid?(this.sourceSchema=new Kt(JSON.parse(JSON.stringify(t))),this.compiledSchema=new Kt(JSON.parse(JSON.stringify(t)))):(this.sourceSchema=new Kt(JSON.parse(JSON.stringify(Zt))),this.compiledSchema=new Kt(JSON.parse(JSON.stringify(Zt))),this.validator=fs.getValidator(this.sourceSchema)),this.compile(),this.compiledSchema.collapsed="never",this.fieldMap.clear(),this.schemaMap.clear(),this.requestUpdate()}get options(){return this.i_options}set options(t){this.i_options={dialect:t?.dialect??"draft-07",userdata:t?.userdata},this.i_options?.storage&&(this.store=new Js(this.i_options.storage)),this.i_options?.asset&&(this.asset=this.i_options.asset)}get data(){return JSON.parse(JSON.stringify(this.root))}set data(t){if(!this.validator.schemaValid)return;!this.valid&&this.checkIn,this.i_root.content=t,this.compile(),this.requestUpdate()}attributeChangedCallback(t,e,s){if(super.attributeChangedCallback(t,e,s),"schema"===t){const t=Gt.fromAttribute(s);this.schema=t}"bootstrap"===t&&Zs.loadBootstrap(),"useajv"===t&&fs.loadValidator(this.useAjv).then((()=>{this.validator=fs.getValidator(this.sourceSchema),this.check()})).catch((t=>{})),"usemarkdown"===t&&De.loadMarkdownIt(this.useMarkdown).then((()=>null)).catch((t=>{}))}getField(t){return this.fieldMap.get(t)}addField(t,e,s){this.schemaMap.set(t,s),this.fieldMap.set(e,s)}removeField(t,e){this.schemaMap.delete(t),this.fieldMap.delete(e)}getfieldFromSchema(t){return this.schemaMap.get(t)}updateField(t){this.getField(t)?.requestUpdate()}render(){return Dt.isBootStrapLoaded()?this.validator.schemaValid?this.renderForm():this.renderError():"Bootstrap not loaded..."}renderForm(){return Y`
