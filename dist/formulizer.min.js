import{_ as t,n as e,e as s,r as i,t as r,a as n,i as a,b as o,c as h,d as l,f as c,B as d,g as u,h as p,j as m,x as f,k as g,l as b,m as $,o as v,p as y,q as w,s as x,E as k,u as z,v as S,F as _,w as E,y as I,T as O,z as j,Z as F,A as C,C as N,D as A,G as M}from"./markdown-dynamic.min.js";const R=Symbol("FZ_FORM_SCHEMA"),D=Symbol("FZ_FORM_PARENT"),L=Symbol("FZ_FORM_PARENT"),q=Symbol("FZ_FORM_ROOT"),U=[],T=[],P=["parent","root"];class V{$id;$schema;$ref;$comment;type;enum;const;multipleOf;maximum;exclusiveMaximum;minimum;exclusiveMinimum;maxLength;minLength;pattern;items;additionalItems;maxItems;minItems;uniqueItems;contains;maxProperties;minProperties;required;properties;patternProperties;additionalProperties;dependencies;propertyNames;if;then;else;allOf;anyOf;oneOf;not;definitions;title;description;default;examples;format;root;parent;basetype;empty;pointer;nullAllowed;transient;trackers;target;enumFetch;isenum;filter;isenumarray;homogeneous;requiredIf;field;from;order;abstract;case;visible;readonly;collapsed;orderBy;expression;change;nullable;assets;preview;mimetype;mask;tab;group}const B=["color","signature","password","doc","uuid","geo","markdown","asset","date","time","date-time","email","barcode"],J=["root","parent","basetype","pointer","nullAllowed","transient","trackers","target","enumFetch","isenum","filter","isenumarray","homogeneous","requiredIf","field","from","order","abstract","case","visible","readonly","collapsed","orderBy","expression","change","_nullable","assets","preview","mimetype","mask","tab","group"];function W(t){return!!h(t)&&(!!x(t.pointer)&&(!!x(t.name)&&(!!o(t.target)&&!!function(t){return g(t)&&t instanceof G}(t.schema))))}class G extends V{constructor(t){return super(),G.wrapSchema(t)}_abstract(t){if(a(t)||null==t)return"~";if(o(t)&&this.items instanceof G&&null!=this.items){const e=this.items;return t.map((t=>e._abstract(t))).filter((t=>t)).join(",")}if(o(t)&&o(this.items))return"";if(h(this.properties)){const e=this.properties;return this.properties?Object.keys(this.properties).filter((e=>null!=t[e])).map((s=>e[s]._abstract(t[s]))).join(","):""}return String(t)}static _abstractFunc(){return(t,e)=>t._abstract(e)}_default(t){switch(!0){case"const"in this:return this.const;case c(this)&&"default"in this:return this.default;case"object"===this.basetype:return this.properties?Object.entries(this.properties).reduce(((t,[e,s])=>(s.default?t[e]=l(JSON.parse(JSON.stringify(s.default)),t,s):t[e]=t.required?.includes[e]?s._default(t):l(s._empty(),t,s),t)),l({},t,this)):{};case"array"===this.basetype:return l([],t,this);default:return l(this._empty(),t,this)}}_deref(t){const e=t.split(/\//),s=/^\d+$/.test(e[0]);let i=s?this:this.root;if(s){const t=parseInt(e[0]);for(let e=0;e<t;e++)i=i?.parent;if(!i)return}e.shift();for(const t of e){if(i="*"===t?i.items:i.properties?.[t],!i)return}return i}_track(t){const e=/\$\`([^`]+)`/g;let s;for(;null!=(s=e.exec(t));){const t=s[1],e=this._deref(t);null==e||e.trackers.includes(this.pointer)||e.trackers.push(this.pointer)}}_toJSON(){return JSON.stringify(this,((t,e)=>P.includes(t)?void 0:e))}static wrapSchema(t){return Object.setPrototypeOf(t,G.prototype),h(t.properties)&&Object.values(t.properties).forEach((t=>G.wrapSchema(t))),o(t.items)&&t.items.forEach((t=>G.wrapSchema(t))),h(t.items)&&G.wrapSchema(t.items),o(t.oneOf)&&t.oneOf.forEach((t=>G.wrapSchema(t))),o(t.anyOf)&&t.anyOf.forEach((t=>G.wrapSchema(t))),o(t.allOf)&&t.allOf.forEach((t=>G.wrapSchema(t))),t.not&&G.wrapSchema(t.not),t}static inferEnums(t){if(h(t)&&c(t)){if(o(t.enum))return t.enum.map((t=>({value:t,title:String(t)})));if(void 0!==t.const){return[{value:t.const,title:String(t.title??t.const)}]}if(Array.isArray(t.oneOf))return t.oneOf.flatMap((t=>G.inferEnums(t)??[]));if(Array.isArray(t.anyOf))return t.anyOf.flatMap((t=>G.inferEnums(t)||[]));if(Array.isArray(t.allOf))for(const e of t.allOf){const t=G.inferEnums(e);if(t)return t}if(t.not){const e=G.inferEnums(t.not)??[];return G.inferEnums(t)?.filter((t=>!e.some((e=>e.value===t.value))))}}}_empty(){return"array"==this.basetype?[]:"object"==this.basetype?{}:this.const?this.const:this.nullAllowed?null:void 0}}class K{root;property;phase;after;static sourceCount=1;constructor(t,e,s,i){this.root=t,this.property=e,this.phase=s,this.after=i}appliable(t,e,s){return!0}sourceURL(t,e){let s=`_FZ_${this.property}_${e??""}_${K.sourceCount++}.js`.replace(/ +/g,"_");return s=s.replace(/[^a-z0-9_]/gi,""),`\n    //# sourceURL=${s}\n`}set(t,e,s){t[this.property]=e,s&&(t[this.property].expresion=s)}compileExpr(t,e,s){const i=x(e)?[e]:e;try{i.forEach((e=>t._track(e))),this.set(t,new Function("schema","value","parent","property","$","userdata",s),e)}catch(e){throw Error(`compilation for keyword ${this.property} failed schema:${t.pointer}\n    - ${String(e)}`)}}buildCode(t){const e=t.map(((t,e)=>`    const cst${e} = \`${t}\n\``));return e.push(`    return ( ${t.map(((t,e)=>`cst${e}`)).join(" + ")} ) `),e.join(";\n")}error(t){return Error(`Compilation step ${this.property}: ${t} `)}}const Z={fromAttribute(t){try{return null!=t?new G(JSON.parse(t)):H}catch(t){}return H},toAttribute(t){try{return null!=t?t._toJSON():null}catch(t){return null}}},H=new G({type:"object",properties:{},collapsed:!1}),Y=new G({}),X=u(class extends E{constructor(t){if(super(t),t.type!==I.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const s=t.element.classList;for(const t of this.st)t in e||(s.remove(t),this.st.delete(t));for(const t in e){const i=!!e[t];i===this.st.has(t)||this.nt?.has(t)||(i?(s.add(t),this.st.add(t)):(s.remove(t),this.st.delete(t)))}return O}}),Q=["fz-array","fz-asset","fz-boolean","fz-constant","fz-date","fz-datetime","fz-document","fz-enum-select","fz-enum-array","fz-geolocation","fz-integer","fz-markdown","fz-enum-check","fz-float","fz-object","fz-range","fz-signature","fz-string","fz-textarea","fz-enum-typeahead","fz-time","fz-uuid","fz-color"].join(",");class tt extends d{#t="/";get pointer(){return this.#t}set pointer(t){this.#t=t}#e=Y;get schema(){return this.#e}set schema(t){this.#e=t}#s={};get data(){return this.#s}set data(t){this.#s=t}#i=null;get name(){return this.#i}set name(t){this.#i=t}#r=null;get index(){return this.#r}set index(t){this.#r=t}#n=!1;get touched(){return this.#n}set touched(t){this.#n=t}#a=T;get errors(){return this.#a}set errors(t){this.#a=t}_dofocus=!1;_form;get valid(){return 0===(this.errors?.length??0)&&this.errors!=T}get invalid(){return(this.errors?.length??0)>0}get value(){if(null!=this.data)return this.name&&!(this.name in this.data)&&(this.data[this.name]=void 0),this.data[this.key]}set value(t){t!==this.value&&(this.cascadeValue(t),this.errors=[],this.form?.check())}get validationMap(){return X({"is-valid":this.valid,"is-invalid":this.invalid})}cascadeValue(t){const e=this.schema,s=this.form;if(this.data)this.data[this.key]=l(t,this.data,this.schema);else{if(!this.pointer.startsWith("/"))return!1;if("/"===this.pointer)return!1;const i=this.pointer.split("/").map((t=>/^\d+$/.test(t)?parseInt(t,10):t)),r=[];for(let t=e;t;t=t.parent)r.unshift(t);if(i.length!==r.length)return!1;const n=[];let a="",o=s.root;for(let e=0;e<i.length&&o;e++){const h=i[e],c=r[e];a=e?`${a}/${h}`:`${h}`;const d=s.getField(a);d&&n.push(d);const u=c.basetype;switch(!0){case""===h:break;case e===i.length-1:{const e=l(t,o,c);d&&!d.data&&(d.data=o),o=o[h]=e}break;case null==o[h]&&"array"==u:{const t=l([],o,c);d&&!d.data&&(d.data=o),o=o[h]=t}break;case null==o[h]&&"object"==u:{const t=l({},o,c);d&&!d.data&&(d.data=o),o=o[h]=t}break;default:o="object"==u||"array"==u?o[h]:null}}n.forEach((t=>{t.toField(),t.requestUpdate()}))}return this.toField(),this.requestUpdate(),!0}get nullable(){return"null"===this.schema.type||(!(!o(this.schema.type)||!this.schema.type.includes("null"))||this.schema.nullAllowed)}get key(){return this.name??this.index??-1}get label(){return(this.isItem?String(null!=this.index?this.index+1:"-"):this.schema?.title??this.name)??""}get isItem(){return null!=this.index}get isProperty(){return null!=this.name}get visible(){return!this.data||!this.schema.visible||!!this.evalExpr("visible")}get required(){let t=!1;return this.isProperty&&this.schema.requiredIf&&(t=this.evalExpr("requiredIf")??!1),t}get readonly(){return!this.form||(!!this.form.readonly||!(!this.data||!this.schema.readonly)&&this.evalExpr("readonly"))}get empty(){return this.schema._empty()}get isEmpty(){return a(this.value)}dofocus(){this._dofocus=!0}eventStop(t){t&&(t.preventDefault(),t.stopPropagation())}fields(){const t=[];return this.shadowRoot?.querySelectorAll(Q).forEach((e=>t.push(e))),t}get form(){return this._form||(this._form=p("fz-form",this)),this._form}static get styles(){return[...super.styles,m`
            .invalid {
        ...
        `]}render(){return f`
            <div ?hidden="${!this.visible}">
                ...
                ${this.valid?f``:f`<div class="row">${this.renderErrors()}</div>`}
            </div>
        `}renderErrors(){return f`
            <span id="error" class="error-message error-truncated" @click="${this.toggleError}">
                ${this.errors.join(", ")}
            </span>`}toggleError(){this.shadowRoot?.getElementById("error")?.classList.toggle("error-truncated")}get renderLabel(){return""===(this.schema?.title??"")?f``:this.isItem?f`
            ...
            </label>`}renderItem(t,e){let s=null,i=null;if(!this.schema)return f``;"string"==typeof e&&(s=e),"number"==typeof e&&(i=e);const r=null==this.data?null:this.data[this.key];switch(t.field){case"fz-enum-select":return f`<fz-enum-select .pointer="${this.pointer}/${e}" .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-enum-select>`;case"fz-enum-check":return f`<fz-enum-check .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-enum-check>`;case"fz-date":return f`<fz-date .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-date>`;case"fz-time":return f`<fz-time .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-time>`;case"fz-datetime":return f`<fz-datetime .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-datetime>`;case"fz-textarea":return f`<fz-textarea .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-textarea>`;case"fz-string":return f`<fz-string .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-string>`;case"fz-mask":return f`<fz-mask .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-mask>`;case"fz-asset":return f`<fz-asset .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-asset>`;case"fz-signature":return f`<fz-signature .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-signature>`;case"fz-boolean":return f`<fz-boolean .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-boolean>`;case"fz-float":return f`<fz-float .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-float>`;case"fz-integer":return f`<fz-integer .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-integer>`;case"fz-range":return f`<fz-range .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-range>`;case"fz-geolocation":return f`<fz-geolocation .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-geolocation>`;case"fz-array":return f`<fz-array .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-array>`;case"fz-object":return f` <fz-object .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-object>`;case"fz-constant":return f` <fz-constant .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-constant>`;case"fz-enum-array":return f` <fz-enum-array .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-enum-array>`;case"fz-document":return f` <fz-document .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-document>`;case"fz-uuid":return f` <fz-uuid .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-uuid>`;case"fz-markdown":return f` <fz-markdown .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-markdown>`;case"fz-enum-typeahead":return f` <fz-enum-typeahead .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-enum-typeahead>`;case"fz-color":return f` <fz-color .pointer="${this.pointer}/${e}"  .schema="${t}" .name="${s}" .index="${i}" .data="${r}"></fz-color>`;default:return f`<div class="alert alert-warning" role="alert">field name=${s} type ${t.basetype}/${t.field} not implemented !</div>`}}connectedCallback(){super.connectedCallback(),this.form?.addField(this.schema.pointer,this.pointer,this)}disconnectedCallback(){super.disconnectedCallback(),this.form?.removeField(this.schema.pointer,this.pointer),this.pointer=void 0,this.schema=void 0,this.data=void 0,this.name=void 0,this.index=void 0,this.touched=void 0,this.errors=void 0,this._dofocus=void 0,this._form=void 0}update(t){this.schema?.expression&&(this.value=this.evalExpr("expression")),super.update(t),this._dofocus&&(this._dofocus=!1,this.focus())}firstUpdated(t){super.firstUpdated(t),this.toField(),this.form?.check()}labelClicked(t){this.eventStop(t)}change(){this.toValue(),this.evalExpr("change");const t=new CustomEvent("update",{detail:{data:this.data,schema:this.schema,field:this},bubbles:!0,composed:!0});this.dispatchEvent(t),this.schema.trackers.length&&this.dispatchEvent(new CustomEvent("data-updated",{detail:{trackers:this.schema.trackers,field:this},bubbles:!0,composed:!0})),this.requestUpdate()}abstract(t,e){let s;if(null==t){if(this.isEmpty)return"~";s=this.schema.abstract?this.evalExpr("abstract"):this.schema._abstract(this.value)}else if(g(e)&&b(e.from)){const i=e.from?.(e,this.value[t],this.data,this.key,this.derefFunc,this.form.options.userdata),r=i.refarray.findIndex((e=>e[i.refname]===this.value[t])),n=i.refarray[r],a=$(n);s=b(a.abstract)?a.abstract(a,n,i.refarray,r,this.derefFunc,this.form.options.userdata):a._abstract(this.value[t])}else{const i="string"==typeof t?this.schema.properties?.[t]:e;s=b(i?.abstract)?i.abstract(i,this.value[t],this.data,this.key,this.derefFunc,this.form.options.userdata):i?._abstract(this.value[t])}return s.length>200?s.substring(0,200)+"...":s}evalExpr(t,e,s,i,r){const n=this.schema?.[t];return b(n)?null!=e?n(e,s,i,r,this.derefFunc,this.form?.options.userdata):n(this.schema,this.value,this.data,this.key,this.derefFunc,this.form?.options.userdata):null}get derefFunc(){return(t,...e)=>{const s=String.raw(t,e);return v(this.form.root,this.data,this.key,s)}}trackedValueChange(){this.schema?.expression&&(this.value=this.evalExpr("expression")),this.requestUpdate()}}t([e({type:String})],tt.prototype,"pointer",null),t([e({type:Object})],tt.prototype,"schema",null),t([e({type:Object})],tt.prototype,"data",null),t([e({type:String})],tt.prototype,"name",null),t([e({type:Number})],tt.prototype,"index",null),t([e({type:Boolean,attribute:!1})],tt.prototype,"touched",null),t([e({type:Array,attribute:!1})],tt.prototype,"errors",null);const et=["valueMissing","badInput","patternMismatch","tooLong","tooShort","rangeOverflow","rangeUnderflow","stepMismatch","customError","typeMismatch"];class st extends tt{get input(){return this.shadowRoot?.getElementById("input")}renderField(){return f`
            <div class="form-group row">
                ${this.renderLabel}
                <div class="col-sm">${this.renderInput()}</div>
            </div>`}firstUpdated(t){super.firstUpdated(t),this.input&&this.listen(this.input,"keydown",(t=>this.debugKey(t)))}disconnectedCallback(){this.input&&(this.input.value=""),super.disconnectedCallback()}focus(){this.input?.focus()}debugKey(t){"F9"===t.key&&(window._FZ_FORM_FIELD_DEBUG=this,et.map((t=>`${t} = ${this.input.validity[t]}`)).join("\n"),[["schema",JSON.stringify(this.schema,j).substring(0,100)],["data",JSON.stringify(this.data,((t,e)=>"symbol"==typeof t?void 0:e)).substring(1,100)],["pointer",this.pointer],["name",this.name],["valid",this.valid],["visible",this.visible],["required",this.required],["readonly",this.readonly],["check",JSON.stringify(this.input.validity)],["input",this.input.value],["value",this.value]].map((t=>t.join(" = "))).join("\n"),this.eventStop(t))}}const it=[],rt=[];class nt extends st{modal;enums=[];refenum;get extend(){return!!this.refenum?.extend}get showNullChoice(){if(!this.schema?.nullAllowed)return!1;return this.schema.nullAllowed&&(!this.schema.enum?.includes(null)||!this.schema.oneOf?.some((t=>null===t.const))||!this.schema.anyOf?.some((t=>null===t.const)))}renderInput(){return this.evalEnums(),f`
            ${this.extend?f`<fz-item-dlg  @click="${this.eventStop}" .reference="${this.refenum}" @close="${this.close}"></fz-item-dlg>`:""}
            ${this.renderEnum()}`}close(t){if(t.detail.dismissed)this.refenum?.target.pop();else if(this.input&&this.input instanceof HTMLSelectElement){const e=document.createElement("option");e.value=t.detail.value,e.text=t.detail.abstract,this.input.add(e),e.selected=!0}this.refenum?.pointer&&this.form?.updateField(this.refenum?.pointer),super.change(),this.requestUpdate()}change(t){"~~ADD~~"==this.input?.value&&this.modal?(this.modal.open(),this.modal.reference=this.refenum,this.modal.requestUpdate()):super.change()}isSelected(t){return this.value===t}evalEnums(){if(this.enums!=it&&this.enums!=rt){switch(!0){case b(this.schema?.from):this.enums=this.getFrom();break;case g(this.schema?.enumFetch):this.fetchEnum().then((t=>(this.enums=t,this.requestUpdate())),(t=>this.errors=[String(t)]));break;default:this.enums=this.getEnum(),0==this.enums.length&&(this.enums=rt)}this.enums!=it&&0==this.enums?.length&&(this.enums=rt)}}getEnum(){const t=G.inferEnums(this.schema);return y(t)?[]:t?.reduce(((t,e)=>(this.evalExpr("filter",this.schema,e.value,this.data,this.key)&&t.push(e),t)),[])}async fetchEnum(){return new Promise(((t,e)=>{const s=this.schema.enumFetch;let i=!1;const r=new CustomEvent("enum",{detail:{name:s,success:e=>{clearTimeout(n),i||(i=!0,t(e))},failure:t=>{clearTimeout(n),i||(i=!0,e(new Error(`EnumFetch "${s}" failed: ${t}`)))},timeout:1e4},bubbles:!0,cancelable:!1,composed:!0});this.dispatchEvent(r);const n=setTimeout((()=>{i||e(new Error(`Timeout when fetching enumeration"${s}"`))}),r.detail.timeout??1e4)}))}getFrom(){const t=this.evalExpr("from");if(W(t)){this.refenum=t;const e=this.refenum.name,s=this.refenum.target;return s.reduce(((t,i,r)=>{const n=$(i);if(this.evalExpr("filter",n,i,s,r)){const a=i[e],o=b(n?.abstract)?n.abstract(n,i,s,r,this.derefFunc,this.form.options.userdata):a;t.push({title:o,value:a})}return t}),[])}return[]}}t([s("fz-item-dlg")],nt.prototype,"modal",void 0);let at=class extends nt{#o=-1;get selected(){return this.#o}set selected(t){this.#o=t}#h=[];get options(){return this.#h}set options(t){this.#h=t}toField(){this.options.forEach((t=>t.selected=!1)),y(this.value)||y(this.enums)?this.selected=-1:(this.selected=this.enums.findIndex((t=>t.value==this.value)),this.selected>=0&&(this.options[this.selected].selected=!0))}toValue(){g(this.enums)&&this.selected>=0&&(this.value=this.enums[this.selected].value)}static get styles(){return[...super.styles,m`
            .readonly {
                background-color: #ececec
            }`]}renderEnum(){return this.enums==it?f`
            ...
            >
                ${this.extend?f`<option style="color:red;text-align:center" ?disabled="${this.readonly}" ?selected="${!1}" .value="${"~~ADD~~"}">Add ...</option>`:""}
                ${this.showNullChoice?f`<option style="color:red;text-align:center" ?disabled="${this.readonly}" ?selected="${this.isSelected(null)}" .value="${"~~EMPTY~~"}"> ${this.required?"Choose a value...":"<vide>"}</option>`:""}
                ${this.enums?.map(((t,e)=>f`
                    <option id="option" ?disabled="${this.readonly}"  ?selected="${this.selected===e}">
                        <b>${t.title}</b>
                    </option>`))}
            </select>`}select(){this.options.forEach(((t,e)=>t.selected?this.selected=e:null)),this.change()}};t([e({type:Number,attribute:!1})],at.prototype,"selected",null),t([i("option")],at.prototype,"options",null),at=t([r("fz-enum-select")],at);let ot=class extends nt{#o=-1;get selected(){return this.#o}set selected(t){this.#o=t}#l=[];get radios(){return this.#l}set radios(t){this.#l=t}toField(){y(this.radios)||(this.radios.forEach((t=>{t.checked=!1,t.removeAttribute("checked")})),void 0===this.value||y(this.enums)?this.selected=-1:(this.selected=this.enums.findIndex((t=>t.value===this.value)),this.selected>=0&&(this.radios[this.selected].checked=!0)))}toValue(){this.selected>=0&&g(this.enums)&&(this.value=this.enums[this.selected].value)}renderEnum(){return this.enums==it?f`
                <div class="form-control d-flex align-items-center">
                    <div class="spinner-border spinner-border-sm text-secondary me-2" role="status">
                        <span class="visually-hidden">Loading...</span>
                    </div>
            ...
            ${this.enums?.map(((t,e)=>f`
                ...
                </div>`))}`}select(t){this.readonly||(this.selected=t,this.radios[this.selected].checked=!0,this.change())}};t([e({type:Number,attribute:!1})],ot.prototype,"selected",null),t([i("input")],ot.prototype,"radios",null),ot=t([r("fz-enum-check")],ot);
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ht="important",lt=" !"+ht,ct=u(class extends E{constructor(t){if(super(t),t.type!==I.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,s)=>{const i=t[s];return null==i?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(t,[e]){const{style:s}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const t of this.ft)null==e[t]&&(this.ft.delete(t),t.includes("-")?s.removeProperty(t):s[t]=null);for(const t in e){const i=e[t];if(null!=i){this.ft.add(t);const e="string"==typeof i&&i.endsWith(lt);t.includes("-")||e?s.setProperty(t,e?i.slice(0,-11):i,e?ht:""):s[t]=i}}return O}});let dt=class extends nt{#c=!1;get isopen(){return this.#c}set isopen(t){this.#c=t}#o=-1;get selected(){return this.#o}set selected(t){this.#o=t}filtered=[];toField(){if(this.queryElem)if(y(this.value)||y(this.enums))this.queryElem.value="",this.selected=-1;else{const t=this.enums.find((t=>t.value==this.value));this.queryElem.value=t?t.title:"",this.selected=t?0:-1}else this.selected=-1}toValue(){this.selected>=0&&(this.value=this.filtered[this.selected].value)}renderEnum(){if(this.enums==it)return f`
                <div class="form-control d-flex align-items-center">
                    <div class="spinner-border spinner-border-sm text-secondary me-2" role="status">
                        <span class="visually-hidden">Loading...</span>
                    </div>
                    Loading...
                </div>`;const t={display:this.isopen?"block":"none"};return f`
            <div class="dropdown">
                <input  
                    id="query"
                    type="text" 
                ...
                <div id="list" style="${ct(t)}" class="dropdown-menu w-100">
                    ${0==this.filtered?.length?f`<a data-testid="nomatch-item" class="dropdown-item disabled"  style="font-style: italic">No match...</a>`:""}
                    ${this.filtered?.map(((t,e)=>f`<a data-testid="selected-item" class="dropdown-item" @click="${()=>this.select(e)}" >${this.boldPrefix(t.title)}</a>`))}
                </div>
            </div>`}get query(){return this.queryElem?.value??""}boldPrefix(t){if(null==this.query||0==this.query.length)return t;const e=t.split(new RegExp(this.query,"i")).join(`<b><u>${this.query}</u></b>`);return w(e)}show(){this.isopen=!0,this.queryElem.select(),this.filter()}select(t){this.selected=t,this.isopen=!1,this.queryElem.value=this.filtered[this.selected].title,this.change()}filter(){super.evalEnums();const t=this.query.toUpperCase();this.filtered=this.showNullChoice?[{title:"~ empty",value:this.empty}]:[],this.filtered.push(...this.enums?.filter((e=>e.title.toUpperCase().includes(t))).slice(0,10)??[]),this.selected=-1,this.requestUpdate()}};t([e({type:Boolean,attribute:!1})],dt.prototype,"isopen",null),t([e({type:Number,attribute:!1})],dt.prototype,"selected",null),t([s("#query")],dt.prototype,"queryElem",void 0),dt=t([r("fz-enum-typeahead")],dt);const ut=/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?\)/;let pt=class extends st{toField(){g(this.input)&&(x(this.value)?this.value.match(ut)?this.input.value=this.rgbaToHex(this.value):this.input.value=this.value:this.input.value="#000000")}toValue(){g(this.input)&&(x(this.input.value,!0)?this.input.value.match(ut)?this.value=this.rgbaToHex(this.input.value):this.value=this.input.value:this.value=this.empty)}renderInput(){return f`
            <div class="input-group ${this.validationMap}" >
                ...
                />
                <span class="input-group-text" style="max-width:5em">${y(this.value)?"~":this.value}</span>
            </div>`}rgbaToHex(t){const e=t.match(ut);if(!e)throw new Error("Invalid RGBA format");const[,s,i,r,n]=e.map(Number),a=t=>{const e=t.toString(16);return 1===e.length?"0"+e:e};return`#${`${a(s)}${a(i)}${a(r)}`}`}};pt=t([r("fz-color")],pt);
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mt=t=>t??k;let ft=class extends st{toField(){if(g(this.input)){const t=/\d\d\d\d-\d\d-\d\d/;this.input.valueAsDate=t.test(this.value)?new Date(this.value):null}}toValue(){g(this.input)&&(this.value=g(this.input.valueAsDate)?function(t=new Date){return t.toISOString().substring(0,10)}(this.input.valueAsDate):void 0)}renderInput(){return f`<input
            id="input" 
            type="date" 
            @input="${this.change}"
            ?readonly="${this.readonly}" 
        ...
        />`}get min(){return this.schema?.minimum}get max(){return this.schema?.maximum}};ft=t([r("fz-date")],ft);let gt=class extends st{toField(){if(g(this.input)){const t=/\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\dZ?/;this.input.valueAsDate?this.input.valueAsDate=t.test(this.value)?new Date(this.value.substring(0,16)):null:this.input.value=t.test(this.value)?this.value.substring(0,16):""}}toValue(){g(this.input)&&(this.value=g(this.input.valueAsDate)?function(t=new Date){return t.toISOString().slice(0,-5)+"Z"}(this.input.valueAsDate):void 0)}renderInput(){return f`<input 
            id="input" 
            type="datetime-local" 
            @input="${this.change}"
            min="${mt(this.min)}"
            ...
            class="form-control ${this.validationMap}"
            autocomplete=off  spellcheck="false"
        />`}get min(){return this.schema?.minimum}get max(){return this.schema?.maximum}};gt=t([r("fz-datetime")],gt);let bt=class extends st{toField(){g(this.input)&&(this.input.valueAsDate=new Date(this.value))}toValue(){g(this.input)&&(this.value=g(this.input.valueAsDate)?function(t=new Date){return t.toISOString().substring(11,19)}(this.input.valueAsDate):void 0)}renderInput(){return f`
            <input 
                ...
                ?required="${this.required}"
                autocomplete=off  spellcheck="false"
            />`}};bt=t([r("fz-time")],bt);let $t=class extends st{toField(){g(this.input)&&(this.input.value=String(this.value??""))}toValue(){g(this.input)&&(this.value=g(this.input.value)?this.input.value:void 0)}renderInput(){return f`
            <textarea  
                class="form-control ${this.validationMap}" 
                id="input"
                ...
                ?required="${this.required}"
                rows="5"
            ></textarea>`}get minlength(){return this.schema?.minLength}get maxlength(){return this.schema?.maxLength}get pattern(){return this.schema?.pattern}};$t=t([r("fz-textarea")],$t);let vt=class extends st{toField(){g(this.input)&&(this.input.value=String(this.value??""))}toValue(){g(this.input)&&(this.value=g(this.input.value)&&""!=this.input.value?this.input.value:this.empty)}static get styles(){return[...super.styles,m`
            input[type="color"] {
                height: 38px
        ...
        `}tryChange(t){this.readonly?t.preventDefault():this.change()}get label(){return""}toField(){if(!y(this.input))switch(!0){case void 0===this.value:case null===this.value&&this.schema.nullAllowed:this.input.indeterminate=!0,this.input.checked=!1;break;case z(this.value):this.input.indeterminate=!1,this.input.checked=this.value;break;default:this.input.indeterminate=!0,this.input.checked=!1}}toValue(){y(this.input)||(this.input.indeterminate?this.value=this.schema.nullAllowed?null:void 0:this.value=!!this.input.checked)}};xt=t([r("fz-boolean")],xt);const kt=1.1.toLocaleString().substring(1,2);let zt=class extends st{toField(){g(this.input)&&(S(this.value)?this.input.valueAsNumber=this.value:this.input.value="")}toValue(){g(this.input)&&(this.value=S(this.input.valueAsNumber)?this.input.valueAsNumber:void 0)}static get styles(){return[...super.styles,m`
            ...
            <div class="input-group">
                <input 
                    ...
                    autocomplete=off  spellcheck="false"
                />
            </div>`}get max(){return S(this.schema?.maximum)?this.schema.maximum:S(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return S(this.schema?.minimum)?this.schema.minimum:S(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}keypress(t){/[.,]/.test(t.key)&&kt!==t.key&&t.preventDefault()}};zt=t([r("fz-float")],zt);let St=class extends st{toField(){g(this.input)&&(this.input.valueAsNumber=S(this.value)?Math.floor(this.value):NaN)}toValue(){g(this.input)&&(this.value=S(this.input.valueAsNumber)?this.input.valueAsNumber:void 0)}static get styles(){return[...super.styles,m`
          ...
          `]}renderInput(){return f`
            ...
            </div>`}get max(){return S(this.schema?.maximum)?this.schema.maximum:S(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return S(this.schema?.minimum)?this.schema.minimum:S(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}keypress(){}};St=t([r("fz-range")],St);let _t=class extends st{watchId;toField(){g(this.input)&&(this.input.value=String(this.value??""))}toValue(){g(this.input)&&(this.value=g(this.input.value)?this.input.value:void 0)}static get styles(){return[...super.styles,m`
            input[type="color"] {
                height: 38px
            }`]}renderInput(){return f`
            <div class="input-group ${this.validationMap}">
            ...
            <div class="input-group">
                <input 
                    ...
                    autocomplete=off  spellcheck="false"
                />
            </div>`}get max(){return S(this.schema?.maximum)?this.schema.maximum:S(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return S(this.schema?.minimum)?this.schema.minimum:S(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}keypress(t){}};Et=t([r("fz-integer")],Et);let It=class extends st{toField(){g(this.input)&&(this.input.value=String(this.schema.const??""))}toValue(){this.value=this.schema.const}renderInput(){return f`<div class="input-group ${this.validationMap}">${this.value}</div>`}connectedCallback(){super.connectedCallback(),this.value!==this.schema.const&&(this.value=this.schema.const)}};It=t([r("fz-constant")],It);const Ot=[];for(let t=0;t<256;++t)Ot.push((t+256).toString(16).slice(1));let jt;const Ft=new Uint8Array(16);const Ct={};function Nt(t,e,s){let i;{const t=Date.now(),r=function(){if(!jt){if("undefined"==typeof crypto||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");jt=crypto.getRandomValues.bind(crypto)}return jt(Ft)}();!function(t,e,s){t.msecs??=-1/0,t.nsecs??=0,e===t.msecs?(t.nsecs++,t.nsecs>=1e4&&(t.node=void 0,t.nsecs=0)):e>t.msecs?t.nsecs=0:e<t.msecs&&(t.node=void 0);t.node||(t.node=s.slice(10,16),t.node[0]|=1,t.clockseq=16383&(s[8]<<8|s[9]));t.msecs=e}(Ct,t,r),i=function(t,e,s,i,r,n,a=0){if(t.length<16)throw new Error("Random bytes length must be >= 16");if(n){if(a<0||a+16>n.length)throw new RangeError(`UUID byte range ${a}:${a+15} is out of buffer bounds`)}else n=new Uint8Array(16),a=0;e??=Date.now(),s??=0,i??=16383&(t[8]<<8|t[9]),r??=t.slice(10,16);const o=(1e4*(268435455&(e+=122192928e5))+s)%4294967296;n[a++]=o>>>24&255,n[a++]=o>>>16&255,n[a++]=o>>>8&255,n[a++]=255&o;const h=e/4294967296*1e4&268435455;n[a++]=h>>>8&255,n[a++]=255&h,n[a++]=h>>>24&15|16,n[a++]=h>>>16&255,n[a++]=i>>>8|128,n[a++]=255&i;for(let t=0;t<6;++t)n[a++]=r[t];return n}(r,Ct.msecs,Ct.nsecs,Ct.clockseq,Ct.node,e,s)}return e??function(t,e=0){return(Ot[t[e+0]]+Ot[t[e+1]]+Ot[t[e+2]]+Ot[t[e+3]]+"-"+Ot[t[e+4]]+Ot[t[e+5]]+"-"+Ot[t[e+6]]+Ot[t[e+7]]+"-"+Ot[t[e+8]]+Ot[t[e+9]]+"-"+Ot[t[e+10]]+Ot[t[e+11]]+Ot[t[e+12]]+Ot[t[e+13]]+Ot[t[e+14]]+Ot[t[e+15]]).toLowerCase()}(i)}var At;let Mt=class extends st{static{At=this}toField(){g(this.input)&&(this.input.value=String(this.value??""))}toValue(){g(this.input)&&(this.value=g(this.input.value)?this.input.value:void 0)}static docTypes=["image/png","image/jpeg","image/gif","text/plain","application/pdf","application/msword","application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/vnd.ms-excel","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","application/vnd.ms-powerpoint","application/vnd.openxmlformats-officedocument.presentationml.presentation","application/vnd.oasis.opendocument.text","application/vnd.oasis.opendocument.spreadsheet","application/vnd.oasis.opendocument.presentation","application/vnd.oasis.opendocument.graphics"];photoModal;url="";filename;get hasPreview(){return!!this.schema.preview}get mimetype(){return this.schema.mimetype?this.schema.mimetype:At.docTypes.join(", ")}get store(){return this.form.store}static get styles(){return[...super.styles,m`
                .fileUpload {
                    position: relative;
                    overflow: hidden;
                    margin: 0px;
            ...
            <div class="input-group">
                ...
                <input class="form-control ${this.validationMap}"  type="text" spellcheck="false"
                    ...
                    autocomplete=off  spellcheck="false"
                />
                ${this.isEmpty||this.readonly?f``:f`
        ...
        `}};Rt=t([r("fz-markdown")],Rt);let Dt=class extends st{toField(){g(this.input)&&(this.input.value=String(this.value??""))}toValue(){g(this.input)&&(this.value=g(this.input.value)?this.input.value:this.empty)}renderInput(){return f`
                        ...
                        <ul id="content" class="list-group">
                            ...
                            ${this.readonly?f``:f`
                                <li class="list-group-item" @click="${this.close}">
                                    ...
                                    ${this.schema.homogeneous?null:f`
                                        <div class="btn-group" style="float:right" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ${this.schema.items?.oneOf?.map(((t,e)=>f`<a class="dropdown-item"
            ...
            </div>`}renderStatic(t){return this.solveOrder(),this.solveSchemas(),f`
        <li 
                id="${t}"
                draggable="true" 
            ...
            ${this.readonly?f``:f`<button ?hidden="${this.noless}" @click="${e=>this.del(t,e)}" type="button" style="float:right" class="btn-close" aria-label="Close"></button>`}
                ...
                <div class="card shadow" style="margin-bottom:5px">
                ...
                </div>`),s}renderTabGroup(t,e,s){const i=[],r=e[s].groupnum,n=e[s].groupname,a=e[s].tabname;for(;s<e.length&&r===e[s].groupnum;s++){const t=e[s].fieldname,r=this.schema.properties?.[t],o=this.activegroup[a]!==n;i.push(f`<div 
                    ...
                    </div>`)}return t.push(f`${i}`),s}renderTab(t,e,s){const i=[],r=e[s].tabnum,n=e[s].tabname,a=s;for(this.activegroup[n]=e[s].groupname;s<e.length&&r===e[s].tabnum;)s=this.renderTabGroup(i,e,s);const o={};for(let t=a;t<s;t++){o[e[t].groupname]=1}const h=Object.keys(o);return t.push(f`<ul class="nav nav-tabs" id="content">
                ${h.map((t=>f`<li class="nav-item">
                        <a class="nav-link" data-tabname="${n}" data-groupname="${t}" @click="${this.toggleTab}" aria-current="page" href="#" data-toggle="tab" href="#${t}">${t}</a>
                    </li>`))}
            </ul>`),t.push(f`<div class="tab-content border border-top-0" id="content" style="padding-bottom:5px;margin-bottom:5px">${i}</div>`),s}get deletable(){return null!=this.schema.parent&&!this.isEmpty&&(!(!this.schema.nullAllowed||!this.nullable)||!this.schema.nullAllowed&&!this.required)}async delete(){null!==this.collapsed&&(this.collapsed=!0),this.value=this.empty}renderField(){if(!this.schema?.properties)return f``;const t=[],e=this.schema.order;let s=0;for(;e&&s<e.length;){const i=e[s];s=i.tabname&&i.groupname?this.renderTab(t,e,s):i.groupname?this.renderGroup(t,e,s):this.renderSingle(t,e,s)}return f`${this.isItem?f`<div>${this.renderLabel}</div>${t}`:""===(this.schema.title??"")?f`<div ?hidden="${this.collapsed}" > ${t} </div>`:f`<div class="panel ${this.schema.parent?"":"border-0"}" id="content" >
                <div class="panel-heading" ?hidden="${!this.schema.parent}" >
                    <div>
                        ${this.renderLabel}
                        ${this.collapsed?f`${this.abstract()}`:f``}
                        <button
 ...
 */let Zt=class extends Lt{toField(){}toValue(){}renderField(){return f`
            ...
            </div>`}connectedCallback(){super.connectedCallback()}toggle(t){if(null==this.value&&(this.value=[]),this.value.includes(t)){const e=this.value.indexOf(t);e>=0&&this.value.splice(e,1)}else this.value.push(t)}getItems(){const t=this.schema.items?.enum,e=this.data;if(t)return t.reduce(((t,s)=>(this.evalExpr("filter",this.schema.items,s,e[this.key],-1)&&t.push({label:String(s),value:s}),t)),[]);const s=this.schema.items?.oneOf;return s?s.reduce(((t,e)=>(this.evalExpr("filter",e,e.const,this.data[this.key],-1)&&t.push({label:e.title??e.description??e.const,value:e.const}),t)),[]):[]}};Zt=t([r("fz-enum-array")],Zt);let Ht=class extends d{modal;backdrop;validable=!1;#g="Dialogue";get modalTitle(){return this.#g}set modalTitle(t){this.#g=t}#b="Valider";get okLabel(){return this.#b}set okLabel(t){this.#b=t}#$="Annuler";get dismissLabel(){return this.#$}set dismissLabel(t){this.#$=t}static get styles(){return[...super.styles,m`
            .modal-body {
            ...
            </div>`:null}renderError(){if(this.validator?.schemaValid&&this.validator?.valid)return f``;const t=t=>f`<li>property : ${null==t.dataPath?t.instancePath:t.dataPath} : ${t.keyword} ➜ ${t.message}</li>`;return[f`<hr>`,this.validator?.schemaValid?f``:f`<pre><ol> Schema errors : ${this.validator?.schemaErrors.map(t)} </ol></pre>`,this.validator?.valid?f``:f`<pre><ol> Data errors : ${this.validator?.errors.map(t)} </ol></pre>`]}connectedCallback(){super.connectedCallback(),this.listen(this,"data-updated",(t=>this.handleDataUpdate(t))),this.dispatchEvent(new CustomEvent("init"))}disconnectedCallback(){super.disconnectedCallback(),this.i_options=void 0,this.store=void 0,this.asset=void 0,this.fieldMap.clear(),this.schemaMap.clear(),this.useAjv=void 0,this.useMarkdown=void 0,this.sourceSchema=H,this.actions=void 0,this.readonly=void 0,this.checkIn=void 0,this.checkOut=void 0,this.oninit=void 0,this.onready=void 0,this.onvaliddata=void 0,this.oninvaliddata=void 0,this.onvalidate=void 0,this.ondismiss=void 0,this.compiledSchema=void 0,this.validator=void 0,this.message=void 0}async firstUpdated(t){super.firstUpdated(t),this.check()}check(t=!1){const e=this.valid,s=e?this.validator?.errorMap():void 0;for(const[e,i]of this.fieldMap.entries())(i.errors!=T||t)&&(i.errors=s?.get(e)??U);const i=new CustomEvent(e?"data-valid":"data-invalid");this.dispatchEvent(i)}handleDataUpdate(t){if(this===t.composedPath()[0])return;t.detail.trackers.forEach((t=>{const e=this.getfieldFromSchema(t);e?.trackedValueChange()}))}confirm(t){t.preventDefault(),t.stopPropagation();const e=new CustomEvent("validate");this.dispatchEvent(e)}cancel(t){t.preventDefault(),t.stopPropagation();const e=new CustomEvent("dismiss");this.dispatchEvent(e)}compile(){const t=new $e(this.compiledSchema,this.options,this.i_root.content).compile();if(t.length>0)return void(this.message=`Schema compilation failed: \n    - ${t.join("\n    - ")}`);const e=new Re(this.i_root.content,this.schema).compile();e.length>0&&(this.message=`Data compilation failed: \n    - ${e.join("\n    - ")}`),this.dispatchEvent(new CustomEvent("ready"))}debug(t){const e=this.fieldMap.get(t);if(!e)throw new Error(`No field found for pointer: ${t}`);if(!e.data||!e.key)throw new Error(`Field at ${t} has no parent/key`);const s=e.data,i=e.key;let r=s[i];Object.defineProperty(s,i,{get:()=>r,set(t){r=t},configurable:!0,enumerable:!0})}static async loadBootstrap(t,e,s){if(!d.isBootStrapLoaded()){await d.registerBootstrap(t,e,s);for(const t of document.getElementsByTagName("fz-form"))t.requestUpdate()}}};t([e({type:Boolean,attribute:"useajv"})],qe.prototype,"useAjv",void 0),t([e({type:Boolean,attribute:"usemarkdown"})],qe.prototype,"useMarkdown",void 0),t([e({type:Object,attribute:"schema",converter:Z})],qe.prototype,"sourceSchema",null),t([e({type:Boolean,attribute:"actions"})],qe.prototype,"actions",null),t([e({type:Boolean,attribute:"readonly"})],qe.prototype,"readonly",null),t([e({type:Boolean,attribute:"checkin"})],qe.prototype,"checkIn",null),t([e({type:Boolean,attribute:"checkout"})],qe.prototype,"checkOut",null),t([e({type:String,attribute:"oninit",converter:t=>t})],qe.prototype,"oninit",void 0),t([e({type:String,attribute:"onready",converter:t=>t})],qe.prototype,"onready",void 0),t([e({type:String,attribute:"onvaliddata",converter:t=>t})],qe.prototype,"onvaliddata",void 0),t([e({type:String,attribute:"oninvaliddata",converter:t=>t})],qe.prototype,"oninvaliddata",void 0),t([e({type:String,attribute:"onvalidate",converter:t=>t})],qe.prototype,"onvalidate",void 0),t([e({type:String,attribute:"ondismiss",converter:t=>t})],qe.prototype,"ondismiss",void 0),qe=t([r("fz-form")],qe),window.FzForm=qe;export{qe as FzForm,_ as FzMarkdownIt};
