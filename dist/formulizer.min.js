 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let me=class extends ae{#c=!1;get isopen(){return this.#c}set isopen(t){this.#c=t}#a=-1;get selected(){return this.#a}set selected(t){this.#a=t}filtered=[];toField(){if(this.queryElem)if($t(this.value)||$t(this.enums))this.queryElem.value="",this.selected=-1;else{const t=this.enums.find((t=>t.value==this.value));this.queryElem.value=t?t.title:"",this.selected=t?0:-1}else this.selected=-1}toValue(){this.selected>=0&&(this.value=this.filtered[this.selected].value)}renderEnum(){if(this.enums==ne)return Y`
                <div class="form-control d-flex align-items-center">
                    <div class="spinner-border spinner-border-sm text-secondary me-2" role="status">
                        <span class="visually-hidden">Loading...</span>
                    </div>
            ...
            </div>`}rgbaToHex(t){const e=t.match(be);if(!e)throw new Error("Invalid RGBA format");const[,s,i,r,n]=e.map(Number),o=t=>{const e=t.toString(16);return 1===e.length?"0"+e:e};return`#${`${o(s)}${o(i)}${o(r)}`}`}};ge=t([e("fz-color")],ge);
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $e=t=>t??Q;let ve=class extends re{toField(){if(gt(this.input)){const t=/\d\d\d\d-\d\d-\d\d/;this.input.valueAsDate=t.test(this.value)?new Date(this.value):null}}toValue(){gt(this.input)&&(this.value=gt(this.input.valueAsDate)?function(t=new Date){return t.toISOString().substring(0,10)}(this.input.valueAsDate):void 0)}renderInput(){return Y`<input
            id="input" 
            type="date" 
            @input="${this.change}"
            ?readonly="${this.readonly}" 
        ...
        />`}get min(){return this.schema?.minimum}get max(){return this.schema?.maximum}};ve=t([e("fz-date")],ve);let ye=class extends re{toField(){if(gt(this.input)){const t=/\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\dZ?/;this.input.valueAsDate?this.input.valueAsDate=t.test(this.value)?new Date(this.value.substring(0,16)):null:this.input.value=t.test(this.value)?this.value.substring(0,16):""}}toValue(){gt(this.input)&&(this.value=gt(this.input.valueAsDate)?function(t=new Date){return t.toISOString().slice(0,-5)+"Z"}(this.input.valueAsDate):void 0)}renderInput(){return Y`<input 
            ...
            class="form-control ${this.validation}"
            autocomplete=off  spellcheck="false"
        />`}get min(){return this.schema?.minimum}get max(){return this.schema?.maximum}};ye=t([e("fz-datetime")],ye);let we=class extends re{toField(){gt(this.input)&&(this.input.valueAsDate=new Date(this.value))}toValue(){gt(this.input)&&(this.value=gt(this.input.valueAsDate)?function(t=new Date){return t.toISOString().substring(11,19)}(this.input.valueAsDate):void 0)}renderInput(){return Y`
            <input 
                ...
                ?required="${this.required}"
                autocomplete=off  spellcheck="false"
            />`}};we=t([e("fz-time")],we);let xe=class extends re{toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=vt(this.input.value,!0)?this.input.value:void 0)}renderInput(){return Y`
            <textarea  
                id="input"
                ?readonly="${this.readonly}"
                ?required="${this.required}"
                ...
                rows="5"
                class="form-control ${this.validation}" 
            ></textarea>`}get minlength(){return this.schema?.minLength}get maxlength(){return this.schema?.maxLength}get pattern(){return this.schema?.pattern}};xe=t([e("fz-textarea")],xe);let ke=class extends re{toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=gt(this.input.value)&&""!=this.input.value?this.input.value:this.empty)}static get styles(){return[...super.styles,a`
            input[type="color"] {
                height: 38px
            ...
            <div class="input-group" >
                <input
                    ...
                    class="form-control ${this.validation}" 
                />
            </div>`}get minlength(){return this.schema?.minLength}get maxlength(){return this.schema?.maxLength}get pattern(){return this.schema?.pattern}get type(){switch(this.schema?.format){case"color":return"color";case"email":return"email";case"password":return"password";case"uri":return"url";default:return"text"}}};ke=t([e("fz-string")],ke);let ze=class extends re{toField(){this.input&&(this.input.value=this.value??"")}toValue(){this.input&&(this.value=this.input.value)}renderInput(){return Y`
            <div class="input-group">
                <input
                    class="form-control ${this.validation}"
                    type="text"
        ...
        `}tryChange(t){this.readonly?t.preventDefault():this.change()}toField(){if(!$t(this.input))switch(!0){case void 0===this.value:case null===this.value&&this.schema.nullAllowed:this.input.indeterminate=!0,this.input.checked=!1;break;case wt(this.value):this.input.indeterminate=!1,this.input.checked=this.value;break;default:this.input.indeterminate=!0,this.input.checked=!1}}toValue(){$t(this.input)||(this.input.indeterminate?this.value=this.schema.nullAllowed?null:void 0:this.value=!!this.input.checked)}};_e=t([e("fz-boolean")],_e);const Ee=1.1.toLocaleString().substring(1,2);let Oe=class extends re{toField(){gt(this.input)&&(yt(this.value)?this.input.valueAsNumber=this.value:this.input.value="")}toValue(){gt(this.input)&&(this.value=yt(this.input.valueAsNumber)?this.input.valueAsNumber:void 0)}static get styles(){return[...super.styles,a`
            ...
            <div class="input-group">
                <input 
                    ...
                    autocomplete=off  spellcheck="false"
                />
            </div>`}get max(){return yt(this.schema?.maximum)?this.schema.maximum:yt(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return yt(this.schema?.minimum)?this.schema.minimum:yt(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}keypress(t){/[.,]/.test(t.key)&&Ee!==t.key&&t.preventDefault()}};Oe=t([e("fz-float")],Oe);let Ie=class extends re{toField(){gt(this.input)&&(this.input.valueAsNumber=yt(this.value)?Math.floor(this.value):NaN)}toValue(){gt(this.input)&&(this.value=yt(this.input.valueAsNumber)?this.input.valueAsNumber:void 0)}static get styles(){return[...super.styles,a`
          ...
          `]}renderInput(){return Y`
            ...
            </div>`}get max(){return yt(this.schema?.maximum)?this.schema.maximum:yt(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return yt(this.schema?.minimum)?this.schema.minimum:yt(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}keypress(){}};Ie=t([e("fz-range")],Ie);let Ce=class extends re{watchId;toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=gt(this.input.value)?this.input.value:void 0)}static get styles(){return[...super.styles,a`
            input[type="color"] {
                height: 38px
            }`]}renderInput(){return Y`
            <div class="input-group ${this.validation}">
            ...
            <div class="input-group">
                <input 
                    ...
                    autocomplete=off  spellcheck="false"
                />
            </div>`}get max(){return yt(this.schema?.maximum)?this.schema.maximum:yt(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return yt(this.schema?.minimum)?this.schema.minimum:yt(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}keypress(t){}};je=t([e("fz-integer")],je);let Ae=class extends re{toField(){gt(this.input)&&(this.input.value=String(this.schema.const??""))}toValue(){this.value=this.schema.const}renderInput(){return Y`<div class="input-group ${this.validation}">${this.value}</div>`}connectedCallback(){super.connectedCallback(),this.value!==this.schema.const&&(this.value=this.schema.const)}};Ae=t([e("fz-const")],Ae);const Fe=[];for(let t=0;t<256;++t)Fe.push((t+256).toString(16).slice(1));let Ne;const Me=new Uint8Array(16);const Re={};function Ue(t,e,s){let i;{const t=Date.now(),r=function(){if(!Ne){if("undefined"==typeof crypto||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");Ne=crypto.getRandomValues.bind(crypto)}return Ne(Me)}();!function(t,e,s){t.msecs??=-1/0,t.nsecs??=0,e===t.msecs?(t.nsecs++,t.nsecs>=1e4&&(t.node=void 0,t.nsecs=0)):e>t.msecs?t.nsecs=0:e<t.msecs&&(t.node=void 0);t.node||(t.node=s.slice(10,16),t.node[0]|=1,t.clockseq=16383&(s[8]<<8|s[9]));t.msecs=e}(Re,t,r),i=function(t,e,s,i,r,n,o=0){if(t.length<16)throw new Error("Random bytes length must be >= 16");if(n){if(o<0||o+16>n.length)throw new RangeError(`UUID byte range ${o}:${o+15} is out of buffer bounds`)}else n=new Uint8Array(16),o=0;e??=Date.now(),s??=0,i??=16383&(t[8]<<8|t[9]),r??=t.slice(10,16);const a=(1e4*(268435455&(e+=122192928e5))+s)%4294967296;n[o++]=a>>>24&255,n[o++]=a>>>16&255,n[o++]=a>>>8&255,n[o++]=255&a;const h=e/4294967296*1e4&268435455;n[o++]=h>>>8&255,n[o++]=255&h,n[o++]=h>>>24&15|16,n[o++]=h>>>16&255,n[o++]=i>>>8|128,n[o++]=255&i;for(let t=0;t<6;++t)n[o++]=r[t];return n}(r,Re.msecs,Re.nsecs,Re.clockseq,Re.node,e,s)}return e??function(t,e=0){return(Fe[t[e+0]]+Fe[t[e+1]]+Fe[t[e+2]]+Fe[t[e+3]]+"-"+Fe[t[e+4]]+Fe[t[e+5]]+"-"+Fe[t[e+6]]+Fe[t[e+7]]+"-"+Fe[t[e+8]]+Fe[t[e+9]]+"-"+Fe[t[e+10]]+Fe[t[e+11]]+Fe[t[e+12]]+Fe[t[e+13]]+Fe[t[e+14]]+Fe[t[e+15]]).toLowerCase()}(i)}var Te;let Le=class extends re{static{Te=this}toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=gt(this.input.value)?this.input.value:void 0)}static docTypes=["image/png","image/jpeg","image/gif","text/plain","application/pdf","application/msword","application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/vnd.ms-excel","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","application/vnd.ms-powerpoint","application/vnd.openxmlformats-officedocument.presentationml.presentation","application/vnd.oasis.opendocument.text","application/vnd.oasis.opendocument.spreadsheet","application/vnd.oasis.opendocument.presentation","application/vnd.oasis.opendocument.graphics"];photoModal;url="";filename;get hasPreview(){return!!this.schema.preview}get mimetype(){return this.schema.mimetype?this.schema.mimetype:Te.docTypes.join(", ")}get store(){return this.form.store}static get styles(){return[...super.styles,a`
                .fileUpload {
                    position: relative;
                    overflow: hidden;
                    margin: 0px;
            ...
            </div>`}change(){super.change(),this.requestUpdate()}connectedCallback(){super.connectedCallback()}async firstUpdated(t){if(super.firstUpdated(t),this.photoModal=this.shadowRoot?.querySelector("fz-photo-dlg")??void 0,this.listen(this.photoModal,"close",(t=>this.set(Ue(),t.detail.blob,"photo.png"))),null!=this.value){const t=await this.store.get(this.value);t?this.set(this.value,t.blob,t.filename):(this.dirty=!0,this.localError="document not found")}}async open(){if(null==this.value)return;const t=await this.store.get(this.value);let e;if(t)e=URL.createObjectURL(t.blob);else{const t=new Blob([`FzForm ERROR: Couldn't open document uuid=${this.value}`],{type:"text/plain"});e=URL.createObjectURL(t)}window.open(e)}setUrl(t){if(this.url="",t.type.startsWith("image")){const e=new FileReader;e.readAsDataURL(t),e.onload=t=>{this.url=t.target?.result,this.requestUpdate()}}}async set(t,e,s){e&&s&&(this.value&&await this.store.remove(this.value),this.filename=s,this.value=t,this.setUrl(e),this.value&&await this.store.put(this.value,e,this.filename,this.pointer),this.change())}async save(t){await this.set(Ue(),t.target.files[0],t.target.files[0].name)}async delete(){this.value&&await this.store.remove(this.value),this.value=this.empty,this.url="",this.filename="",this.change()}};Le=Te=t([e("fz-doc")],Le);let De=null;let Pe=class extends Dt{markdown="";static styles=[...super.styles,a`
            blockquote {
                padding: 10px 20px;
                margin: 0 0 20px;
                font-size: 17.5px;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ss=class extends Je{toField(){}toValue(){}renderCollapsed(){return this.renderField()}renderField(){return Y`
            <div class="form-group row">
                ${this.renderLabel()}
                <div class="col-sm">
            ...
            </div>`}connectedCallback(){super.connectedCallback()}toggleItem(t){if(null==this.value&&(this.value=[]),this.value.includes(t)){const e=this.value.indexOf(t);e>=0&&this.value.splice(e,1)}else this.value.push(t)}getItems(){const t=this.schema.items?.enum,e=this.data;if(t)return t.reduce(((t,s)=>(this.evalExpr("filter",this.schema.items,s,e[this.key],-1)&&t.push({label:String(s),value:s}),t)),[]);const s=this.schema.items?.oneOf;return s?s.reduce(((t,e)=>(this.evalExpr("filter",e,e.const,this.data[this.key],-1)&&t.push({label:e.title??e.description??e.const,value:e.const}),t)),[]):[]}};ss=t([e("fz-enum-array")],ss);let is=class extends Dt{modal;backdrop;validable=!1;#m="Dialogue";get modalTitle(){return this.#m}set modalTitle(t){this.#m=t}#b="Valider";get okLabel(){return this.#b}set okLabel(t){this.#b=t}#g="Annuler";get dismissLabel(){return this.#g}set dismissLabel(t){this.#g=t}static get styles(){return[...super.styles,a`
            .modal-body {
            ...
            </fz-dialog>`}updated(t){this.reference?(this.pointer=this.reference?.pointer,this.array=this.reference?.target,this.refname=this.reference?.name,this.arraySchema=Ut(this.array)):(this.pointer=void 0,this.array=void 0,this.refname=void 0,this.arraySchema=void 0,this.itemSchema=void 0)}toggleDropdown(){const t=this.shadowRoot?.querySelector(".dropdown-menu");t?.style.setProperty("display","block"==t?.style.display?"none":"block")}addItem(t){this.itemSchema=t;const e=this.itemSchema._default(this.array);this.index=this.array?.length,this.array?.push(e),this.modal?.valid(),this.requestUpdate()}stopEvent(t){t.preventDefault(),t.stopPropagation()}close(t){const e=t.detail;if(!t.detail.dismissed){const e=this.shadowRoot?.getElementById("form-object");t.detail.value=e.value[this.refname??"id"],t.detail.abstract=e.abstract()}this.reference=void 0,this.stopEvent(t),this.dispatchEvent(new CustomEvent("close",{detail:e})),this.modal?.valid(!1)}firstUpdated(){this.modal=this.shadowRoot?.querySelector("fz-dialog")}open(){this.modal&&this.modal.open(),this.arraySchema?.homogeneous&&void 0===this.index&&this.arraySchema?.items&&this.addItem(this.arraySchema?.items)}};t([_({type:Object})],ls.prototype,"reference",null),ls=t([e("fz-item-dlg")],ls);class cs{static levels={DEBUG:0,INFO:1,WARN:2,ERROR:3,NONE:4};static registry=new Map;static set(...t){let e="NONE";for(const s of t)["DEBUG","INFO","WARN","ERROR","NONE"].includes(s)?e=s:FzLogger.registry.set(s,e)}static get(t,e){function s(t,e){let s=Object.getPrototypeOf(t??{});for(;s;){if(s.constructor?.name===e)return!0;s=Object.getPrototypeOf(s)}return!1}const i=[];for(const t in e)(s(e[t],"FzField")||s(e[t],"Schema"))&&i.push(`${t}: ${e[t].pointer}`);const r=(e,...s)=>{if(!(e=>{const s=FzLogger.registry.get(t);return null!=s&&FzLogger.levels[e]>=FzLogger.levels[s]})(e))return;((t,...e)=>{i.join(" ")})(s.shift(),...s)};return{debug:(...t)=>r("DEBUG",...t),info:(...t)=>r("INFO",...t),warn:(...t)=>r("WARN",...t),error:(...t)=>r("ERROR",...t),if:{debug:(t,...e)=>t&&r("DEBUG",...e),info:(t,...e)=>t&&r("INFO",...e),warn:(t,...e)=>t&&r("WARN",...e),error:(t,...e)=>t&&r("ERROR",...e)}}}}globalThis.FzLogger=cs;var ds={$schema:"http://json-schema.org/draft-07/schema#",$id:"http://json-schema.org/draft-07/schema-3s#",title:"Core schema meta-schema",definitions:{schemaArray:{type:"array",minItems:1,items:{$ref:"#"}},nonNegativeInteger:{type:"integer",minimum:0},nonNegativeIntegerDefault0:{allOf:[{$ref:"#/definitions/nonNegativeInteger"},{default:0}]},simpleTypes:{enum:["array","boolean","integer","null","number","object","string"]},stringArray:{type:"array",items:{type:"string"},uniqueItems:!0,default:[]}},type:["object","boolean"],properties:{$id:{type:"string",format:"uri-reference"},$schema:{type:"string",format:"uri"},$ref:{type:"string",format:"uri-reference"},$comment:{type:"string"},title:{type:"string"},description:{type:"string"},default:!0,readOnly:{type:"boolean",default:!1},examples:{type:"array",items:!0},multipleOf:{type:"number",exclusiveMinimum:0},maximum:{type:"number"},exclusiveMaximum:{type:"number"},minimum:{type:"number"},exclusiveMinimum:{type:"number"},maxLength:{$ref:"#/definitions/nonNegativeInteger"},minLength:{$ref:"#/definitions/nonNegativeIntegerDefault0"},pattern:{type:"string",format:"regex"},additionalItems:{$ref:"#"},items:{anyOf:[{$ref:"#"},{$ref:"#/definitions/schemaArray"}],default:!0},maxItems:{$ref:"#/definitions/nonNegativeInteger"},minItems:{$ref:"#/definitions/nonNegativeIntegerDefault0"},uniqueItems:{type:"boolean",default:!1},contains:{$ref:"#"},maxProperties:{$ref:"#/definitions/nonNegativeInteger"},minProperties:{$ref:"#/definitions/nonNegativeIntegerDefault0"},required:{$ref:"#/definitions/stringArray"},additionalProperties:{$ref:"#"},definitions:{type:"object",additionalProperties:{$ref:"#"},default:{}},properties:{type:"object",additionalProperties:{$ref:"#"},default:{}},patternProperties:{type:"object",additionalProperties:{$ref:"#"},propertyNames:{format:"regex"},default:{}},dependencies:{type:"object",additionalProperties:{anyOf:[{$ref:"#"},{$ref:"#/definitions/stringArray"}]}},propertyNames:{$ref:"#"},const:!0,enum:{type:"array",items:!0,minItems:1,uniqueItems:!0},type:{anyOf:[{$ref:"#/definitions/simpleTypes"},{type:"array",items:{$ref:"#/definitions/simpleTypes"},minItems:1,uniqueItems:!0}]},format:{type:"string"},contentMediaType:{type:"string"},contentEncoding:{type:"string"},if:{$ref:"#"},then:{$ref:"#"},else:{$ref:"#"},allOf:{$ref:"#/definitions/schemaArray"},anyOf:{$ref:"#/definitions/schemaArray"},oneOf:{$ref:"#/definitions/schemaArray"},not:{$ref:"#"}},default:!0};let us,ps,fs;async function ms(t=!1){if(t){{const t=await import("./ajv-dynamic.min.js").then((function(t){return t.a}));us=t.default}{const t=await import("./ajv-dynamic.min.js").then((function(t){return t.i}));ps=t.default}{const t=await import("./ajv-dynamic.min.js").then((function(t){return t.b}));fs=t.default}}}ms(!1);class bs{get schemaValid(){return!0}get schemaErrors(){return[]}get valid(){return!0}validate(t){}get errors(){return[]}get map(){const t=new Map;for(const e of this.errors){let{instancePath:s,message:i,params:r,keyword:n}=e;"required"===n&&(s=`/${r.missingProperty}`,i="required"),t.has(s)||t.set(s,[]),t.get(s)?.push(i??"unidentified error")}return t}static get loaded(){return null!=us}static getValidator(t){if(null==us)return new gs(t);const e=new us({allErrors:!0,allowUnionTypes:!0,strictSchema:!0,strictNumbers:!1,coerceTypes:!1});return fs(e),Vt.forEach((t=>e.addFormat(t,/./))),Bt.forEach((t=>e.addKeyword({keyword:t,valid:!0}))),new $s(e,t)}static async loadValidator(t=!1){t&&!bs.loaded&&await ms(t)}}class gs extends bs{constructor(t){super()}}class $s extends bs{ajv;dataParser;schemaParser;constructor(t,e){super(),this.ajv=t,this.schemaParser=this.ajv.compile(ds),this.schemaParser(e),ps(this.schemaParser.errors),this.dataParser=this.ajv.compile(e)}get schemaValid(){return 0==(this.schemaParser.errors?.length??0)}get schemaErrors(){return this.schemaParser.errors??[]}get valid(){return 0==(this.dataParser.errors?.length??0)}validate(t){this.dataParser(t),ps(this.dataParser.errors)}get errors(){return this.dataParser.errors??[]}}const vs=Symbol("FZ_FORM_SCHEMA"),ys=Symbol("FZ_FORM_PARENT"),ws=Symbol("FZ_FORM_KEY"),xs=Symbol("FZ_FORM_ROOT");class ks extends Kt{constructor(t){super(t,"nullable","upgrade",[])}appliable(t){return this.property in t}apply(t){t.nullable&&(void 0===t.type?t.type=["null"]:Array.isArray(t.type)?t.type=[...t.type,"null"]:t.type=[t.type,"null"]),t[this.property]=void 0}}class zs extends Kt{constructor(t){super(t,"$id","upgrade",[])}appliable(t){return this.property in t&&t.$id.includes("#")}apply(t){const[e,s]=t.$id.split("#");t.$id=e,t.$anchor=s}}class Ss extends Kt{constructor(t){super(t,"dependencies","upgrade",[])}appliable(t){return this.property in t}apply(t){t.dependentRequired={...t[this.property]},t.dependencies=void 0}}class _s extends Kt{constructor(t){super(t,"items","upgrade",[])}appliable(t){return Array.isArray(t[this.property])}apply(t){t.prefixItems=t[this.property],t.items=void 0}}class Es extends Kt{constructor(t){super(t,"additionalProperties","upgrade",[])}appliable(t){return!1===t.additionalProperties}apply(t){t.unevaluatedProperties=!1,t.additionalProperties=void 0}}class Os extends Kt{constructor(t){super(t,"$ref","upgrade",[])}appliable(t){return this.property in t}apply(t){t.$dynamicRef=t[this.property],t.$ref=void 0}}class Is{static implemented=["draft-07","2019-09","2020-12"];static unimplemented=["draft-06","draft-05","draft-04","draft-03","draft-02"];static DIALECT_DRAF_07="http://json-schema.org/draft-07/schema";static DIALECT_2019_09="https://json-schema.org/draft/2019-09/schema";static DIALECT_2020_12="https://json-schema.org/draft/2020-12/schema";root;dialect;steps;passes={upgrade:[],pre:[],post:[]};errors=[];constructor(t,e,s){if(this.root=t,this.dialect=this.extractDialect(e,t.$schema),Is.unimplemented.includes(this.dialect))throw Error(`schema dialect '${this.dialect}' not implemented (implmented are draft-07,2019-09 and 2020-12)`);this.steps=[new Os(this.root),new Es(this.root),new Ss(this.root),new zs(this.root),new _s(this.root),new ks(this.root),new Cs(this.root),new js(this.root),new As(this.root),new Fs(this.root),new Ns(this.root),new Ms(this.root,e),new Rs(this.root),new Us(this.root),new Ts(this.root),new Ls(this.root),new Ds(this.root),new Ps(this.root),new qs(this.root),new Vs(this.root,s),new Bs(this.root,"abstract",Wt._abstractFunc()),new Js(this.root,"case",(()=>!1)),new Js(this.root,"visible",(()=>!0)),new Js(this.root,"readonly",(()=>!1)),new Js(this.root,"requiredIf",(()=>!1)),new Js(this.root,"collapsed",(()=>!1)),new Js(this.root,"filter",(()=>!0)),new Ws(this.root,"rank",(()=>!0)),new Ws(this.root,"expression",(()=>"")),new Ws(this.root,"change",(()=>""))];for(const t of this.steps)this.passes[t.phase].push(t);this.passes.upgrade=this.topologicalSort(this.passes.upgrade),this.passes.pre=this.topologicalSort(this.passes.pre),this.passes.post=this.topologicalSort(this.passes.post)}extractDialect(t,e){switch(!0){case Is.unimplemented.some((t=>e?.startsWith(`http://json-schema.org/${t}/schema`))):return Is.unimplemented.find((t=>e?.includes(t)))??"draft-06";case e?.startsWith(Is.DIALECT_DRAF_07):return"draft-07";case e?.startsWith(Is.DIALECT_2019_09):return"2019-09";case e?.startsWith(Is.DIALECT_2020_12):return"2020-12";case t.dialect&&Is.implemented.includes(t.dialect):return t.dialect;default:return"2020-12"}}compile(){return this.errors=[],this.walkSchema(this.passes.pre,this.root),this.walkSchema(this.passes.post,this.root),Ls.breakCycles(),this.errors}walkSchema(t,e,s,i){for(const r of t)try{r.appliable(e,s,i)&&r.apply(e,s,i)}catch(t){this.errors.push(String(t))}return e.properties?Object.entries(e.properties).forEach((([s,i])=>this.walkSchema(t,i,e,s))):e.items?(e.items.oneOf||e.items.allOf||e.items.anyOf,this.walkSchema(t,e.items,e,"*")):e.oneOf?e.oneOf.forEach((e=>this.walkSchema(t,e,s,i))):e.allOf?e.allOf.forEach((e=>this.walkSchema(t,e,s,i))):e.anyOf?e.anyOf.forEach((e=>this.walkSchema(t,e,s,i))):void 0}topologicalSort(t){function e(r,n){if(!i.has(r.property)){if(n.has(r.property))throw new Error(`Cycle in step dependencies: ${r.property}`);n.add(r.property);for(const s of r.after){const i=t.find((t=>t.property===s));i&&e(i,n)}n.delete(r.property),i.add(r.property),s.push(r)}}const s=[],i=new Set;for(const s of t)e(s,new Set);return s}}class Cs extends Kt{constructor(t){super(t,"$ref","pre",[])}apply(t){const e=[];for(const[s,i]of Object.entries(t.properties??{}))i.$ref&&e.push({parent:t.properties??{},property:s});for(const[s,i]of(t.oneOf??[]).entries())i.$ref&&e.push({parent:t.oneOf??[],property:s});for(const[s,i]of(t.anyOf??[]).entries())i.$ref&&e.push({parent:t.anyOf??[],property:s});for(const[s,i]of(t.allOf??[]).entries())i.$ref&&e.push({parent:t.allOf??[],property:s});for(const t of e)t.parent[t.property]=this.definition(t.parent[t.property])}definition(t){const e=t.$ref;if(!e.startsWith("#/definitions/"))throw this.error(`only '/definitions/<name>' allowed => ${e}]`);if(null==this.root.definitions)throw this.error('No "definitions" property in root schema');const s=e.split("/")[2];if(null==this.root.definitions[s])throw this.error(`No definitions found in schema for ${e}`);const i=this.root.definitions[s],r=Object.assign({},i);return Object.entries(t).forEach((([t,e])=>"$ref"!==t&&(r[t]=e))),Wt.wrapSchema(r)}}class js extends Kt{constructor(t){super(t,"parent","pre",[])}appliable(t){return!(this.property in t)}apply(t,e){t.parent=e}}class As extends Kt{constructor(t){super(t,"pointer","pre",[])}appliable(t){return!(this.property in t)}apply(t,e,s){t.pointer=e?`${e.pointer}/${s}`:""}}class Fs extends Kt{constructor(t){super(t,"root","pre",[])}appliable(t){return!(this.property in t)}apply(t){t.root=this.root}}class Ns extends Kt{static STRINGKW=["minLength","maxLength","pattern","format"];static NUMBERKW=["minimum","maximum","exclusiveMinimum","exclusiveMaximum","multipleOf"];static ARRAYKW=["items","additionalItems","minItems","maxItems","uniqueItems"];static OBJECTKW=["required","properties","additionalProperties","patternProperties","minProperties","maxProperties","dependencies"];static ALL=new Set(["string","integer","number","object","array","boolean","null"]);constructor(t){super(t,"basetype","pre",[])}appliable(t){return!(this.property in t)}apply(t,e,s){switch(t.target=[...this.infer(t)??[]],t.target.length){case 2:if(!t.target.includes("null"))throw Error(`Second type must be "null" : ${jt(e,s)}`);t.basetype=t.target.find((t=>"null"!==t))??t.target[0],t.nullAllowed=!0;break;case 1:t.basetype=t.target[0],t.nullAllowed="null"==t.target[0];break;case 0:t.basetype="null",t.nullAllowed=!1;break;default:throw Error(`multiple types not implemented : ${jt(e,s)}`)}}infer(t){const e=[];if(e.push(Ns.ALL),e.push(this.constKW(t)),e.push(this.typeKW(t)),e.push(this.enumKW(t)),e.push(this.numberKW(t)),e.push(this.stringKW(t)),e.push(this.arrayKW(t)),e.push(this.objectKW(t)),e.push(this.notKW(t)),t.allOf){const s=t.allOf.map((t=>this.infer(t))).filter((t=>null!=t));e.push(Ot(s))}if(t.anyOf){const s=t.anyOf.map((t=>this.infer(t))).map((t=>t??Ns.ALL));e.push(It(s))}if(t.oneOf){const s=t.oneOf.map((t=>this.infer(t))).map((t=>t??Ns.ALL));e.push(It(s))}return Ot(e.filter((t=>null!=t)))}notKW(t){return t.not?(e=this.infer(t.not),s=Ns.ALL,null==e?new Set:new Set([...s].filter((t=>!e.has(t))))):null;var e,s}enumKW(t){if("enum"in t&&Array.isArray(t.enum)){const e=t.enum.map((t=>null==t?"null":Array.isArray(t)?"array":typeof t));return new Set(e)}return null}typeKW(t){return"type"in t?new Set(Array.isArray(t.type)?t.type:[t.type]):null}constKW(t){if("const"in t){if(null==t.const)return new Set(["null"]);if(Array.isArray(t.const))return new Set(["array"]);const e=Number.isInteger(t.const)?"integer":typeof t.const;return new Set([e])}return null}arrayKW(t){return Ns.ARRAYKW.some((e=>e in t))?new Set(["array"]):null}numberKW(t){return Ns.NUMBERKW.some((e=>e in t))?new Set(["number"]):null}objectKW(t){return Ns.OBJECTKW.some((e=>e in t))?new Set(["object"]):null}stringKW(t){return Ns.STRINGKW.some((e=>e in t))?new Set(["string"]):null}}class Ms extends Kt{preferNull;constructor(t,e){super(t,"empty","pre",["basetype"]),this.preferNull=e?.preferNull??!1}appliable(t){return!(this.property in t)}apply(t){t.empty=t.nullAllowed&&this.preferNull?null:void 0}}class Rs extends Kt{constructor(t){super(t,"isenum","pre",[])}appliable(t){return!(this.property in t)}apply(t){switch(t.isenum=!1,!0){case!_t(t):break;case!!t.enum:case t.oneOf&&t.oneOf.every((t=>"const"in t)):case t.anyOf&&t.anyOf.every((t=>"const"in t)):t.filter||(t.filter=()=>!0),t.isenum=!0}}}class Us extends Kt{constructor(t){super(t,"isenumarray","pre",[])}appliable(t){return!(this.property in t)}apply(t){t.isenumarray=_t(t)&&function(t){if("array"===t.basetype&&t.uniqueItems){if(t.items?.oneOf)return!!t.items.oneOf.every((t=>"const"in t));if(t.items?.anyOf)return!!t.items?.anyOf.every((t=>"const"in t))}return!1}(t)}}class Ts extends Kt{constructor(t){super(t,"homogeneous","pre",["basetype"])}appliable(t){return!(this.property in t)&&"array"===t.basetype}apply(t){t.homogeneous=!t.items?.oneOf}}class Ls extends Kt{static ALL=new Map;constructor(t){super(t,"trackers","pre",["pointer"])}appliable(t){return!(this.property in t)}apply(t){t.trackers=[],Ls.ALL?.set(t.pointer,t.trackers)}static breakCycles(){if(null==Ls.ALL)return;const t=Ls.ALL,e=new Set,s=new Set,i=new Map;for(const[r,n]of t){function o(r){if(s.has(r)){let e=r;const s=new Set;for(;i.has(e)&&!s.has(e);)s.add(e),e=i.get(e);for(const e of s){const s=i.get(e);if(s&&t.has(s)){const i=t.get(s),r=i.indexOf(e);-1!==r&&i.splice(r,1)}}}else if(!e.has(r)){e.add(r),s.add(r);for(const e of t.get(r)||[])i.set(e,r),o(e);s.delete(r)}}0===n.length&&t.delete(r);for(const a of t.keys())e.has(a)||o(a);Ls.ALL=void 0}}}class Ds extends Kt{constructor(t){super(t,"requiredIf","pre",["basetype"])}appliable(t){return"object"===t.basetype&&null!=t.properties&&null!=t.required}apply(t){t.required?.forEach((e=>{t.properties&&e in t.properties&&(t.properties[e].requiredIf="true")}))}}class Ps extends Kt{constructor(t){super(t,"field","pre",["basetype","isenum","isenumarray"])}appliable(t){return!(this.property in t)}apply(t){if("const"in t)return t.field="fz-const";if(t.from&&_t(t))return t.filter||(t.filter=()=>!0),t.field="fz-enum-select";if(t.isenum)switch(t.filter||(t.filter=()=>!0),!0){case t.enum&&t.enum?.length<=3:case t.oneOf&&t.oneOf?.length<=3:case t.anyOf&&t.anyOf?.length<=3:return t.field="fz-enum-check";case t.enum&&t.enum?.length<=20:case t.oneOf&&t.oneOf?.length<=20:case t.anyOf&&t.anyOf?.length<=20:return t.field="fz-enum-select";default:return t.field="fz-enum-typeahead"}switch(t.basetype){case"object":return t.field="fz-object";case"array":return t.isenumarray?(t.filter||(t.filter=()=>!0),t.field="fz-enum-array"):t.field="fz-array";case"integer":return t.minimum&&t.maximum&&t.maximum-t.minimum<=10?t.field="fz-range":t.field="fz-integer";case"number":return t.field="fz-float";case"boolean":return t.field="fz-boolean";case"string":if(t.mask)return t.field="fz-mask";switch(t.format){case"color":return t.field="fz-color";case"uuid":case"uuid":return t.field="fz-uuid";case"signature":return t.field="fz-signature";case"date":return t.field="fz-date";case"time":return t.field="fz-time";case"date-time":return t.field="fz-datetime";case"geo":return t.field="fz-location";case"doc":return t.field="fz-doc";case"markdown":return t.field="fz-markdown";case"asset":return t.field="fz-asset"}return!t.format&&t.maxLength&&t.maxLength>256?t.field="fz-textarea":t.field="fz-string"}return t.field="fz-error"}}class qs extends Kt{constructor(t){super(t,"order","pre",["basetype"])}appliable(t){return!(this.property in t)&&"object"===t.basetype&&null!=t.properties}apply(t){const e=t.properties;if(!e)return;const s=new Map,i=new Map;let r=0;const n=Object.entries(e).map((([t,e])=>{e.tab&&!i.has(e.tab)&&i.set(e.tab,r);const n=e.tab?i.get(e.tab):r;e.group&&!s.has(e.group)&&s.set(e.group,r);return{tabnum:n,groupnum:e.group?s.get(e.group):r,fieldnum:r++,fieldname:t,schema:e,tabname:e.tab??"",groupname:e.group??""}}));n.sort(((t,e)=>{const s=Math.min(t.tabnum,t.groupnum,t.fieldnum)-Math.min(e.tabnum,e.groupnum,e.fieldnum);return 0===s?t.fieldnum-e.fieldnum:s})),t.order=n}}class Vs extends Kt{data;constructor(t,e){super(t,"from","post",["pointer","trackers"]),this.data=e}appliable(t){return gt(t.from)&&!zt(t.from)}apply(t){const e=t.from;t.from=()=>null;const s=e.pointer.replace(/\/[^/]+$/,""),i=e.pointer.substr(s.length+1);t._track(`$\`${s}\``),t.from=(t,r,n,o,a)=>{const h=Ct(this.data,n,o,s);return h?kt(h)?{pointer:s,name:i,target:h,schema:Ut(h),extend:!!e.extend}:[]:null}}}class Bs extends Kt{defunc;constructor(t,e,s){super(t,e,"post",[]),this.defunc=s}appliable(t){return this.property in t&&"string"==typeof t[this.property]}apply(t,e,s){const i=t[this.property];if(this.set(t,this.defunc),vt(i)){const e=`\n                ${this.sourceURL(t,s)}\n                try { \n                    return nvl\`${i}\`\n                } catch(e) {  \n                    console.error(\n                        \` eval for keyword "${this.property}" failed field:\${parent?.pointer ?? ""} -> \${property ?? ""}\n\`,\n                        \`    => \${String(e)}\`) \n                }\n                return ''\n            `;this.compileExpr(t,i,e)}}}class Js extends Kt{defaultFunc;constructor(t,e,s){super(t,e,"post",[]),this.defaultFunc=s}appliable(t){return this.property in t&&!zt(t[this.property])}apply(t,e,s){const i=t[this.property];if(this.set(t,this.defaultFunc),$t(i)||wt(i))return this.set(t,(()=>i));if(!vt(i))return this.set(t,(()=>!!i));const r=`\n            ${this.sourceURL(t,s)}\n            try {  \n                const result = (${i}) \n                return result === null ? result : !!result\n            } catch(e) {  \n                console.error(\n                    \` eval for keyword "${this.property}" failed field:\${parent?.pointer ?? ""} -> \${property ?? ""}\n\`,\n                    \`    => \${String(e)}\`) \n            }\n            return true\n        `;this.compileExpr(t,i,r)}}class Ws extends Kt{defaultFunc;constructor(t,e,s){super(t,e,"post",[]),this.defaultFunc=s}appliable(t){return this.property in t&&"function"!=typeof t[this.property]}apply(t,e,s){const i=t[this.property];if(this.set(t,this.defaultFunc),!vt(i)&&!kt(i))return this.set(t,(()=>i));let r="return null";r=vt(i)?`return ${i}`:this.buildCode(i);const n=`\n            ${this.sourceURL(t,s)}\n            try {\n                ${r} \n            } catch(e) {  \n                console.error(\n                    \` eval for keyword "${this.property}" failed field:\${parent?.pointer ?? ""} -> \${property ?? ""}\n\`,\n                    \`    => \${String(e)}\`) }\n            return null\n        `;this.compileExpr(t,i,n)}}class Ks{data;schema;steps;errors=[];constructor(t,e){this.data=t,this.schema=e,this.steps=[(t,e,s,i)=>{(xt(e)||kt(e))&&(e[vs]=t,e[ys]=s,e[ws]=i,e[xs]=e)}]}compile(){return this.errors=[],this.walkData(this.schema,this.data),this.errors}walkData(t,e,s,i){if(null!=t&&null!=e){try{this.steps.forEach((r=>r(t,e,s,i)))}catch(t){this.errors.push(String(t))}if(kt(e))t.homogeneous?e.forEach(((s,i)=>this.walkData(t.items,s,e,i))):e.forEach(((s,i)=>{t.items?.oneOf?.forEach((t=>{t.case&&t.case(null,s,e,i,(()=>null))&&this.walkData(t,s,e,i)}))}));else if(xt(e)&&t.properties)for(const s in e){const i=t.properties[s],r=e[s];this.walkData(i,r,e,s)}else;}}}class Gs{store;constructor(t){this.store=t}async put(t,e,s,i){try{return this.store.put?.(t,e,s,i)}catch(t){}}async remove(t){try{return this.store.remove?.(t)}catch(t){}}async get(t){try{return this.store.get?.(t)??null}catch(t){return}}}class Zs{store=new Map;async put(t,e,s,i){this.store.set(t,{uuid:t,blob:e,filename:s})}async remove(t){await this.store.delete(t)}async get(t){return this.store.get(t)}}var Hs;let Ys=Hs=class extends Dt{static get styles(){return[...super.styles]}i_root={content:{}};#v={};get i_options(){return this.#v}set i_options(t){this.#v=t}store=new Zs;asset;fieldMap=new Map;schemaMap=new Map;errorMap=new Map;submitted=!1;bootstrap=!1;useAjv=!1;useMarkdown=!1;#y=Zt;get sourceSchema(){return this.#y}set sourceSchema(t){this.#y=t}#w=!1;get actions(){return this.#w}set actions(t){this.#w=t}#x=!1;get readonly(){return this.#x}set readonly(t){this.#x=t}#k=!1;get checkIn(){return this.#k}set checkIn(t){this.#k=t}#z=!1;get checkOut(){return this.#z}set checkOut(t){this.#z=t}oninit=null;onready=null;onvaliddata=null;oninvaliddata=null;onvalidate=null;ondismiss=null;compiledSchema=Zt;validator=new gs(Zt);message="";constructor(){super()}get root(){return this.i_root.content}get valid(){return this.validator.validate(this.root),this.errorMap=this.validator.map,this.validator.valid}get schema(){return this.compiledSchema}set schema(t){this.validator=bs.getValidator(t),this.validator.schemaValid?(this.sourceSchema=new Wt(JSON.parse(JSON.stringify(t))),this.compiledSchema=new Wt(JSON.parse(JSON.stringify(t)))):(this.sourceSchema=new Wt(JSON.parse(JSON.stringify(Zt))),this.compiledSchema=new Wt(JSON.parse(JSON.stringify(Zt))),this.validator=bs.getValidator(this.sourceSchema)),this.compile(),this.compiledSchema.collapsed=()=>!1,this.fieldMap.clear(),this.schemaMap.clear(),this.requestUpdate()}get options(){return this.i_options}set options(t){this.i_options=t,this.i_options?.storage&&(this.store=new Gs(this.i_options.storage)),this.i_options?.asset&&(this.asset=this.i_options.asset)}get data(){return JSON.parse(JSON.stringify(this.root))}set data(t){if(!this.validator.schemaValid)return;!this.valid&&this.checkIn,this.i_root.content=t,this.compile(),this.requestUpdate()}attributeChangedCallback(t,e,s){if(super.attributeChangedCallback(t,e,s),"schema"===t){const t=Gt.fromAttribute(s);this.schema=t}"bootstrap"===t&&Hs.loadBootstrap(),"useajv"===t&&bs.loadValidator(this.useAjv).then((()=>{this.validator=bs.getValidator(this.sourceSchema),this.check()})).catch((t=>{})),"usemarkdown"===t&&Pe.loadMarkdownIt(this.useMarkdown).then((()=>null)).catch((t=>{}))}getField(t){return this.fieldMap.get(t)}addField(t,e,s){this.schemaMap.set(t,s),this.fieldMap.set(e,s)}removeField(t,e){this.schemaMap.delete(t),this.fieldMap.delete(e)}getfieldFromSchema(t){return this.schemaMap.get(t)}updateField(t){this.getField(t)?.requestUpdate()}render(){return Dt.isBootStrapLoaded()?this.validator.schemaValid?this.renderForm():this.renderError():"Bootstrap not loaded..."}renderForm(){return Y`
