 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class ce extends te{constructor(t){if(super(t),this.it=Q,t.type!==Xt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Q||null==t)return this._t=void 0,this.it=t;if(t===X)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}ce.directiveName="unsafeHTML",ce.resultType=1;const ue=Qt(ce),de="important",pe=" !"+de,fe=Qt(class extends te{constructor(t){if(super(t),t.type!==Yt||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,s)=>{const i=t[s];return null==i?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(t,[e]){const{style:s}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const t of this.ft)null==e[t]&&(this.ft.delete(t),t.includes("-")?s.removeProperty(t):s[t]=null);for(const t in e){const i=e[t];if(null!=i){this.ft.add(t);const e="string"==typeof i&&i.endsWith(pe);t.includes("-")||e?s.setProperty(t,e?i.slice(0,-11):i,e?de:""):s[t]=i}}return X}});
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const $e=t=>t??Q;let ve=class extends re{toField(){if(gt(this.input)){const t=/\d\d\d\d-\d\d-\d\d/;this.input.valueAsDate=t.test(this.value)?new Date(this.value):null}}toValue(){gt(this.input)&&(this.value=gt(this.input.valueAsDate)?function(t=new Date){return t.toISOString().substring(0,10)}(this.input.valueAsDate):void 0)}renderInput(){return Y`<input
        ...
        `}tryChange(t){this.readonly?t.preventDefault():this.change()}toField(){if(!$t(this.input))if(!0===wt(this.value))this.input.indeterminate=!1,this.input.checked=this.value;else this.input.indeterminate=!0,this.input.checked=!1}toValue(){$t(this.input)||(this.input.indeterminate?this.value=this.schema.nullAllowed?null:void 0:this.value=!!this.input.checked)}};_e=t([e("fz-boolean")],_e);const Ee=1.1.toLocaleString().substring(1,2);let Oe=class extends re{static get styles(){return[...super.styles,a`
            ...
            }`]}toField(){gt(this.input)&&(yt(this.value)?this.input.valueAsNumber=this.value:this.input.value="")}toValue(){gt(this.input)&&(this.value=yt(this.input.valueAsNumber)?this.input.valueAsNumber:void 0)}renderInput(){return Y`
            <div class="input-group">
                <input 
                    class="form-control ${this.validation}" 
                    type="number" 
          ...
          `]}renderInput(){return Y`
            ...
            </div>`}get max(){return yt(this.schema?.maximum)?this.schema.maximum:yt(this.schema?.exclusiveMaximum)?this.schema.exclusiveMaximum:void 0}get min(){return yt(this.schema?.minimum)?this.schema.minimum:yt(this.schema?.exclusiveMinimum)?this.schema.exclusiveMinimum:void 0}};Ie=t([e("fz-range")],Ie);let Ce=class extends re{watchId;toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=gt(this.input.value)?this.input.value:void 0)}static get styles(){return[...super.styles,a`
            input[type="color"] {
                height: 38px
            }`]}renderInput(){return Y`
            <div class="input-group ${this.validation}">
        ...
        `}};qe=t([e("fz-markdown")],qe);let Ve=class extends re{toField(){gt(this.input)&&(this.input.value=String(this.value??""))}toValue(){gt(this.input)&&(this.value=gt(this.input.value)?this.input.value:this.empty)}renderInput(){return Y`
            ...
            </div>`}connectedCallback(){super.connectedCallback(),null==this.value&&(this.value=Ue())}};Ve=t([e("fz-uuid")],Ve);const Be=["fz-array","fz-enum-array","fz-object","fz-enum-check","fz-enum-select","fz-enum-typeahead","fz-picker","fz-boolean","fz-color","fz-const","fz-date","fz-datetime","fz-doc","fz-float","fz-integer","fz-location","fz-location","fz-mask","fz-markdown","fz-range","fz-signature","fz-string","fz-textarea","fz-time","fz-uuid"].join(",");class Je extends se{get fields(){return[...this.shadowRoot?.querySelectorAll(Be)??[]]}renderLabel(){const t=this.required?"*":"",e=`${this.label}${t}`;return Y`
            <label for="input" class="col-sm-3 col-form-label" @click="${this.labelClicked}">
                <div>${e}</div>
