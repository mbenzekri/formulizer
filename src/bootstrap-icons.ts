import { css } from "lit"
import bootstrapWoff from "../src/assets/bootstrap-icons.woff"
import bootstrapWoff2 from "../src/assets/bootstrap-icons.woff2"
...
Promise.all(fonts.map(font => font.load())).then((fonts: FontFace[]) => {
    fonts.forEach(font => {
