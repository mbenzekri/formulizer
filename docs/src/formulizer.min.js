 ...
 */const Qt=Tt(class extends Yt{constructor(t){if(super(t),t.type!==Jt||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const r=t.element.classList;for(const t of this.st)t in e||(r.remove(t),this.st.delete(t));for(const t in e){const o=!!e[t];o===this.st.has(t)||this.nt?.has(t)||(o?(r.add(t),this.st.add(t)):(r.remove(t),this.st.delete(t)))}return Y}});let $t=class extends Kt{static get styles(){return[...super.styles,l`
            ...
            >
                ${this.withAdd?T`<option style="color:red;text-align:center" ?disabled="${this.readonly}" ?selected="${!1}" .value="${"~~ADD~~"}">Add ...</option>`:""}
                ${this.showNullChoice?T`<option style="color:red;text-align:center" ?disabled="${this.readonly}" ?selected="${this.isSelected(null)}" .value="${"~~EMPTY~~"}"> ${this.required?"Choose a value...":"<vide>"}</option>`:""}
        ...
        `}convertToInput(t){return t}convertToValue(t){return"string"!=typeof t?"":t}};hi=t([r("fz-markdown")],hi);let vi=class extends It{renderInput(){return T`<div class="input-group" >${this.value}</div>`}convertToInput(t){return null==t||""==t?null:t}convertToValue(t){return St(t)?this.empty:t}connectedCallback(){super.connectedCallback(),null==this.value&&(this.value=we())}};vi=t([r("fz-uuid")],vi);let xi=class extends Kt{renderEnum(){return T`
            <div class="dropdown">
                ...
                <div id="list" class="dropdown-menu w-100">
                    ...
                    ${this.showNullChoice?T`<a class="dropdown-item" @click="${()=>this.select({label:"<vide>",value:this.empty})}" >&lt;empty&gt;</a>`:""}
