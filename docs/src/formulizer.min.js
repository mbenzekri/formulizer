 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let tl=class extends Ls{content;validator;renderField(){return U`
            <div class="form-group row">
                ${this.renderLabel}
                <div class="col-sm">
            ...
            </fz-dialog>`}updated(t){this.reference?(this.pointer=this.reference?.pointer,this.array=this.reference?.refarray,this.refname=this.reference?.refname,this.arraySchema=qt(this.array)):(this.pointer=void 0,this.array=void 0,this.refname=void 0,this.arraySchema=void 0,this.itemSchema=void 0)}toggleDropdown(){const t=this.shadowRoot?.querySelector(".dropdown-menu");t?.style.setProperty("display","block"==t?.style.display?"none":"block")}addItem(t){this.itemSchema=t;const e=vt(this.array,this.itemSchema);this.index=this.array?.length,this.array?.push(e),this.modal?.valid(),this.requestUpdate()}stopEvent(t){t.preventDefault(),t.stopPropagation()}close(t){const e=t.detail;if(!t.detail.dismissed){const e=this.shadowRoot?.getElementById("form-object");t.detail.value=e.value[this.refname??"id"],t.detail.abstract=e.abstract()}this.reference=null,this.stopEvent(t),this.dispatchEvent(new CustomEvent("close",{detail:e})),this.modal?.valid(!1)}firstUpdated(){this.modal=this.shadowRoot?.querySelector("fz-dialog")}open(){this.modal&&this.modal.open(),this.arraySchema?.homogeneous&&void 0===this.index&&this.addItem(this.arraySchema?.items)}};t([A({type:Object}),e("design:type",Object)],sl.prototype,"reference",null),sl=t([r("fz-item-dlg")],sl);class ll{static sourceCount=1;root;property;constructor(t,e){this.root=t,this.property=e}appliable(t,e,r){return!0}sourceURL(t){let e=`_FZ_${this.property}_${t??""}_${ll.sourceCount++}.js`.replace(/ +/g,"_");return e=e.replace(/[^a-z0-9_]/gi,""),console.log(`builded source :${e}`),`\n    //# sourceURL=${e}\n`}error(t){return Error(`Compilation step ${this.property}: ${t} `)}}class cl extends ll{constructor(t){super(t,"nullable")}appliable(t){return this.property in t}apply(t){t.type=Array.isArray(t.type)?[...t.type,"null"]:[t.type,"null"],t[this.property]=void 0}}class bl extends ll{constructor(t){super(t,"$id")}appliable(t){return this.property in t&&t.$id.includes("#")}apply(t){const[e,r]=t.$id.split("#");t.$id=e,t.$anchor=r}}class dl extends ll{constructor(t){super(t,"dependencies")}appliable(t){return this.property in t}apply(t){t.dependentRequired={...t[this.property]},t[this.property]=void 0}}class fl extends ll{constructor(t){super(t,"items")}appliable(t){return Array.isArray(t[this.property])}apply(t){t.prefixItems=t[this.property],t[this.property]=void 0}}class pl extends ll{constructor(t){super(t,"additionalProperties")}appliable(t){return!1===t[this.property]}apply(t){t.unevaluatedProperties=!1,t[this.property]=void 0}}class ml extends ll{constructor(t){super(t,"$ref")}appliable(t){return this.property in t}apply(t){t.$dynamicRef=t[this.property],t[this.property]=void 0}}function ul(t,e,r){if(!t||!e)return;const o=/\$\`([^`]+)`/g;let i;for(;null!=(i=o.exec(r));){const r=xt(t,e,i[1]);r&&!r.observers.includes(e.pointer)&&r.observers.push(e.pointer)}}class hl{static implemented=["draft-07","2019-09","2020-12"];static unimplemented=["draft-06","draft-05","draft-04","draft-03","draft-02"];static DIALECT_DRAF_07="http://json-schema.org/draft-07/schema";static DIALECT_2019_09="https://json-schema.org/draft/2019-09/schema";static DIALECT_2020_12="https://json-schema.org/draft/2020-12/schema";root;dialect;steps_pass0;steps_pass1;steps_pass2;errors=[];constructor(t,e,r){if(this.root=t,this.dialect=this.extractDialect(e,t.$schema),hl.unimplemented.includes(this.dialect))throw Error(`schema dialect '${this.dialect}' not implemented (implmented are draft-07,2019-09 and 2020-12)`);this.steps_pass0=[new ml(this.root),new pl(this.root),new dl(this.root),new bl(this.root),new fl(this.root),new cl(this.root)],this.steps_pass1=[new gl(this.root),new Dl(this.root),new zl(this.root),new El(this.root),new vl(this.root),new wl(this.root,e),new xl(this.root),new yl(this.root),new kl(this.root),new jl(this.root),new Al(this.root),new Fl(this.root),new ql(this.root)],this.steps_pass2=[new Pl(this.root,r),new Ol(this.root,"abstract",Vt),new Rl(this.root,"case",(()=>!1)),new Rl(this.root,"visible",(()=>!0)),new Rl(this.root,"readonly",(()=>!1)),new Rl(this.root,"requiredWhen",(()=>!1)),new Rl(this.root,"collapsed",(()=>!1)),new Rl(this.root,"filter",(()=>!0)),new Sl(this.root,"orderBy",(()=>!0)),new Sl(this.root,"expression",(()=>"")),new Sl(this.root,"change",(()=>""))]}extractDialect(t,e){switch(!0){case hl.unimplemented.some((t=>e?.startsWith(`http://json-schema.org/${t}/schema`))):return hl.unimplemented.find((t=>e?.includes(t)))??"draft-06";case e?.startsWith(hl.DIALECT_DRAF_07):return"draft-07";case e?.startsWith(hl.DIALECT_2019_09):return"2019-09";case e?.startsWith(hl.DIALECT_2020_12):return"2020-12";case t.dialect&&hl.implemented.includes(t.dialect):return t.dialect;default:return"2020-12"}}compile(){return this.errors=[],this.walkSchema(this.steps_pass1,this.root),this.walkSchema(this.steps_pass2,this.root),this.errors}walkSchema(t,e,r,o){for(const i of t)try{i.appliable(e,r,o)&&i.apply(e,r,o)}catch(t){this.errors.push(String(t))}return e.properties?Object.entries(e.properties).forEach((([r,o])=>this.walkSchema(t,o,e,r))):e.items?(e.items.oneOf||e.items.allOf||e.items.anyOf,this.walkSchema(t,e.items,e,"*")):e.oneOf?e.oneOf.forEach((e=>this.walkSchema(t,e,r,o))):e.allOf?e.allOf.forEach((e=>this.walkSchema(t,e,r,o))):e.anyOf?e.anyOf.forEach((e=>this.walkSchema(t,e,r,o))):void 0}}class gl extends ll{constructor(t){super(t,"$ref")}apply(t){const e=t.properties;e&&Object.entries(e).forEach((([t,r])=>r.$ref&&(e[t]=this.definition(r)))),t.items&&t.items.$ref&&(t.items=this.definition(t.items)),t.items&&t.items.oneOf&&(t.items.oneOf=t.items.oneOf.map((t=>t.$ref?this.definition(t):t)))}definition(t){const e=t.$ref;if(!e.startsWith("#/definitions/"))throw this.error(`only '#/definitions/<name>' allowed => ${e}]`);if(!this.root.definitions)throw this.error('No "definitions" property in root schema');const r=e.split("/")[2];if(r in this.root.definitions){const e=this.root.definitions[r],o=Object.assign({},e);return Object.entries(t).forEach((([t,e])=>"$ref"!==t&&(o[t]=e))),o}throw this.error(`No definitions found in schema for ${e}`)}}class vl extends ll{static STRINGKW=["minLength","maxLength","pattern","format"];static NUMBERKW=["minimum","maximum","exclusiveMinimum","exclusiveMaximum","multipleOf"];static ARRAYKW=["items","additionalItems","minItems","maxItems","uniqueItems"];static OBJECTKW=["required","properties","additionalProperties","patternProperties","minProperties","maxProperties","dependencies"];static ALL=new Set(["string","integer","number","object","array","boolean","null"]);constructor(t){super(t,"basetype")}appliable(t){return!(this.property in t)}apply(t,e,r){switch(t.target=[...this.infer(t)??[]],t.target.length){case 2:if(!t.target.includes("null"))throw Error(`Second type must be "null" : ${kt(e,r)}`);t.basetype=t.target.find((t=>"null"!==t))??t.target[0],t.nullAllowed=!0;break;case 1:t.basetype=t.target[0],t.nullAllowed="null"==t.target[0];break;case 0:t.basetype=void 0,t.nullAllowed=!1;break;default:throw Error(`multiple types not implemented : ${kt(e,r)}`)}}infer(t){const e=[];if(e.push(vl.ALL),e.push(this.constKW(t)),e.push(this.typeKW(t)),e.push(this.enumKW(t)),e.push(this.numberKW(t)),e.push(this.stringKW(t)),e.push(this.arrayKW(t)),e.push(this.objectKW(t)),e.push(this.notKW(t)),t.allOf){const r=t.allOf.map((t=>this.infer(t)));e.push(this.intersect(r))}if(t.anyOf){const r=t.anyOf.map((t=>this.infer(t)));e.push(this.union(r))}if(t.oneOf){const r=t.oneOf.map((t=>this.infer(t)));e.push(this.union(r))}const r=e.filter((t=>null!=t));return this.intersect(r)}notKW(t){return t.not?this.complement(this.infer(t.not)):null}enumKW(t){if("enum"in t&&Array.isArray(t.enum)){const e=t.enum.map((t=>null==t?"null":Array.isArray(t)?"array":typeof t));return new Set(e)}return null}typeKW(t){return"type"in t?new Set(Array.isArray(t.type)?t.type:[t.type]):null}constKW(t){if("const"in t){if(null==t.const)return new Set(["null"]);if(Array.isArray(t.const))return new Set(["array"]);const e=Number.isInteger(t.const)?"integer":typeof t.const;return new Set([e])}return null}arrayKW(t){return vl.ARRAYKW.some((e=>e in t))?new Set(["array"]):null}numberKW(t){return vl.NUMBERKW.some((e=>e in t))?new Set(["number"]):null}objectKW(t){return vl.OBJECTKW.some((e=>e in t))?new Set(["object"]):null}stringKW(t){return vl.STRINGKW.some((e=>e in t))?new Set(["string"]):null}intersect(t){return t.reduce(((t,e)=>new Set([...t].filter((t=>e.has(t))))),t[0])}complement(t){return null==t?new Set:new Set([...vl.ALL].filter((e=>!t.has(e))))}union(t){return t.reduce(((t,e)=>new Set([...t,...e])),new Set)}}class wl extends ll{options;constructor(t,e){super(t,"enumRef"),this.options=e}appliable(t){return this.property in t}apply(t){if(!this.options.ref)throw Error("missing 'enumRef' function in options");const e=this.options.ref(t.enumRef).map((t=>({const:t.value,title:t.title})));t.oneOf=e}}class xl extends ll{constructor(t){super(t,"isenum")}appliable(t){return!(this.property in t)}apply(t){switch(t.isenum=!1,!0){case!ht(t.basetype):break;case!!t.enum:case t.oneOf&&t.oneOf.every((t=>"const"in t)):case t.anyOf&&t.anyOf.every((t=>"const"in t)):t.filter||(t.filter=()=>!0),t.isenum=!0}}}class yl extends ll{constructor(t){super(t,"isenumarray")}appliable(t){return!(this.property in t)}apply(t){t.isenumarray=ht(t.basetype)&&function(t){if("array"===t.basetype&&t.uniqueItems){if(t.items.oneOf)return!!t.items.oneOf.every((t=>"const"in t));if(t.items.anyOf)return!!t.anyOf.every((t=>"const"in t))}return!1}(t)}}class kl extends ll{constructor(t){super(t,"homogeneous")}appliable(t){return!(this.property in t)&&"array"===t.basetype}apply(t){t.homogeneous=!t.items.oneOf}}class jl extends ll{constructor(t){super(t,"observers")}appliable(t){return!(this.property in t)}apply(t){t.observers=[]}}class Dl extends ll{constructor(t){super(t,"parent")}appliable(t){return!(this.property in t)}apply(t,e){t.parent=e}}class zl extends ll{constructor(t){super(t,"pointer")}appliable(t){return!(this.property in t)}apply(t,e,r){t.pointer=e?`${e.pointer}/${r}`:"#"}}class El extends ll{constructor(t){super(t,"root")}appliable(t){return!(this.property in t)}apply(t){t.root=this.root}}class Al extends ll{constructor(t){super(t,"requiredWhen")}appliable(t){return"object"===t.basetype&&null!=t.properties&&null!=t.required}apply(t){t.required.forEach((e=>{e in t.properties&&(t.properties[e].requiredWhen="true")}))}}class Fl extends ll{constructor(t){super(t,"field")}appliable(t){return!(this.property in t)}apply(t){if("const"in t)return t.field="fz-constant";if(t.refTo&&ht(t.basetype))return t.filter||(t.filter=()=>!0),t.field="fz-enum";if(t.isenum)switch(t.filter||(t.filter=()=>!0),!0){case t.enum?.length<=3:case t.oneOf?.length<=3:case t.anyOf?.length<=3:return t.field="fz-enum-check";case t.enum?.length<=20:case t.oneOf?.length<=20:case t.anyOf?.length<=20:return t.field="fz-enum";default:return t.field="fz-enum-typeahead"}switch(t.basetype){case"object":return t.field="fz-object";case"array":return t.isenumarray?(t.filter||(t.filter=()=>!0),t.field="fz-enum-array"):t.field="fz-array";case"integer":return t.minimum&&t.maximum&&t.maximum-t.minimum<=10?t.field="fz-range":t.field="fz-integer";case"number":return t.field="fz-float";case"boolean":return t.field="fz-boolean";case"string":switch(t.format){case"uuid":return t.field="fz-uuid";case"signature":return t.field="fz-signature";case"date":return t.field="fz-date";case"time":return t.field="fz-time";case"date-time":return t.field="fz-datetime";case"geo":return t.field="fz-geolocation";case"doc":return t.field="fz-document";case"markdown":return t.field="fz-markdown";case"asset":return t.field="fz-asset"}return!t.format&&t.maxLength>256?t.field="fz-textarea":t.field="fz-string"}return t.field="fz-error"}}class ql extends ll{constructor(t){super(t,"order")}appliable(t){return!(this.property in t)&&"object"===t.basetype&&null!=t.properties}apply(t){const e=t.properties,r=new Map,o=new Map;let i=0;const n=Object.entries(e).map((([t,e])=>{e.tab&&!o.has(e.tab)&&o.set(e.tab,i);const n=e.tab?o.get(e.tab):i;e.group&&!r.has(e.group)&&r.set(e.group,i);return{tabnum:n,groupnum:e.group?r.get(e.group):i,fieldnum:i++,fieldname:t,schema:e,tabname:e.tab,groupname:e.group}}));n.sort(((t,e)=>{const r=Math.min(t.tabnum,t.groupnum,t.fieldnum)-Math.min(e.tabnum,e.groupnum,e.fieldnum);return 0===r?t.fieldnum-e.fieldnum:r})),t.order=n}}class Pl extends ll{data;constructor(t,e){super(t,"refTo"),this.data=e}appliable(t){return this.property in t&&"function"!=typeof t.refTo}apply(t){const e=t.refTo;t.refTo=()=>null;const r=e.replace(/\/[^/]+$/,""),o=e.substr(r.length+1);ul(this.root,t,`$\`${r}\``),t.refTo=(t,e,i,n,a)=>{const s=yt(this.data.content,i,n,r);return s?Array.isArray(s)?{pointer:r,refname:o,refarray:s}:(console.error(`reference list must be an array ${r}`),null):null}}}class Ol extends ll{defunc;constructor(t,e,r){super(t,e),this.defunc=r}appliable(t){return this.property in t&&"string"==typeof t[this.property]}apply(t,e,r){const o=t[this.property];if(t[this.property]=this.defunc,"string"==typeof o){const e=`\n                ${this.sourceURL(r)}\n                try { \n                    return nvl\`${o}\`\n                } catch(e) { \n                    console.error(\`unable to produce ${this.property} property due to :\${e.toString()}\`)\n                }\n                return ''\n            `;try{ul(this.root,t,o),t[this.property]=new Function("schema","value","parent","property","$","userdata",e),t[this.property].expression=o}catch(t){throw Error(`unable to compile ${this.property} expression "${o}" due to ::\n\t=>${String(t)}`)}}}}class Rl extends ll{defunc;constructor(t,e,r){super(t,e),this.defunc=r}appliable(t){return this.property in t&&["string","boolean"].includes(typeof t[this.property])}apply(t,e,r){const o=t[this.property];if(t[this.property]=this.defunc,"boolean"==typeof o||null===o)t[this.property]=null===o?()=>null:()=>o;else if("string"==typeof o){const e=`\n            ${this.sourceURL(r)}\n            try {  \n                    const result = (${o}) \n\n                    return result === null ? result : !!result\n                }\n                catch(e) {  console.error(\`unable to produce ${this.property} property due to :\n\t=>\${e.toString()}\`) }\n                return true\n            `;try{ul(this.root,t,o),t[this.property]=new Function("schema","value","parent","property","$","userdata",e),t[this.property].expression=o}catch(t){throw Error(`unable to compile ${this.property} expression "${o}" due to ::\n\t=>${String(t)}`)}}}}class Sl extends ll{defunc;constructor(t,e,r){super(t,e),this.defunc=r}appliable(t){return this.property in t&&"function"!=typeof t[this.property]}apply(t,e,r){const o=t[this.property];t[this.property]=this.defunc;let i="return null";switch(!0){case"boolean"==typeof o:i=o?"return true ;":"return false ;";break;case"string"==typeof o:i=`return ${o} ;`;break;case Array.isArray(o):const t=o.map(((t,e)=>`    const cst${e} = \`${t}\n\``));t.push(`return ( ${o.map(((t,e)=>`cst${e}`)).join(" + ")} );`),i=t.join(";\n")}const n=`\n            try {  \n                ${i} \n            }\n            catch(e) {  console.error(\`unable to produce ${this.property} property due to :\n\t=>\${e.toString()}\`) }\n            return null\n            ${this.sourceURL(r)}\n        `;try{Array.isArray(o)&&o.forEach((e=>ul(this.root,t,e))),"string"==typeof o&&ul(this.root,t,o),t[this.property]=new Function("schema","value","parent","property","$","userdata",n),t[this.property].expression=o}catch(t){console.error(`unable to compile ${this.property} expression "${o}" due to ::\n\t=>${String(t)}`)}}}class Xl{data;schema;steps;errors=[];constructor(t,e){this.data=t,this.schema=e,this.steps=[(t,e,r,o)=>{Ft(t,e),Pt(t,r),Ot(t,this.data.content)}]}compile(){return this.errors=[],this.walkData(this.data.content,this.schema),this.errors}walkData(t,e,r,o){if(null!=e&&null!=t){try{this.steps.forEach((i=>i(t,e,r,o)))}catch(t){this.errors.push(String(t))}if(Array.isArray(t))e.homogeneous?t.forEach((r=>this.walkData(r,e.items,t,e))):t.forEach(((r,o)=>{e.items.oneOf.forEach((e=>{e.case&&e.case(null,r,t,o,(()=>null))&&this.walkData(r,e,t,e)}))}));else if("object"!=typeof t);else for(const r in t){const o=e.properties[r];this.walkData(t[r],o,t,e)}}}}class Vl{store;constructor(t){this.store=t}async put(t,e,r,o){try{return this.store.put?.(t,e,r,o)}catch(e){console.error(`storage: unable to put blob for uuid=${t} ptr=${o}\n    - ${String(e)}`)}}async remove(t){try{return this.store.remove?.(t)}catch(e){console.error(`storage: unable to remove blob for uuid=${t}\n    - ${String(e)}`)}}async get(t){try{return this.store.get?.(t)??null}catch(e){return void console.error(`storage: unable to get blob for uuid=${t}\n    - ${String(e)}`)}}}class Gl{store=new Map;async put(t,e,r,o){this.store.set(t,{uuid:t,blob:e,filename:r})}async remove(t){await this.store.delete(t)}async get(t){return this.store.get(t)}}let Ml=class extends Bt{static get styles(){return[...super.styles]}#h={};get i_options(){return this.#h}set i_options(t){this.#h=t}#g={type:"object",properties:[]};get i_schema(){return this.#g}set i_schema(t){this.#g=t}#v=!1;get actions(){return this.#v}set actions(t){this.#v=t}#w=!1;get readonly(){return this.#w}set readonly(t){this.#w=t}#x=!1;get checkIn(){return this.#x}set checkIn(t){this.#x=t}#y=!1;get checkOut(){return this.#y}set checkOut(t){this.#y=t}oninit=null;onready=null;onvaliddata=null;oninvaliddata=null;onvalidate=null;ondismiss=null;#k=null;get _errors(){return this.#k}set _errors(t){this.#k=t}obj={content:{}};store=new Gl;asset;validator;dataPointerFieldMap=new Map;schemaPointerFieldMap=new Map;message="";constructor(){super(),["oninit","onready","onvaliddata","oninvaliddata","onvalidate","ondismiss"].forEach((t=>{this.constructor.elementProperties.get(t).converter=e=>(function(t,e,r){if(r){const o=window[r];"function"==typeof o&&t.addEventListener(e,o)}}(this,t.substring(2),e),e)}))}get root(){return this.obj.content}get valid(){return this.validator?.validate(this.root)??!1}get schema(){return this.i_schema}set schema(t){var e;e=t,Bs&&Bs(e)?(this.i_schema=JSON.parse(JSON.stringify(t)),this.validator=new Ws(this.i_schema),this.valid?(this._errors=null,this.message="",this.compile(),this.requestUpdate()):(this._errors=Cs(),this.message="provided value for 'data' attribute doesn't conform to schema")):(this._errors=Cs(),this.message="provided data for 'schema' attribute is not a valid annotated JSON Schema.")}get options(){return this.i_options}set options(t){this.i_options=t,this.i_options?.storage&&(this.store=new Vl(this.i_options.storage)),this.i_options?.asset&&(this.asset=this.i_options.asset)}get data(){return function(t){const e=JSON.stringify(t,(function(t,e){const r=qt(e),o=qt(this);if(!o?.properties?.[t]?.transient)return r&&Array.isArray(e)&&0===e.length||r&&null!=e&&"object"==typeof e&&Object.keys(e).every((t=>null==e[t]))?r.nullAllowed?null:void 0:e}));return null==e?null:JSON.parse(e)}(this.root)}set data(t){if(this.validator){if(this.checkIn&&!this.validator.validate(t))return this._errors=this.validator?.errors()||null,void(this.message="provided data is not conform to schema (checkin activated)");this.message="",this._errors=null,this.obj.content=t,this.compile(),this.requestUpdate()}else this.message="Unable to accept data because provided JSON Schema is not valid."}attributeChangedCallback(t,e,r){if(super.attributeChangedCallback(t,e,r),"schema"===t){const t=gt.fromAttribute(r);this.schema=t}}render(){return this._errors?.length?this.renderError():this.renderForm()}renderForm(){return U`
