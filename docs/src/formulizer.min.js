          ...
          `]}renderInput(){return T`
            ...
            <div class="input-group">
                <input 
                    ...
                    ?required="${this.required}"
                />
            </div>`}get max(){return this.schema.maximumExclusive&&"maximum"in this.schema?this.schema.maximum-1:"maximum"in this.schema?this.schema.maximum:""}get min(){return this.schema.minimumExclusive&&"minimum"in this.schema?this.schema.minimum+1:"minimum"in this.schema?this.schema.minimum:""}keypress(t){return/[-0123456789]/.test(t.key)?this.min>=0&&"-"===t.key?t.preventDefault():void 0:t.preventDefault()}convertToInput(t){return isNaN(t)?null:Math.floor(t)}convertToValue(t){return Vt(t)||isNaN(t)?this.empty:t}};me=t([r("fz-integer")],me);let ue=class extends It{renderInput(){return T`<div class="input-group">${this.value}</div>`}convertToInput(t){return null==t||""==t?null:t}convertToValue(t){return Vt(t)?this.empty:t}connectedCallback(){super.connectedCallback(),this.value!==this.schema.const&&(this.value=this.schema.const)}};ue=t([r("fz-constant")],ue);const ge=[];for(let t=0;t<256;++t)ge.push((t+256).toString(16).slice(1));let he;const ve=new Uint8Array(16);const xe={};function we(t,e,r){let o;{const t=Date.now(),i=function(){if(!he){if("undefined"==typeof crypto||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");he=crypto.getRandomValues.bind(crypto)}return he(ve)}();!function(t,e,r){t.msecs??=-1/0,t.nsecs??=0,e===t.msecs?(t.nsecs++,t.nsecs>=1e4&&(t.node=void 0,t.nsecs=0)):e>t.msecs?t.nsecs=0:e<t.msecs&&(t.node=void 0);t.node||(t.node=r.slice(10,16),t.node[0]|=1,t.clockseq=16383&(r[8]<<8|r[9]));t.msecs=e}(xe,t,i),o=function(t,e,r,o,i,n,a=0){if(t.length<16)throw new Error("Random bytes length must be >= 16");if(n){if(a<0||a+16>n.length)throw new RangeError(`UUID byte range ${a}:${a+15} is out of buffer bounds`)}else n=new Uint8Array(16),a=0;e??=Date.now(),r??=0,o??=16383&(t[8]<<8|t[9]),i??=t.slice(10,16);const s=(1e4*(268435455&(e+=122192928e5))+r)%4294967296;n[a++]=s>>>24&255,n[a++]=s>>>16&255,n[a++]=s>>>8&255,n[a++]=255&s;const l=e/4294967296*1e4&268435455;n[a++]=l>>>8&255,n[a++]=255&l,n[a++]=l>>>24&15|16,n[a++]=l>>>16&255,n[a++]=o>>>8|128,n[a++]=255&o;for(let t=0;t<6;++t)n[a++]=i[t];return n}(i,xe.msecs,xe.nsecs,xe.clockseq,xe.node,e,r)}return e??function(t,e=0){return(ge[t[e+0]]+ge[t[e+1]]+ge[t[e+2]]+ge[t[e+3]]+"-"+ge[t[e+4]]+ge[t[e+5]]+"-"+ge[t[e+6]]+ge[t[e+7]]+"-"+ge[t[e+8]]+ge[t[e+9]]+"-"+ge[t[e+10]]+ge[t[e+11]]+ge[t[e+12]]+ge[t[e+13]]+ge[t[e+14]]+ge[t[e+15]]).toLowerCase()}(o)}var ye;let ke=class extends It{static{ye=this}static docTypes=["image/png","image/jpeg","image/gif","text/plain","application/pdf","application/msword","application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/vnd.ms-excel","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","application/vnd.ms-powerpoint","application/vnd.openxmlformats-officedocument.presentationml.presentation","application/vnd.oasis.opendocument.text","application/vnd.oasis.opendocument.spreadsheet","application/vnd.oasis.opendocument.presentation","application/vnd.oasis.opendocument.graphics"];photoModal;url="";filename;get hasPreview(){return this.schema.preview}get mimetype(){return this.schema.mimetype?this.schema.mimetype:ye.docTypes.join(", ")}get store(){return this.form.store}static get styles(){return[...super.styles,l`
                .fileUpload {
                    position: relative;
                    overflow: hidden;
                    margin: 0px;
            ...
            </div>`}change(){super.change(),this.requestUpdate()}convertToInput(t){return t??""}convertToValue(t){return Vt(t)?this.empty:t}connectedCallback(){super.connectedCallback(),this.addEventListener("update",(()=>this.check()))}async firstUpdated(t){if(super.firstUpdated(t),this.photoModal=this.shadowRoot?.querySelector("fz-photo-dlg")??void 0,this.photoModal.addEventListener("close",(t=>{this.set(we(),t.detail.blob,"photo.png")})),null!=this.value){const t=await this.store.get(this.value);t?this.set(this.value,t.blob,t.filename):(this.valid=!1,this.message="document not found")}}async open(){if(null==this.value)return;const t=await this.store.get(this.value);let e;if(t)e=URL.createObjectURL(t.blob);else{const t=new Blob([`FzForm ERROR: Couldn't open document uuid=${this.value}`],{type:"text/plain"});e=URL.createObjectURL(t)}window.open(e)}setUrl(t){if(this.url="",t.type.startsWith("image")){const e=new FileReader;e.readAsDataURL(t),e.onload=t=>{this.url=t.target?.result,this.requestUpdate()}}}async set(t,e,r){e&&r&&(this.value&&await this.store.remove(this.value),this.filename=r,this.value=t,this.setUrl(e),this.value&&await this.store.put(this.value,e,this.filename,this.pointer),this.change(),this.requestUpdate())}async save(t){await this.set(we(),t.target.files[0],t.target.files[0].name)}async delete(){this.value&&await this.store.remove(this.value),this.value=this.empty,this.url="",this.filename="",this.change(),this.requestUpdate()}};ke=ye=t([r("fz-document")],ke);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
class De extends Yt{constructor(t){if(super(t),this.it=Q,t.type!==Ut)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Q||null==t)return this._t=void 0,this.it=t;if(t===Y)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}De.directiveName="unsafeHTML",De.resultType=1;const ze=Tt(De),Fe={};function Ae(t,e){"string"!=typeof e&&(e=Ae.defaultChars);const r=function(t){let e=Fe[t];if(e)return e;e=Fe[t]=[];for(let t=0;t<128;t++){const r=String.fromCharCode(t);e.push(r)}for(let r=0;r<t.length;r++){const o=t.charCodeAt(r);e[o]="%"+("0"+o.toString(16).toUpperCase()).slice(-2)}return e}(e);return t.replace(/(%[a-f0-9]{2})+/gi,(function(t){let e="";for(let o=0,i=t.length;o<i;o+=3){const n=parseInt(t.slice(o+1,o+3),16);if(n<128)e+=r[n];else{if(192==(224&n)&&o+3<i){const r=parseInt(t.slice(o+4,o+6),16);if(128==(192&r)){const t=n<<6&1984|63&r;e+=t<128?"��":String.fromCharCode(t),o+=3;continue}}if(224==(240&n)&&o+6<i){const r=parseInt(t.slice(o+4,o+6),16),i=parseInt(t.slice(o+7,o+9),16);if(128==(192&r)&&128==(192&i)){const t=n<<12&61440|r<<6&4032|63&i;e+=t<2048||t>=55296&&t<=57343?"���":String.fromCharCode(t),o+=6;continue}}if(240==(248&n)&&o+9<i){const r=parseInt(t.slice(o+4,o+6),16),i=parseInt(t.slice(o+7,o+9),16),a=parseInt(t.slice(o+10,o+12),16);if(128==(192&r)&&128==(192&i)&&128==(192&a)){let t=n<<18&1835008|r<<12&258048|i<<6&4032|63&a;t<65536||t>1114111?e+="����":(t-=65536,e+=String.fromCharCode(55296+(t>>10),56320+(1023&t))),o+=9;continue}}e+="�"}}return e}))}Ae.defaultChars=";/?:@&=+$,#",Ae.componentChars="";const qe={};function je(t,e,r){"string"!=typeof e&&(r=e,e=je.defaultChars),void 0===r&&(r=!0);const o=function(t){let e=qe[t];if(e)return e;e=qe[t]=[];for(let t=0;t<128;t++){const r=String.fromCharCode(t);/^[0-9a-z]$/i.test(r)?e.push(r):e.push("%"+("0"+t.toString(16).toUpperCase()).slice(-2))}for(let r=0;r<t.length;r++)e[t.charCodeAt(r)]=t[r];return e}(e);let i="";for(let e=0,n=t.length;e<n;e++){const a=t.charCodeAt(e);if(r&&37===a&&e+2<n&&/^[0-9a-f]{2}$/i.test(t.slice(e+1,e+3)))i+=t.slice(e,e+3),e+=2;else if(a<128)i+=o[a];else if(a>=55296&&a<=57343){if(a>=55296&&a<=56319&&e+1<n){const r=t.charCodeAt(e+1);if(r>=56320&&r<=57343){i+=encodeURIComponent(t[e]+t[e+1]),e++;continue}}i+="%EF%BF%BD"}else i+=encodeURIComponent(t[e])}return i}function Ee(t){let e="";return e+=t.protocol||"",e+=t.slashes?"//":"",e+=t.auth?t.auth+"@":"",t.hostname&&-1!==t.hostname.indexOf(":")?e+="["+t.hostname+"]":e+=t.hostname||"",e+=t.port?":"+t.port:"",e+=t.pathname||"",e+=t.search||"",e+=t.hash||"",e}function Re(){this.protocol=null,this.slashes=null,this.auth=null,this.port=null,this.hostname=null,this.hash=null,this.search=null,this.pathname=null}je.defaultChars=";/?:@&=+$,-_.!~*'()#",je.componentChars="-_.!~*'()";const Xe=/^([a-z0-9.+-]+:)/i,Pe=/:[0-9]*$/,Ge=/^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,Ve=["{","}","|","\\","^","`"].concat(["<",">",'"',"`"," ","\r","\n","\t"]),Se=["'"].concat(Ve),Oe=["%","/","?",";","#"].concat(Se),Be=["/","?","#"],Me=/^[+a-z0-9A-Z_-]{0,63}$/,We=/^([+a-z0-9A-Z_-]{0,63})(.*)$/,Ze={javascript:!0,"javascript:":!0},Le={http:!0,https:!0,ftp:!0,gopher:!0,file:!0,"http:":!0,"https:":!0,"ftp:":!0,"gopher:":!0,"file:":!0};function Ne(t,e){if(t&&t instanceof Re)return t;const r=new Re;return r.parse(t,e),r}Re.prototype.parse=function(t,e){let r,o,i,n=t;if(n=n.trim(),!e&&1===t.split("#").length){const t=Ge.exec(n);if(t)return this.pathname=t[1],t[2]&&(this.search=t[2]),this}let a=Xe.exec(n);if(a&&(a=a[0],r=a.toLowerCase(),this.protocol=a,n=n.substr(a.length)),(e||a||n.match(/^\/\/[^@\/]+@[^@\/]+/))&&(i="//"===n.substr(0,2),!i||a&&Ze[a]||(n=n.substr(2),this.slashes=!0)),!Ze[a]&&(i||a&&!Le[a])){let t,e,r=-1;for(let t=0;t<Be.length;t++)o=n.indexOf(Be[t]),-1!==o&&(-1===r||o<r)&&(r=o);e=-1===r?n.lastIndexOf("@"):n.lastIndexOf("@",r),-1!==e&&(t=n.slice(0,e),n=n.slice(e+1),this.auth=t),r=-1;for(let t=0;t<Oe.length;t++)o=n.indexOf(Oe[t]),-1!==o&&(-1===r||o<r)&&(r=o);-1===r&&(r=n.length),":"===n[r-1]&&r--;const i=n.slice(0,r);n=n.slice(r),this.parseHost(i),this.hostname=this.hostname||"";const a="["===this.hostname[0]&&"]"===this.hostname[this.hostname.length-1];if(!a){const t=this.hostname.split(/\./);for(let e=0,r=t.length;e<r;e++){const r=t[e];if(r&&!r.match(Me)){let o="";for(let t=0,e=r.length;t<e;t++)r.charCodeAt(t)>127?o+="x":o+=r[t];if(!o.match(Me)){const o=t.slice(0,e),i=t.slice(e+1),a=r.match(We);a&&(o.push(a[1]),i.unshift(a[2])),i.length&&(n=i.join(".")+n),this.hostname=o.join(".");break}}}}this.hostname.length>255&&(this.hostname=""),a&&(this.hostname=this.hostname.substr(1,this.hostname.length-2))}const s=n.indexOf("#");-1!==s&&(this.hash=n.substr(s),n=n.slice(0,s));const l=n.indexOf("?");return-1!==l&&(this.search=n.substr(l),n=n.slice(0,l)),n&&(this.pathname=n),Le[r]&&this.hostname&&!this.pathname&&(this.pathname=""),this},Re.prototype.parseHost=function(t){let e=Pe.exec(t);e&&(e=e[0],":"!==e&&(this.port=e.substr(1)),t=t.substr(0,t.length-e.length)),t&&(this.hostname=t)};var He,Ce=Object.freeze({__proto__:null,decode:Ae,encode:je,format:Ee,parse:Ne}),Ie=/[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Ke=/[\0-\x1F\x7F-\x9F]/,Je=/[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1B7D\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3E]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/,Ue=/[\$\+<->\^`\|~\xA2-\xA6\xA8\xA9\xAC\xAE-\xB1\xB4\xB8\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0384\u0385\u03F6\u0482\u058D-\u058F\u0606-\u0608\u060B\u060E\u060F\u06DE\u06E9\u06FD\u06FE\u07F6\u07FE\u07FF\u0888\u09F2\u09F3\u09FA\u09FB\u0AF1\u0B70\u0BF3-\u0BFA\u0C7F\u0D4F\u0D79\u0E3F\u0F01-\u0F03\u0F13\u0F15-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE\u0FCF\u0FD5-\u0FD8\u109E\u109F\u1390-\u1399\u166D\u17DB\u1940\u19DE-\u19FF\u1B61-\u1B6A\u1B74-\u1B7C\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2044\u2052\u207A-\u207C\u208A-\u208C\u20A0-\u20C0\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2307\u230C-\u2328\u232B-\u2426\u2440-\u244A\u249C-\u24E9\u2500-\u2767\u2794-\u27C4\u27C7-\u27E5\u27F0-\u2982\u2999-\u29D7\u29DC-\u29FB\u29FE-\u2B73\u2B76-\u2B95\u2B97-\u2BFF\u2CE5-\u2CEA\u2E50\u2E51\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFF\u3004\u3012\u3013\u3020\u3036\u3037\u303E\u303F\u309B\u309C\u3190\u3191\u3196-\u319F\u31C0-\u31E3\u31EF\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uAA77-\uAA79\uAB5B\uAB6A\uAB6B\uFB29\uFBB2-\uFBC2\uFD40-\uFD4F\uFDCF\uFDFC-\uFDFF\uFE62\uFE64-\uFE66\uFE69\uFF04\uFF0B\uFF1C-\uFF1E\uFF3E\uFF40\uFF5C\uFF5E\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC]|\uD802[\uDC77\uDC78\uDEC8]|\uD805\uDF3F|\uD807[\uDFD5-\uDFF1]|\uD81A[\uDF3C-\uDF3F\uDF45]|\uD82F\uDC9C|\uD833[\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA]/,Te=/[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/,Ye=Object.freeze({__proto__:null,Any:Ie,Cc:Ke,Cf:/[\xAD\u0600-\u0605\u061C\u06DD\u070F\u0890\u0891\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC3F]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/,P:Je,S:Ue,Z:Te}),Qe=new Uint16Array('ᵁ<Õıʊҝջאٵ۞ޢߖࠏ੊ઑඡ๭༉༦჊ረዡᐕᒝᓃᓟᔥ\0\0\0\0\0\0ᕫᛍᦍᰒᷝ὾⁠↰⊍⏀⏻⑂⠤⤒ⴈ⹈⿎〖㊺㘹㞬㣾㨨㩱㫠㬮ࠀEMabcfglmnoprstu\\bfms¦³¹ÈÏlig耻Æ䃆P耻&䀦cute耻Á䃁reve;䄂Āiyx}rc耻Â䃂;䐐r;쀀𝔄rave耻À䃀pha;䎑acr;䄀d;橓Āgp¡on;䄄f;쀀𝔸plyFunction;恡ing耻Å䃅Ācs¾Ãr;쀀𝒜ign;扔ilde耻Ã䃃ml耻Ä䃄ЀaceforsuåûþėĜĢħĪĀcrêòkslash;或Ŷöø;櫧ed;挆y;䐑ƀcrtąċĔause;戵noullis;愬a;䎒r;쀀𝔅pf;쀀𝔹eve;䋘còēmpeq;扎܀HOacdefhilorsuōőŖƀƞƢƵƷƺǜȕɳɸɾcy;䐧PY耻©䂩ƀcpyŝŢźute;䄆Ā;iŧŨ拒talDifferentialD;慅leys;愭ȀaeioƉƎƔƘron;䄌dil耻Ç䃇rc;䄈nint;戰ot;䄊ĀdnƧƭilla;䂸terDot;䂷òſi;䎧rcleȀDMPTǇǋǑǖot;抙inus;抖lus;投imes;抗oĀcsǢǸkwiseContourIntegral;戲eCurlyĀDQȃȏoubleQuote;思uote;怙ȀlnpuȞȨɇɕonĀ;eȥ�
lig;耀ﬃɩᾹ\0\0᾽g;耀ﬀig;耀ﬄ;쀀𝔣lig;耀ﬁlig;쀀fjƀaltῙ῜ῡt;晭ig;耀ﬂns;斱of;䆒ǰ΅\0ῳf;쀀𝕗ĀakֿῷĀ;vῼ´拔;櫙artint;樍Āao‌⁕Ācs‑⁒α‚‰‸⁅⁈\0⁐β•‥‧‪‬\0‮耻½䂽;慓耻¼䂼;慕;慙;慛Ƴ‴\0‶;慔;慖ʴ‾⁁\0\0⁃耻¾䂾;慗;慜5;慘ƶ⁌\0⁎;慚;慝8;慞l;恄wn;挢cr;쀀𝒻ࢀEabcdefgijlnorstv₂₉₟₥₰₴⃰⃵⃺⃿℃ℒℸ̗ℾ⅒↞Ā;lٍ₇;檌ƀcmpₐₕ₝ute;䇵maĀ;dₜ᳚䎳;檆reve;䄟Āiy₪₮rc;䄝;䐳ot;䄡Ȁ;lqsؾق₽⃉ƀ;qsؾٌ⃄lanô٥Ȁ;cdl٥⃒⃥⃕c;檩otĀ;o⃜⃝檀Ā;l⃢⃣檂;檄Ā;e⃪⃭쀀⋛︀s;檔r;쀀𝔤Ā;gٳ؛mel;愷cy;䑓Ȁ;Eajٚℌℎℐ;檒;檥;檤ȀEaesℛℝ℩ℴ;扩pĀ;p℣ℤ檊rox»ℤĀ;q℮ℯ檈Ā;q℮ℛim;拧pf;쀀𝕘Āci⅃ⅆr;愊mƀ;el٫ⅎ⅐;檎;檐茀>;cdlqr׮ⅠⅪⅮⅳⅹĀciⅥⅧ;檧r;橺ot;拗Par;榕uest;橼ʀadelsↄⅪ←ٖ↛ǰ↉\0↎proø₞r;楸qĀlqؿ↖lesó₈ií٫Āen↣↭rtneqq;쀀≩︀Å↪ԀAabcefkosy⇄⇇⇱⇵⇺∘∝∯≨≽ròΠȀilmr⇐⇔⇗⇛rsðᒄf»․ilôکĀdr⇠⇤cy;䑊ƀ;cwࣴ⇫⇯ir;楈;憭ar;意irc;䄥ƀalr∁∎∓rtsĀ;u∉∊晥it»∊lip;怦con;抹r;쀀𝔥sĀew∣∩arow;椥arow;椦ʀamopr∺∾≃≞≣rr;懿tht;戻kĀlr≉≓eftarrow;憩ightarrow;憪f;쀀𝕙bar;怕ƀclt≯≴≸r;쀀𝒽asè⇴rok;䄧Ābp⊂⊇ull;恃hen»ᱛૡ⊣\0⊪\0⊸⋅⋎\0⋕⋳\0\0⋸⌢⍧⍢⍿\0⎆⎪⎴cute耻í䃭ƀ;iyݱ⊰⊵rc耻î䃮;䐸Ācx⊼⊿y;䐵cl耻¡䂡ĀfrΟ⋉;쀀𝔦rave耻ì䃬Ȁ;inoܾ⋝⋩⋮Āin⋢⋦nt;樌t;戭fin;槜ta;愩lig;䄳ƀaop⋾⌚⌝ƀcgt⌅⌈⌗r;䄫ƀelpܟ⌏⌓inåގarôܠh;䄱f;抷ed;䆵ʀ;cfotӴ⌬⌱⌽⍁are;愅inĀ;t⌸⌹戞ie;槝doô⌙ʀ;celpݗ⍌⍐⍛⍡al;抺Āgr
�r;榅;쀀𝕝us;樭imes;樴š❋❏st;戗áፎƀ;ef❗❘᠀旊nge»❘arĀ;l❤❥䀨t;榓ʀachmt❳❶❼➅➇ròࢨorneòᶌarĀ;d྘➃;業;怎ri;抿̀achiqt➘➝ੀ➢➮➻quo;怹r;쀀𝓁mƀ;egল➪➬;檍;檏Ābu┪➳oĀ;rฟ➹;怚rok;䅂萀<;cdhilqrࠫ⟒☹⟜⟠⟥⟪⟰Āci⟗⟙;檦r;橹reå◲mes;拉arr;楶uest;橻ĀPi⟵⟹ar;榖ƀ;ef⠀भ᠛旃rĀdu⠇⠍shar;楊har;楦Āen⠗⠡rtneqq;쀀≨︀Å⠞܀Dacdefhilnopsu⡀⡅⢂⢎⢓⢠⢥⢨⣚⣢⣤ઃ⣳⤂Dot;戺Ȁclpr⡎⡒⡣⡽r耻¯䂯Āet⡗⡙;時Ā;e⡞⡟朠se»⡟Ā;sျ⡨toȀ;dluျ⡳⡷⡻owîҌefôएðᏑker;斮Āoy⢇⢌mma;権;䐼ash;怔asuredangle»ᘦr;쀀𝔪o;愧ƀcdn⢯⢴⣉ro耻µ䂵Ȁ;acdᑤ⢽⣀⣄sôᚧir;櫰ot肻·Ƶusƀ;bd⣒ᤃ⣓戒Ā;uᴼ⣘;横ţ⣞⣡p;櫛ò−ðઁĀdp⣩⣮els;抧f;쀀𝕞Āct⣸⣽r;쀀𝓂pos»ᖝƀ;lm⤉⤊⤍䎼timap;抸ఀGLRVabcdefghijlmoprstuvw⥂⥓⥾⦉⦘⧚⧩⨕⨚⩘⩝⪃⪕⪤⪨⬄⬇⭄⭿⮮ⰴⱧⱼ⳩Āgt⥇⥋;쀀⋙̸Ā;v⥐௏쀀≫⃒ƀelt⥚⥲⥶ftĀar⥡⥧rrow;懍ightarrow;懎;쀀⋘̸Ā;v⥻ే쀀≪⃒ightarrow;懏ĀDd⦎⦓ash;抯ash;抮ʀbcnpt⦣⦧⦬⦱⧌la»˞ute;䅄g;쀀∠⃒ʀ;Eiop඄⦼⧀⧅⧈;쀀⩰̸d;쀀≋̸s;䅉roø඄urĀ;a⧓⧔普lĀ;s⧓ସǳ⧟\0⧣p肻 ଷmpĀ;e௹ఀʀaeouy⧴⧾⨃⨐⨓ǰ⧹\0⧻;橃on;䅈dil;䅆ngĀ;dൾ⨊ot;쀀⩭̸p;橂;䐽ash;怓΀;Aadqsxஒ⨩⨭⨻⩁⩅⩐rr;懗rĀhr⨳⨶k;椤Ā;oᏲᏰot;쀀≐̸uiöୣĀei⩊⩎ar;椨í஘istĀ;s஠டr;쀀𝔫ȀEest௅⩦⩹⩼ƀ;qs஼⩭௡ƀ;qs஼௅⩴lanô௢ií௪Ā;rஶ⪁»ஷƀAap⪊⪍⪑rò⥱rr;憮ar;櫲ƀ;svྍ⪜ྌĀ;d⪡⪢拼;拺cy;䑚΀AEadest⪷⪺⪾⫂⫅⫶⫹rò⥦;쀀≦̸rr;憚r;急Ȁ;fqs఻⫎⫣⫯tĀar⫔⫙rro÷�
�㣲rò㢨l耻ü䃼angle;榧ހABDacdeflnoprsz㤜㤟㤩㤭㦵㦸㦽㧟㧤㧨㧳㧹㧽㨁㨠ròϷarĀ;v㤦㤧櫨;櫩asèϡĀnr㤲㤷grt;榜΀eknprst㓣㥆㥋㥒㥝㥤㦖appá␕othinçẖƀhir㓫⻈㥙opô⾵Ā;hᎷ㥢ïㆍĀiu㥩㥭gmá㎳Ābp㥲㦄setneqĀ;q㥽㦀쀀⊊︀;쀀⫋︀setneqĀ;q㦏㦒쀀⊋︀;쀀⫌︀Āhr㦛㦟etá㚜iangleĀlr㦪㦯eft»थight»ၑy;䐲ash»ံƀelr㧄㧒㧗ƀ;beⷪ㧋㧏ar;抻q;扚lip;拮Ābt㧜ᑨaòᑩr;쀀𝔳tré㦮suĀbp㧯㧱»ജ»൙pf;쀀𝕧roð໻tré㦴Ācu㨆㨋r;쀀𝓋Ābp㨐㨘nĀEe㦀㨖»㥾nĀEe㦒㨞»㦐igzag;榚΀cefoprs㨶㨻㩖㩛㩔㩡㩪irc;䅵Ādi㩀㩑Ābg㩅㩉ar;機eĀ;qᗺ㩏;扙erp;愘r;쀀𝔴pf;쀀𝕨Ā;eᑹ㩦atèᑹcr;쀀𝓌ૣណ㪇\0㪋\0㪐㪛\0\0㪝㪨㪫㪯\0\0㫃㫎\0㫘ៜ៟tré៑r;쀀𝔵ĀAa㪔㪗ròσrò৶;䎾ĀAa㪡㪤ròθrò৫að✓is;拻ƀdptឤ㪵㪾Āfl㪺ឩ;쀀𝕩imåឲĀAa㫇㫊ròώròਁĀcq㫒ីr;쀀𝓍Āpt៖㫜ré។Ѐacefiosu㫰㫽㬈㬌㬑㬕㬛㬡cĀuy㫶㫻te耻ý䃽;䑏Āiy㬂㬆rc;䅷;䑋n耻¥䂥r;쀀𝔶cy;䑗pf;쀀𝕪cr;쀀𝓎Ācm㬦㬩y;䑎l耻ÿ䃿Ԁacdefhiosw㭂㭈㭔㭘㭤㭩㭭㭴㭺㮀cute;䅺Āay㭍㭒ron;䅾;䐷ot;䅼Āet㭝㭡træᕟa;䎶r;쀀𝔷cy;䐶grarr;懝pf;쀀𝕫cr;쀀𝓏Ājn㮅㮇;怍j;怌'.split("").map((t=>t.charCodeAt(0)))),$e=new Uint16Array("Ȁaglq\tɭ\0\0p;䀦os;䀧t;䀾t;䀼uot;䀢".split("").map((t=>t.charCodeAt(0))));const _e=new Map([[0,65533],[128,8364],[130,8218],[131,402],[132,8222],[133,8230],[134,8224],[135,8225],[136,710],[137,8240],[138,352],[139,8249],[140,338],[142,381],[145,8216],[146,8217],[147,8220],[148,8221],[149,8226],[150,8211],[151,8212],[152,732],[153,8482],[154,353],[155,8250],[156,339],[158,382],[159,376]]),tr=null!==(He=String.fromCodePoint)&&void 0!==He?He:function(t){let e="";return t>65535&&(t-=65536,e+=String.fromCharCode(t>>>10&1023|55296),t=56320|1023&t),e+=String.fromCharCode(t),e};var er;!function(t){t[t.NUM=35]="NUM",t[t.SEMI=59]="SEMI",t[t.EQUALS=61]="EQUALS",t[t.ZERO=48]="ZERO",t[t.NINE=57]="NINE",t[t.LOWER_A=97]="LOWER_A",t[t.LOWER_F=102]="LOWER_F",t[t.LOWER_X=120]="LOWER_X",t[t.LOWER_Z=122]="LOWER_Z",t[t.UPPER_A=65]="UPPER_A",t[t.UPPER_F=70]="UPPER_F",t[t.UPPER_Z=90]="UPPER_Z"}(er||(er={}));var rr,or,ir;function nr(t){return t>=er.ZERO&&t<=er.NINE}function ar(t){return t>=er.UPPER_A&&t<=er.UPPER_F||t>=er.LOWER_A&&t<=er.LOWER_F}function sr(t){return t===er.EQUALS||function(t){return t>=er.UPPER_A&&t<=er.UPPER_Z||t>=er.LOWER_A&&t<=er.LOWER_Z||nr(t)}(t)}!function(t){t[t.VALUE_LENGTH=49152]="VALUE_LENGTH",t[t.BRANCH_LENGTH=16256]="BRANCH_LENGTH",t[t.JUMP_TABLE=127]="JUMP_TABLE"}(rr||(rr={})),function(t){t[t.EntityStart=0]="EntityStart",t[t.NumericStart=1]="NumericStart",t[t.NumericDecimal=2]="NumericDecimal",t[t.NumericHex=3]="NumericHex",t[t.NamedEntity=4]="NamedEntity"}(or||(or={})),function(t){t[t.Legacy=0]="Legacy",t[t.Strict=1]="Strict",t[t.Attribute=2]="Attribute"}(ir||(ir={}));class lr{constructor(t,e,r){this.decodeTree=t,this.emitCodePoint=e,this.errors=r,this.state=or.EntityStart,this.consumed=1,this.result=0,this.treeIndex=0,this.excess=1,this.decodeMode=ir.Strict}startEntity(t){this.decodeMode=t,this.state=or.EntityStart,this.result=0,this.treeIndex=0,this.excess=1,this.consumed=1}write(t,e){switch(this.state){case or.EntityStart:return t.charCodeAt(e)===er.NUM?(this.state=or.NumericStart,this.consumed+=1,this.stateNumericStart(t,e+1)):(this.state=or.NamedEntity,this.stateNamedEntity(t,e));case or.NumericStart:return this.stateNumericStart(t,e);case or.NumericDecimal:return this.stateNumericDecimal(t,e);case or.NumericHex:return this.stateNumericHex(t,e);case or.NamedEntity:return this.stateNamedEntity(t,e)}}stateNumericStart(t,e){return e>=t.length?-1:(32|t.charCodeAt(e))===er.LOWER_X?(this.state=or.NumericHex,this.consumed+=1,this.stateNumericHex(t,e+1)):(this.state=or.NumericDecimal,this.stateNumericDecimal(t,e))}addToNumericResult(t,e,r,o){if(e!==r){const i=r-e;this.result=this.result*Math.pow(o,i)+parseInt(t.substr(e,i),o),this.consumed+=i}}stateNumericHex(t,e){const r=e;for(;e<t.length;){const o=t.charCodeAt(e);if(!nr(o)&&!ar(o))return this.addToNumericResult(t,r,e,16),this.emitNumericEntity(o,3);e+=1}return this.addToNumericResult(t,r,e,16),-1}stateNumericDecimal(t,e){const r=e;for(;e<t.length;){const o=t.charCodeAt(e);if(!nr(o))return this.addToNumericResult(t,r,e,10),this.emitNumericEntity(o,2);e+=1}return this.addToNumericResult(t,r,e,10),-1}emitNumericEntity(t,e){var r;if(this.consumed<=e)return null===(r=this.errors)||void 0===r||r.absenceOfDigitsInNumericCharacterReference(this.consumed),0;if(t===er.SEMI)this.consumed+=1;else if(this.decodeMode===ir.Strict)return 0;return this.emitCodePoint(function(t){var e;return t>=55296&&t<=57343||t>1114111?65533:null!==(e=_e.get(t))&&void 0!==e?e:t}(this.result),this.consumed),this.errors&&(t!==er.SEMI&&this.errors.missingSemicolonAfterCharacterReference(),this.errors.validateNumericCharacterReference(this.result)),this.consumed}stateNamedEntity(t,e){const{decodeTree:r}=this;let o=r[this.treeIndex],i=(o&rr.VALUE_LENGTH)>>14;for(;e<t.length;e++,this.excess++){const n=t.charCodeAt(e);if(this.treeIndex=cr(r,o,this.treeIndex+Math.max(1,i),n),this.treeIndex<0)return 0===this.result||this.decodeMode===ir.Attribute&&(0===i||sr(n))?0:this.emitNotTerminatedNamedEntity();if(o=r[this.treeIndex],i=(o&rr.VALUE_LENGTH)>>14,0!==i){if(n===er.SEMI)return this.emitNamedEntityData(this.treeIndex,i,this.consumed+this.excess);this.decodeMode!==ir.Strict&&(this.result=this.treeIndex,this.consumed+=this.excess,this.excess=0)}}return-1}emitNotTerminatedNamedEntity(){var t;const{result:e,decodeTree:r}=this,o=(r[e]&rr.VALUE_LENGTH)>>14;return this.emitNamedEntityData(e,o,this.consumed),null===(t=this.errors)||void 0===t||t.missingSemicolonAfterCharacterReference(),this.consumed}emitNamedEntityData(t,e,r){const{decodeTree:o}=this;return this.emitCodePoint(1===e?o[t]&~rr.VALUE_LENGTH:o[t+1],r),3===e&&this.emitCodePoint(o[t+2],r),r}end(){var t;switch(this.state){case or.NamedEntity:return 0===this.result||this.decodeMode===ir.Attribute&&this.result!==this.treeIndex?0:this.emitNotTerminatedNamedEntity();case or.NumericDecimal:return this.emitNumericEntity(0,2);case or.NumericHex:return this.emitNumericEntity(0,3);case or.NumericStart:return null===(t=this.errors)||void 0===t||t.absenceOfDigitsInNumericCharacterReference(this.consumed),0;case or.EntityStart:return 0}}}function br(t){let e="";const r=new lr(t,(t=>e+=tr(t)));return function(t,o){let i=0,n=0;for(;(n=t.indexOf("&",n))>=0;){e+=t.slice(i,n),r.startEntity(o);const a=r.write(t,n+1);if(a<0){i=n+r.end();break}i=n+a,n=0===a?i+1:i}const a=e+t.slice(i);return e="",a}}function cr(t,e,r,o){const i=(e&rr.BRANCH_LENGTH)>>7,n=e&rr.JUMP_TABLE;if(0===i)return 0!==n&&o===n?r:-1;if(n){const e=o-n;return e<0||e>=i?-1:t[r+e]-1}let a=r,s=a+i-1;for(;a<=s;){const e=a+s>>>1,r=t[e];if(r<o)a=e+1;else{if(!(r>o))return t[e+i];s=e-1}}return-1}const dr=br(Qe);function fr(t,e=ir.Legacy){return dr(t,e)}function pr(t){return"[object String]"===function(t){return Object.prototype.toString.call(t)}(t)}br($e);const mr=Object.prototype.hasOwnProperty;function ur(t){return Array.prototype.slice.call(arguments,1).forEach((function(e){if(e){if("object"!=typeof e)throw new TypeError(e+"must be object");Object.keys(e).forEach((function(r){t[r]=e[r]}))}})),t}function gr(t,e,r){return[].concat(t.slice(0,e),r,t.slice(e+1))}function hr(t){return!(t>=55296&&t<=57343)&&(!(t>=64976&&t<=65007)&&(!!(65535&~t&&65534!=(65535&t))&&(!(t>=0&&t<=8)&&(11!==t&&(!(t>=14&&t<=31)&&(!(t>=127&&t<=159)&&!(t>1114111)))))))}function vr(t){if(t>65535){const e=55296+((t-=65536)>>10),r=56320+(1023&t);return String.fromCharCode(e,r)}return String.fromCharCode(t)}const xr=/\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,wr=new RegExp(xr.source+"|"+/&([a-z#][a-z0-9]{1,31});/gi.source,"gi"),yr=/^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;function kr(t){return t.indexOf("\\")<0&&t.indexOf("&")<0?t:t.replace(wr,(function(t,e,r){return e||function(t,e){if(35===e.charCodeAt(0)&&yr.test(e)){const r="x"===e[1].toLowerCase()?parseInt(e.slice(2),16):parseInt(e.slice(1),10);return hr(r)?vr(r):t}const r=fr(t);return r!==t?r:t}(t,r)}))}const Dr=/[&<>"]/,zr=/[&<>"]/g,Fr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"};function Ar(t){return Fr[t]}function qr(t){return Dr.test(t)?t.replace(zr,Ar):t}const jr=/[.?*+^$[\]\\(){}|-]/g;function Er(t){switch(t){case 9:case 32:return!0}return!1}function Rr(t){if(t>=8192&&t<=8202)return!0;switch(t){case 9:case 10:case 11:case 12:case 13:case 32:case 160:case 5760:case 8239:case 8287:case 12288:return!0}return!1}function Xr(t){return Je.test(t)||Ue.test(t)}function Pr(t){switch(t){case 33:case 34:case 35:case 36:case 37:case 38:case 39:case 40:case 41:case 42:case 43:case 44:case 45:case 46:case 47:case 58:case 59:case 60:case 61:case 62:case 63:case 64:case 91:case 92:case 93:case 94:case 95:case 96:case 123:case 124:case 125:case 126:return!0;default:return!1}}function Gr(t){return t=t.trim().replace(/\s+/g," "),"Ṿ"==="ẞ".toLowerCase()&&(t=t.replace(/ẞ/g,"ß")),t.toLowerCase().toUpperCase()}const Vr={mdurl:Ce,ucmicro:Ye};var Sr=Object.freeze({__proto__:null,arrayReplaceAt:gr,assign:ur,escapeHtml:qr,escapeRE:function(t){return t.replace(jr,"\\$&")},fromCodePoint:vr,has:function(t,e){return mr.call(t,e)},isMdAsciiPunct:Pr,isPunctChar:Xr,isSpace:Er,isString:pr,isValidEntityCode:hr,isWhiteSpace:Rr,lib:Vr,normalizeReference:Gr,unescapeAll:kr,unescapeMd:function(t){return t.indexOf("\\")<0?t:t.replace(xr,"$1")}});var Or=Object.freeze({__proto__:null,parseLinkDestination:function(t,e,r){let o,i=e;const n={ok:!1,pos:0,str:""};if(60===t.charCodeAt(i)){for(i++;i<r;){if(o=t.charCodeAt(i),10===o)return n;if(60===o)return n;if(62===o)return n.pos=i+1,n.str=kr(t.slice(e+1,i)),n.ok=!0,n;92===o&&i+1<r?i+=2:i++}return n}let a=0;for(;i<r&&(o=t.charCodeAt(i),32!==o)&&!(o<32||127===o);)if(92===o&&i+1<r){if(32===t.charCodeAt(i+1))break;i+=2}else{if(40===o&&(a++,a>32))return n;if(41===o){if(0===a)break;a--}i++}return e===i||0!==a||(n.str=kr(t.slice(e,i)),n.pos=i,n.ok=!0),n},parseLinkLabel:function(t,e,r){let o,i,n,a;const s=t.posMax,l=t.pos;for(t.pos=e+1,o=1;t.pos<s;){if(n=t.src.charCodeAt(t.pos),93===n&&(o--,0===o)){i=!0;break}if(a=t.pos,t.md.inline.skipToken(t),91===n)if(a===t.pos-1)o++;else if(r)return t.pos=l,-1}let b=-1;return i&&(b=t.pos),t.pos=l,b},parseLinkTitle:function(t,e,r,o){let i,n=e;const a={ok:!1,can_continue:!1,pos:0,str:"",marker:0};if(o)a.str=o.str,a.marker=o.marker;else{if(n>=r)return a;let o=t.charCodeAt(n);if(34!==o&&39!==o&&40!==o)return a;e++,n++,40===o&&(o=41),a.marker=o}for(;n<r;){if(i=t.charCodeAt(n),i===a.marker)return a.pos=n+1,a.str+=kr(t.slice(e,n)),a.ok=!0,a;if(40===i&&41===a.marker)return a;92===i&&n+1<r&&n++,n++}return a.can_continue=!0,a.str+=kr(t.slice(e,n)),a}});const Br={};function Mr(){this.rules=ur({},Br)}function Wr(){this.i=[],this.m=null}function Zr(t,e,r){this.type=t,this.tag=e,this.attrs=null,this.map=null,this.nesting=r,this.level=0,this.children=null,this.content="",this.markup="",this.info="",this.meta=null,this.block=!1,this.hidden=!1}function Lr(t,e,r){this.src=t,this.env=r,this.tokens=[],this.inlineMode=!1,this.md=e}Br.code_inline=function(t,e,r,o,i){const n=t[e];return"<code"+i.renderAttrs(n)+">"+qr(n.content)+"</code>"},Br.code_block=function(t,e,r,o,i){const n=t[e];return"<pre"+i.renderAttrs(n)+"><code>"+qr(t[e].content)+"</code></pre>\n"},Br.fence=function(t,e,r,o,i){const n=t[e],a=n.info?kr(n.info).trim():"";let s,l="",b="";if(a){const t=a.split(/(\s+)/g);l=t[0],b=t.slice(2).join("")}if(s=r.highlight&&r.highlight(n.content,l,b)||qr(n.content),0===s.indexOf("<pre"))return s+"\n";if(a){const t=n.attrIndex("class"),e=n.attrs?n.attrs.slice():[];t<0?e.push(["class",r.langPrefix+l]):(e[t]=e[t].slice(),e[t][1]+=" "+r.langPrefix+l);const o={attrs:e};return`<pre><code${i.renderAttrs(o)}>${s}</code></pre>\n`}return`<pre><code${i.renderAttrs(n)}>${s}</code></pre>\n`},Br.image=function(t,e,r,o,i){const n=t[e];return n.attrs[n.attrIndex("alt")][1]=i.renderInlineAsText(n.children,r,o),i.renderToken(t,e,r)},Br.hardbreak=function(t,e,r){return r.xhtmlOut?"<br />\n":"<br>\n"},Br.softbreak=function(t,e,r){return r.breaks?r.xhtmlOut?"<br />\n":"<br>\n":"\n"},Br.text=function(t,e){return qr(t[e].content)},Br.html_block=function(t,e){return t[e].content},Br.html_inline=function(t,e){return t[e].content},Mr.prototype.renderAttrs=function(t){let e,r,o;if(!t.attrs)return"";for(o="",e=0,r=t.attrs.length;e<r;e++)o+=" "+qr(t.attrs[e][0])+'="'+qr(t.attrs[e][1])+'"';return o},Mr.prototype.renderToken=function(t,e,r){const o=t[e];let i="";if(o.hidden)return"";o.block&&-1!==o.nesting&&e&&t[e-1].hidden&&(i+="\n"),i+=(-1===o.nesting?"</":"<")+o.tag,i+=this.renderAttrs(o),0===o.nesting&&r.xhtmlOut&&(i+=" /");let n=!1;if(o.block&&(n=!0,1===o.nesting&&e+1<t.length)){const r=t[e+1];("inline"===r.type||r.hidden||-1===r.nesting&&r.tag===o.tag)&&(n=!1)}return i+=n?">\n":">",i},Mr.prototype.renderInline=function(t,e,r){let o="";const i=this.rules;for(let n=0,a=t.length;n<a;n++){const a=t[n].type;void 0!==i[a]?o+=i[a](t,n,e,r,this):o+=this.renderToken(t,n,e)}return o},Mr.prototype.renderInlineAsText=function(t,e,r){let o="";for(let i=0,n=t.length;i<n;i++)switch(t[i].type){case"text":case"html_inline":case"html_block":o+=t[i].content;break;case"image":o+=this.renderInlineAsText(t[i].children,e,r);break;case"softbreak":case"hardbreak":o+="\n"}return o},Mr.prototype.render=function(t,e,r){let o="";const i=this.rules;for(let n=0,a=t.length;n<a;n++){const a=t[n].type;"inline"===a?o+=this.renderInline(t[n].children,e,r):void 0!==i[a]?o+=i[a](t,n,e,r,this):o+=this.renderToken(t,n,e,r)}return o},Wr.prototype.v=function(t){for(let e=0;e<this.i.length;e++)if(this.i[e].name===t)return e;return-1},Wr.prototype.D=function(){const t=this,e=[""];t.i.forEach((function(t){t.enabled&&t.alt.forEach((function(t){e.indexOf(t)<0&&e.push(t)}))})),t.m={},e.forEach((function(e){t.m[e]=[],t.i.forEach((function(r){r.enabled&&(e&&r.alt.indexOf(e)<0||t.m[e].push(r.fn))}))}))},Wr.prototype.at=function(t,e,r){const o=this.v(t),i=r||{};if(-1===o)throw new Error("Parser rule not found: "+t);this.i[o].fn=e,this.i[o].alt=i.alt||[],this.m=null},Wr.prototype.before=function(t,e,r,o){const i=this.v(t),n=o||{};if(-1===i)throw new Error("Parser rule not found: "+t);this.i.splice(i,0,{name:e,enabled:!0,fn:r,alt:n.alt||[]}),this.m=null},Wr.prototype.after=function(t,e,r,o){const i=this.v(t),n=o||{};if(-1===i)throw new Error("Parser rule not found: "+t);this.i.splice(i+1,0,{name:e,enabled:!0,fn:r,alt:n.alt||[]}),this.m=null},Wr.prototype.push=function(t,e,r){const o=r||{};this.i.push({name:t,enabled:!0,fn:e,alt:o.alt||[]}),this.m=null},Wr.prototype.enable=function(t,e){Array.isArray(t)||(t=[t]);const r=[];return t.forEach((function(t){const o=this.v(t);if(o<0){if(e)return;throw new Error("Rules manager: invalid rule name "+t)}this.i[o].enabled=!0,r.push(t)}),this),this.m=null,r},Wr.prototype.enableOnly=function(t,e){Array.isArray(t)||(t=[t]),this.i.forEach((function(t){t.enabled=!1})),this.enable(t,e)},Wr.prototype.disable=function(t,e){Array.isArray(t)||(t=[t]);const r=[];return t.forEach((function(t){const o=this.v(t);if(o<0){if(e)return;throw new Error("Rules manager: invalid rule name "+t)}this.i[o].enabled=!1,r.push(t)}),this),this.m=null,r},Wr.prototype.getRules=function(t){return null===this.m&&this.D(),this.m[t]||[]},Zr.prototype.attrIndex=function(t){if(!this.attrs)return-1;const e=this.attrs;for(let r=0,o=e.length;r<o;r++)if(e[r][0]===t)return r;return-1},Zr.prototype.attrPush=function(t){this.attrs?this.attrs.push(t):this.attrs=[t]},Zr.prototype.attrSet=function(t,e){const r=this.attrIndex(t),o=[t,e];r<0?this.attrPush(o):this.attrs[r]=o},Zr.prototype.attrGet=function(t){const e=this.attrIndex(t);let r=null;return e>=0&&(r=this.attrs[e][1]),r},Zr.prototype.attrJoin=function(t,e){const r=this.attrIndex(t);r<0?this.attrPush([t,e]):this.attrs[r][1]=this.attrs[r][1]+" "+e},Lr.prototype.Token=Zr;const Nr=/\r\n?|\n/g,Hr=/\0/g;function Cr(t){return/^<\/a\s*>/i.test(t)}const Ir=/\+-|\.\.|\?\?\?\?|!!!!|,,|--/,Kr=/\((c|tm|r)\)/i,Jr=/\((c|tm|r)\)/gi,Ur={c:"©",r:"®",tm:"™"};function Tr(t,e){return Ur[e.toLowerCase()]}function Yr(t){let e=0;for(let r=t.length-1;r>=0;r--){const o=t[r];"text"!==o.type||e||(o.content=o.content.replace(Jr,Tr)),"link_open"===o.type&&"auto"===o.info&&e--,"link_close"===o.type&&"auto"===o.info&&e++}}function Qr(t){let e=0;for(let r=t.length-1;r>=0;r--){const o=t[r];"text"!==o.type||e||Ir.test(o.content)&&(o.content=o.content.replace(/\+-/g,"±").replace(/\.{2,}/g,"…").replace(/([?!])…/g,"$1..").replace(/([?!]){4,}/g,"$1$1$1").replace(/,{2,}/g,",").replace(/(^|[^-])---(?=[^-]|$)/gm,"$1—").replace(/(^|\s)--(?=\s|$)/gm,"$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm,"$1–")),"link_open"===o.type&&"auto"===o.info&&e--,"link_close"===o.type&&"auto"===o.info&&e++}}const $r=/['"]/,_r=/['"]/g;function to(t,e,r){return t.slice(0,e)+r+t.slice(e+1)}function eo(t,e){let r;const o=[];for(let i=0;i<t.length;i++){const n=t[i],a=t[i].level;for(r=o.length-1;r>=0&&!(o[r].level<=a);r--);if(o.length=r+1,"text"!==n.type)continue;let s=n.content,l=0,b=s.length;t:for(;l<b;){_r.lastIndex=l;const c=_r.exec(s);if(!c)break;let d=!0,f=!0;l=c.index+1;const p="'"===c[0];let m=32;if(c.index-1>=0)m=s.charCodeAt(c.index-1);else for(r=i-1;r>=0&&("softbreak"!==t[r].type&&"hardbreak"!==t[r].type);r--)if(t[r].content){m=t[r].content.charCodeAt(t[r].content.length-1);break}let u=32;if(l<b)u=s.charCodeAt(l);else for(r=i+1;r<t.length&&("softbreak"!==t[r].type&&"hardbreak"!==t[r].type);r++)if(t[r].content){u=t[r].content.charCodeAt(0);break}const g=Pr(m)||Xr(String.fromCharCode(m)),h=Pr(u)||Xr(String.fromCharCode(u)),v=Rr(m),x=Rr(u);if(x?d=!1:h&&(v||g||(d=!1)),v?f=!1:g&&(x||h||(f=!1)),34===u&&'"'===c[0]&&m>=48&&m<=57&&(f=d=!1),d&&f&&(d=g,f=h),d||f){if(f)for(r=o.length-1;r>=0;r--){let d=o[r];if(o[r].level<a)break;if(d.single===p&&o[r].level===a){let a,f;d=o[r],p?(a=e.md.options.quotes[2],f=e.md.options.quotes[3]):(a=e.md.options.quotes[0],f=e.md.options.quotes[1]),n.content=to(n.content,c.index,f),t[d.token].content=to(t[d.token].content,d.pos,a),l+=f.length-1,d.token===i&&(l+=a.length-1),s=n.content,b=s.length,o.length=r;continue t}}d?o.push({token:i,pos:c.index,single:p,level:a}):f&&p&&(n.content=to(n.content,c.index,"’"))}else p&&(n.content=to(n.content,c.index,"’"))}}}const ro=[["normalize",function(t){let e;e=t.src.replace(Nr,"\n"),e=e.replace(Hr,"�"),t.src=e}],["block",function(t){let e;t.inlineMode?(e=new t.Token("inline","",0),e.content=t.src,e.map=[0,1],e.children=[],t.tokens.push(e)):t.md.block.parse(t.src,t.md,t.env,t.tokens)}],["inline",function(t){const e=t.tokens;for(let r=0,o=e.length;r<o;r++){const o=e[r];"inline"===o.type&&t.md.inline.parse(o.content,t.md,t.env,o.children)}}],["linkify",function(t){const e=t.tokens;var r;if(t.md.options.linkify)for(let o=0,i=e.length;o<i;o++){if("inline"!==e[o].type||!t.md.linkify.pretest(e[o].content))continue;let i=e[o].children,n=0;for(let a=i.length-1;a>=0;a--){const s=i[a];if("link_close"!==s.type){if("html_inline"===s.type&&(r=s.content,/^<a[>\s]/i.test(r)&&n>0&&n--,Cr(s.content)&&n++),!(n>0)&&"text"===s.type&&t.md.linkify.test(s.content)){const r=s.content;let n=t.md.linkify.match(r);const l=[];let b=s.level,c=0;n.length>0&&0===n[0].index&&a>0&&"text_special"===i[a-1].type&&(n=n.slice(1));for(let e=0;e<n.length;e++){const o=n[e].url,i=t.md.normalizeLink(o);if(!t.md.validateLink(i))continue;let a=n[e].text;a=n[e].schema?"mailto:"!==n[e].schema||/^mailto:/i.test(a)?t.md.normalizeLinkText(a):t.md.normalizeLinkText("mailto:"+a).replace(/^mailto:/,""):t.md.normalizeLinkText("http://"+a).replace(/^http:\/\//,"");const s=n[e].index;if(s>c){const e=new t.Token("text","",0);e.content=r.slice(c,s),e.level=b,l.push(e)}const d=new t.Token("link_open","a",1);d.attrs=[["href",i]],d.level=b++,d.markup="linkify",d.info="auto",l.push(d);const f=new t.Token("text","",0);f.content=a,f.level=b,l.push(f);const p=new t.Token("link_close","a",-1);p.level=--b,p.markup="linkify",p.info="auto",l.push(p),c=n[e].lastIndex}if(c<r.length){const e=new t.Token("text","",0);e.content=r.slice(c),e.level=b,l.push(e)}e[o].children=i=gr(i,a,l)}}else for(a--;i[a].level!==s.level&&"link_open"!==i[a].type;)a--}}}],["replacements",function(t){let e;if(t.md.options.typographer)for(e=t.tokens.length-1;e>=0;e--)"inline"===t.tokens[e].type&&(Kr.test(t.tokens[e].content)&&Yr(t.tokens[e].children),Ir.test(t.tokens[e].content)&&Qr(t.tokens[e].children))}],["smartquotes",function(t){if(t.md.options.typographer)for(let e=t.tokens.length-1;e>=0;e--)"inline"===t.tokens[e].type&&$r.test(t.tokens[e].content)&&eo(t.tokens[e].children,t)}],["text_join",function(t){let e,r;const o=t.tokens,i=o.length;for(let t=0;t<i;t++){if("inline"!==o[t].type)continue;const i=o[t].children,n=i.length;for(e=0;e<n;e++)"text_special"===i[e].type&&(i[e].type="text");for(e=r=0;e<n;e++)"text"===i[e].type&&e+1<n&&"text"===i[e+1].type?i[e+1].content=i[e].content+i[e+1].content:(e!==r&&(i[r]=i[e]),r++);e!==r&&(i.length=r)}}]];function oo(){this.ruler=new Wr;for(let t=0;t<ro.length;t++)this.ruler.push(ro[t][0],ro[t][1])}function io(t,e,r,o){this.src=t,this.md=e,this.env=r,this.tokens=o,this.bMarks=[],this.eMarks=[],this.tShift=[],this.sCount=[],this.bsCount=[],this.blkIndent=0,this.line=0,this.lineMax=0,this.tight=!1,this.ddIndent=-1,this.listIndent=-1,this.parentType="root",this.level=0;const i=this.src;for(let t=0,e=0,r=0,o=0,n=i.length,a=!1;e<n;e++){const s=i.charCodeAt(e);if(!a){if(Er(s)){r++,9===s?o+=4-o%4:o++;continue}a=!0}10!==s&&e!==n-1||(10!==s&&e++,this.bMarks.push(t),this.eMarks.push(e),this.tShift.push(r),this.sCount.push(o),this.bsCount.push(0),a=!1,r=0,o=0,t=e+1)}this.bMarks.push(i.length),this.eMarks.push(i.length),this.tShift.push(0),this.sCount.push(0),this.bsCount.push(0),this.lineMax=this.bMarks.length-1}oo.prototype.process=function(t){const e=this.ruler.getRules("");for(let r=0,o=e.length;r<o;r++)e[r](t)},oo.prototype.State=Lr,io.prototype.push=function(t,e,r){const o=new Zr(t,e,r);return o.block=!0,r<0&&this.level--,o.level=this.level,r>0&&this.level++,this.tokens.push(o),o},io.prototype.isEmpty=function(t){return this.bMarks[t]+this.tShift[t]>=this.eMarks[t]},io.prototype.skipEmptyLines=function(t){for(let e=this.lineMax;t<e&&!(this.bMarks[t]+this.tShift[t]<this.eMarks[t]);t++);return t},io.prototype.skipSpaces=function(t){for(let e=this.src.length;t<e;t++){if(!Er(this.src.charCodeAt(t)))break}return t},io.prototype.skipSpacesBack=function(t,e){if(t<=e)return t;for(;t>e;)if(!Er(this.src.charCodeAt(--t)))return t+1;return t},io.prototype.skipChars=function(t,e){for(let r=this.src.length;t<r&&this.src.charCodeAt(t)===e;t++);return t},io.prototype.skipCharsBack=function(t,e,r){if(t<=r)return t;for(;t>r;)if(e!==this.src.charCodeAt(--t))return t+1;return t},io.prototype.getLines=function(t,e,r,o){if(t>=e)return"";const i=new Array(e-t);for(let n=0,a=t;a<e;a++,n++){let t=0;const s=this.bMarks[a];let l,b=s;for(l=a+1<e||o?this.eMarks[a]+1:this.eMarks[a];b<l&&t<r;){const e=this.src.charCodeAt(b);if(Er(e))9===e?t+=4-(t+this.bsCount[a])%4:t++;else{if(!(b-s<this.tShift[a]))break;t++}b++}i[n]=t>r?new Array(t-r+1).join(" ")+this.src.slice(b,l):this.src.slice(b,l)}return i.join("")},io.prototype.Token=Zr;function no(t,e){const r=t.bMarks[e]+t.tShift[e],o=t.eMarks[e];return t.src.slice(r,o)}function ao(t){const e=[],r=t.length;let o=0,i=t.charCodeAt(o),n=!1,a=0,s="";for(;o<r;)124===i&&(n?(s+=t.substring(a,o-1),a=o):(e.push(s+t.substring(a,o)),s="",a=o+1)),n=92===i,o++,i=t.charCodeAt(o);return e.push(s+t.substring(a)),e}function so(t,e){const r=t.eMarks[e];let o=t.bMarks[e]+t.tShift[e];const i=t.src.charCodeAt(o++);if(42!==i&&45!==i&&43!==i)return-1;if(o<r){if(!Er(t.src.charCodeAt(o)))return-1}return o}function lo(t,e){const r=t.bMarks[e]+t.tShift[e],o=t.eMarks[e];let i=r;if(i+1>=o)return-1;let n=t.src.charCodeAt(i++);if(n<48||n>57)return-1;for(;;){if(i>=o)return-1;if(n=t.src.charCodeAt(i++),!(n>=48&&n<=57)){if(41===n||46===n)break;return-1}if(i-r>=10)return-1}return i<o&&(n=t.src.charCodeAt(i),!Er(n))?-1:i}const bo="<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^\"'=<>`\\x00-\\x20]+|'[^']*'|\"[^\"]*\"))?)*\\s*\\/?>",co="<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",fo=new RegExp("^(?:"+bo+"|"+co+"|\x3c!---?>|\x3c!--(?:[^-]|-[^-]|--[^>])*--\x3e|<[?][\\s\\S]*?[?]>|<![A-Za-z][^>]*>|<!\\[CDATA\\[[\\s\\S]*?\\]\\]>)"),po=new RegExp("^(?:"+bo+"|"+co+")"),mo=[[/^<(script|pre|style|textarea)(?=(\s|>|$))/i,/<\/(script|pre|style|textarea)>/i,!0],[/^<!--/,/-->/,!0],[/^<\?/,/\?>/,!0],[/^<![A-Z]/,/>/,!0],[/^<!\[CDATA\[/,/\]\]>/,!0],[new RegExp("^</?("+["address","article","aside","base","basefont","blockquote","body","caption","center","col","colgroup","dd","details","dialog","dir","div","dl","dt","fieldset","figcaption","figure","footer","form","frame","frameset","h1","h2","h3","h4","h5","h6","head","header","hr","html","iframe","legend","li","link","main","menu","menuitem","nav","noframes","ol","optgroup","option","p","param","search","section","summary","table","tbody","td","tfoot","th","thead","title","tr","track","ul"].join("|")+")(?=(\\s|/?>|$))","i"),/^$/,!0],[new RegExp(po.source+"\\s*$"),/^$/,!1]];const uo=[["table",function(t,e,r,o){if(e+2>r)return!1;let i=e+1;if(t.sCount[i]<t.blkIndent)return!1;if(t.sCount[i]-t.blkIndent>=4)return!1;let n=t.bMarks[i]+t.tShift[i];if(n>=t.eMarks[i])return!1;const a=t.src.charCodeAt(n++);if(124!==a&&45!==a&&58!==a)return!1;if(n>=t.eMarks[i])return!1;const s=t.src.charCodeAt(n++);if(124!==s&&45!==s&&58!==s&&!Er(s))return!1;if(45===a&&Er(s))return!1;for(;n<t.eMarks[i];){const e=t.src.charCodeAt(n);if(124!==e&&45!==e&&58!==e&&!Er(e))return!1;n++}let l=no(t,e+1),b=l.split("|");const c=[];for(let t=0;t<b.length;t++){const e=b[t].trim();if(!e){if(0===t||t===b.length-1)continue;return!1}if(!/^:?-+:?$/.test(e))return!1;58===e.charCodeAt(e.length-1)?c.push(58===e.charCodeAt(0)?"center":"right"):58===e.charCodeAt(0)?c.push("left"):c.push("")}if(l=no(t,e).trim(),-1===l.indexOf("|"))return!1;if(t.sCount[e]-t.blkIndent>=4)return!1;b=ao(l),b.length&&""===b[0]&&b.shift(),b.length&&""===b[b.length-1]&&b.pop();const d=b.length;if(0===d||d!==c.length)return!1;if(o)return!0;const f=t.parentType;t.parentType="table";const p=t.md.block.ruler.getRules("blockquote"),m=[e,0];t.push("table_open","table",1).map=m,t.push("thead_open","thead",1).map=[e,e+1],t.push("tr_open","tr",1).map=[e,e+1];for(let e=0;e<b.length;e++){const r=t.push("th_open","th",1);c[e]&&(r.attrs=[["style","text-align:"+c[e]]]);const o=t.push("inline","",0);o.content=b[e].trim(),o.children=[],t.push("th_close","th",-1)}let u;t.push("tr_close","tr",-1),t.push("thead_close","thead",-1);let g=0;for(i=e+2;i<r&&!(t.sCount[i]<t.blkIndent);i++){let o=!1;for(let e=0,n=p.length;e<n;e++)if(p[e](t,i,r,!0)){o=!0;break}if(o)break;if(l=no(t,i).trim(),!l)break;if(t.sCount[i]-t.blkIndent>=4)break;if(b=ao(l),b.length&&""===b[0]&&b.shift(),b.length&&""===b[b.length-1]&&b.pop(),g+=d-b.length,g>65536)break;if(i===e+2){t.push("tbody_open","tbody",1).map=u=[e+2,0]}t.push("tr_open","tr",1).map=[i,i+1];for(let e=0;e<d;e++){const r=t.push("td_open","td",1);c[e]&&(r.attrs=[["style","text-align:"+c[e]]]);const o=t.push("inline","",0);o.content=b[e]?b[e].trim():"",o.children=[],t.push("td_close","td",-1)}t.push("tr_close","tr",-1)}return u&&(t.push("tbody_close","tbody",-1),u[1]=i),t.push("table_close","table",-1),m[1]=i,t.parentType=f,t.line=i,!0},["paragraph","reference"]],["code",function(t,e,r){if(t.sCount[e]-t.blkIndent<4)return!1;let o=e+1,i=o;for(;o<r;)if(t.isEmpty(o))o++;else{if(!(t.sCount[o]-t.blkIndent>=4))break;o++,i=o}t.line=i;const n=t.push("code_block","code",0);return n.content=t.getLines(e,i,4+t.blkIndent,!1)+"\n",n.map=[e,t.line],!0}],["fence",function(t,e,r,o){let i=t.bMarks[e]+t.tShift[e],n=t.eMarks[e];if(t.sCount[e]-t.blkIndent>=4)return!1;if(i+3>n)return!1;const a=t.src.charCodeAt(i);if(126!==a&&96!==a)return!1;let s=i;i=t.skipChars(i,a);let l=i-s;if(l<3)return!1;const b=t.src.slice(s,i),c=t.src.slice(i,n);if(96===a&&c.indexOf(String.fromCharCode(a))>=0)return!1;if(o)return!0;let d=e,f=!1;for(;(d++,!(d>=r))&&(i=s=t.bMarks[d]+t.tShift[d],n=t.eMarks[d],!(i<n&&t.sCount[d]<t.blkIndent));)if(t.src.charCodeAt(i)===a&&!(t.sCount[d]-t.blkIndent>=4||(i=t.skipChars(i,a),i-s<l||(i=t.skipSpaces(i),i<n)))){f=!0;break}l=t.sCount[e],t.line=d+(f?1:0);const p=t.push("fence","code",0);return p.info=c,p.content=t.getLines(e+1,d,l,!0),p.markup=b,p.map=[e,t.line],!0},["paragraph","reference","blockquote","list"]],["blockquote",function(t,e,r,o){let i=t.bMarks[e]+t.tShift[e],n=t.eMarks[e];const a=t.lineMax;if(t.sCount[e]-t.blkIndent>=4)return!1;if(62!==t.src.charCodeAt(i))return!1;if(o)return!0;const s=[],l=[],b=[],c=[],d=t.md.block.ruler.getRules("blockquote"),f=t.parentType;t.parentType="blockquote";let p,m=!1;for(p=e;p<r;p++){const e=t.sCount[p]<t.blkIndent;if(i=t.bMarks[p]+t.tShift[p],n=t.eMarks[p],i>=n)break;if(62===t.src.charCodeAt(i++)&&!e){let e,r,o=t.sCount[p]+1;32===t.src.charCodeAt(i)?(i++,o++,r=!1,e=!0):9===t.src.charCodeAt(i)?(e=!0,(t.bsCount[p]+o)%4==3?(i++,o++,r=!1):r=!0):e=!1;let a=o;for(s.push(t.bMarks[p]),t.bMarks[p]=i;i<n;){const e=t.src.charCodeAt(i);if(!Er(e))break;9===e?a+=4-(a+t.bsCount[p]+(r?1:0))%4:a++,i++}m=i>=n,l.push(t.bsCount[p]),t.bsCount[p]=t.sCount[p]+1+(e?1:0),b.push(t.sCount[p]),t.sCount[p]=a-o,c.push(t.tShift[p]),t.tShift[p]=i-t.bMarks[p];continue}if(m)break;let o=!1;for(let e=0,i=d.length;e<i;e++)if(d[e](t,p,r,!0)){o=!0;break}if(o){t.lineMax=p,0!==t.blkIndent&&(s.push(t.bMarks[p]),l.push(t.bsCount[p]),c.push(t.tShift[p]),b.push(t.sCount[p]),t.sCount[p]-=t.blkIndent);break}s.push(t.bMarks[p]),l.push(t.bsCount[p]),c.push(t.tShift[p]),b.push(t.sCount[p]),t.sCount[p]=-1}const u=t.blkIndent;t.blkIndent=0;const g=t.push("blockquote_open","blockquote",1);g.markup=">";const h=[e,0];g.map=h,t.md.block.tokenize(t,e,p),t.push("blockquote_close","blockquote",-1).markup=">",t.lineMax=a,t.parentType=f,h[1]=t.line;for(let r=0;r<c.length;r++)t.bMarks[r+e]=s[r],t.tShift[r+e]=c[r],t.sCount[r+e]=b[r],t.bsCount[r+e]=l[r];return t.blkIndent=u,!0},["paragraph","reference","blockquote","list"]],["hr",function(t,e,r,o){const i=t.eMarks[e];if(t.sCount[e]-t.blkIndent>=4)return!1;let n=t.bMarks[e]+t.tShift[e];const a=t.src.charCodeAt(n++);if(42!==a&&45!==a&&95!==a)return!1;let s=1;for(;n<i;){const e=t.src.charCodeAt(n++);if(e!==a&&!Er(e))return!1;e===a&&s++}if(s<3)return!1;if(o)return!0;t.line=e+1;const l=t.push("hr","hr",0);return l.map=[e,t.line],l.markup=Array(s+1).join(String.fromCharCode(a)),!0},["paragraph","reference","blockquote","list"]],["list",function(t,e,r,o){let i,n,a,s,l=e,b=!0;if(t.sCount[l]-t.blkIndent>=4)return!1;if(t.listIndent>=0&&t.sCount[l]-t.listIndent>=4&&t.sCount[l]<t.blkIndent)return!1;let c,d,f,p=!1;if(o&&"paragraph"===t.parentType&&t.sCount[l]>=t.blkIndent&&(p=!0),(f=lo(t,l))>=0){if(c=!0,a=t.bMarks[l]+t.tShift[l],d=Number(t.src.slice(a,f-1)),p&&1!==d)return!1}else{if(!((f=so(t,l))>=0))return!1;c=!1}if(p&&t.skipSpaces(f)>=t.eMarks[l])return!1;if(o)return!0;const m=t.src.charCodeAt(f-1),u=t.tokens.length;c?(s=t.push("ordered_list_open","ol",1),1!==d&&(s.attrs=[["start",d]])):s=t.push("bullet_list_open","ul",1);const g=[l,0];s.map=g,s.markup=String.fromCharCode(m);let h=!1;const v=t.md.block.ruler.getRules("list"),x=t.parentType;for(t.parentType="list";l<r;){n=f,i=t.eMarks[l];const e=t.sCount[l]+f-(t.bMarks[l]+t.tShift[l]);let o=e;for(;n<i;){const e=t.src.charCodeAt(n);if(9===e)o+=4-(o+t.bsCount[l])%4;else{if(32!==e)break;o++}n++}const d=n;let p;p=d>=i?1:o-e,p>4&&(p=1);const u=e+p;s=t.push("list_item_open","li",1),s.markup=String.fromCharCode(m);const g=[l,0];s.map=g,c&&(s.info=t.src.slice(a,f-1));const x=t.tight,w=t.tShift[l],y=t.sCount[l],k=t.listIndent;if(t.listIndent=t.blkIndent,t.blkIndent=u,t.tight=!0,t.tShift[l]=d-t.bMarks[l],t.sCount[l]=o,d>=i&&t.isEmpty(l+1)?t.line=Math.min(t.line+2,r):t.md.block.tokenize(t,l,r,!0),t.tight&&!h||(b=!1),h=t.line-l>1&&t.isEmpty(t.line-1),t.blkIndent=t.listIndent,t.listIndent=k,t.tShift[l]=w,t.sCount[l]=y,t.tight=x,s=t.push("list_item_close","li",-1),s.markup=String.fromCharCode(m),l=t.line,g[1]=l,l>=r)break;if(t.sCount[l]<t.blkIndent)break;if(t.sCount[l]-t.blkIndent>=4)break;let D=!1;for(let e=0,o=v.length;e<o;e++)if(v[e](t,l,r,!0)){D=!0;break}if(D)break;if(c){if(f=lo(t,l),f<0)break;a=t.bMarks[l]+t.tShift[l]}else if(f=so(t,l),f<0)break;if(m!==t.src.charCodeAt(f-1))break}return s=c?t.push("ordered_list_close","ol",-1):t.push("bullet_list_close","ul",-1),s.markup=String.fromCharCode(m),g[1]=l,t.line=l,t.parentType=x,b&&function(t,e){const r=t.level+2;for(let o=e+2,i=t.tokens.length-2;o<i;o++)t.tokens[o].level===r&&"paragraph_open"===t.tokens[o].type&&(t.tokens[o+2].hidden=!0,t.tokens[o].hidden=!0,o+=2)}(t,u),!0},["paragraph","reference","blockquote"]],["reference",function(t,e,r,o){let i=t.bMarks[e]+t.tShift[e],n=t.eMarks[e],a=e+1;if(t.sCount[e]-t.blkIndent>=4)return!1;if(91!==t.src.charCodeAt(i))return!1;function s(e){const r=t.lineMax;if(e>=r||t.isEmpty(e))return null;let o=!1;if(t.sCount[e]-t.blkIndent>3&&(o=!0),t.sCount[e]<0&&(o=!0),!o){const o=t.md.block.ruler.getRules("reference"),i=t.parentType;t.parentType="reference";let n=!1;for(let i=0,a=o.length;i<a;i++)if(o[i](t,e,r,!0)){n=!0;break}if(t.parentType=i,n)return null}const i=t.bMarks[e]+t.tShift[e],n=t.eMarks[e];return t.src.slice(i,n+1)}let l=t.src.slice(i,n+1);n=l.length;let b=-1;for(i=1;i<n;i++){const t=l.charCodeAt(i);if(91===t)return!1;if(93===t){b=i;break}if(10===t){const t=s(a);null!==t&&(l+=t,n=l.length,a++)}else if(92===t&&(i++,i<n&&10===l.charCodeAt(i))){const t=s(a);null!==t&&(l+=t,n=l.length,a++)}}if(b<0||58!==l.charCodeAt(b+1))return!1;for(i=b+2;i<n;i++){const t=l.charCodeAt(i);if(10===t){const t=s(a);null!==t&&(l+=t,n=l.length,a++)}else if(!Er(t))break}const c=t.md.helpers.parseLinkDestination(l,i,n);if(!c.ok)return!1;const d=t.md.normalizeLink(c.str);if(!t.md.validateLink(d))return!1;i=c.pos;const f=i,p=a,m=i;for(;i<n;i++){const t=l.charCodeAt(i);if(10===t){const t=s(a);null!==t&&(l+=t,n=l.length,a++)}else if(!Er(t))break}let u,g=t.md.helpers.parseLinkTitle(l,i,n);for(;g.can_continue;){const e=s(a);if(null===e)break;l+=e,i=n,n=l.length,a++,g=t.md.helpers.parseLinkTitle(l,i,n,g)}for(i<n&&m!==i&&g.ok?(u=g.str,i=g.pos):(u="",i=f,a=p);i<n;){if(!Er(l.charCodeAt(i)))break;i++}if(i<n&&10!==l.charCodeAt(i)&&u)for(u="",i=f,a=p;i<n;){if(!Er(l.charCodeAt(i)))break;i++}if(i<n&&10!==l.charCodeAt(i))return!1;const h=Gr(l.slice(1,b));return!!h&&(o||(void 0===t.env.references&&(t.env.references={}),void 0===t.env.references[h]&&(t.env.references[h]={title:u,href:d}),t.line=a),!0)}],["html_block",function(t,e,r,o){let i=t.bMarks[e]+t.tShift[e],n=t.eMarks[e];if(t.sCount[e]-t.blkIndent>=4)return!1;if(!t.md.options.html)return!1;if(60!==t.src.charCodeAt(i))return!1;let a=t.src.slice(i,n),s=0;for(;s<mo.length&&!mo[s][0].test(a);s++);if(s===mo.length)return!1;if(o)return mo[s][2];let l=e+1;if(!mo[s][1].test(a))for(;l<r&&!(t.sCount[l]<t.blkIndent);l++)if(i=t.bMarks[l]+t.tShift[l],n=t.eMarks[l],a=t.src.slice(i,n),mo[s][1].test(a)){0!==a.length&&l++;break}t.line=l;const b=t.push("html_block","",0);return b.map=[e,l],b.content=t.getLines(e,l,t.blkIndent,!0),!0},["paragraph","reference","blockquote"]],["heading",function(t,e,r,o){let i=t.bMarks[e]+t.tShift[e],n=t.eMarks[e];if(t.sCount[e]-t.blkIndent>=4)return!1;let a=t.src.charCodeAt(i);if(35!==a||i>=n)return!1;let s=1;for(a=t.src.charCodeAt(++i);35===a&&i<n&&s<=6;)s++,a=t.src.charCodeAt(++i);if(s>6||i<n&&!Er(a))return!1;if(o)return!0;n=t.skipSpacesBack(n,i);const l=t.skipCharsBack(n,35,i);l>i&&Er(t.src.charCodeAt(l-1))&&(n=l),t.line=e+1;const b=t.push("heading_open","h"+String(s),1);b.markup="########".slice(0,s),b.map=[e,t.line];const c=t.push("inline","",0);return c.content=t.src.slice(i,n).trim(),c.map=[e,t.line],c.children=[],t.push("heading_close","h"+String(s),-1).markup="########".slice(0,s),!0},["paragraph","reference","blockquote"]],["lheading",function(t,e,r){const o=t.md.block.ruler.getRules("paragraph");if(t.sCount[e]-t.blkIndent>=4)return!1;const i=t.parentType;t.parentType="paragraph";let n,a=0,s=e+1;for(;s<r&&!t.isEmpty(s);s++){if(t.sCount[s]-t.blkIndent>3)continue;if(t.sCount[s]>=t.blkIndent){let e=t.bMarks[s]+t.tShift[s];const r=t.eMarks[s];if(e<r&&(n=t.src.charCodeAt(e),(45===n||61===n)&&(e=t.skipChars(e,n),e=t.skipSpaces(e),e>=r))){a=61===n?1:2;break}}if(t.sCount[s]<0)continue;let e=!1;for(let i=0,n=o.length;i<n;i++)if(o[i](t,s,r,!0)){e=!0;break}if(e)break}if(!a)return!1;const l=t.getLines(e,s,t.blkIndent,!1).trim();t.line=s+1;const b=t.push("heading_open","h"+String(a),1);b.markup=String.fromCharCode(n),b.map=[e,t.line];const c=t.push("inline","",0);return c.content=l,c.map=[e,t.line-1],c.children=[],t.push("heading_close","h"+String(a),-1).markup=String.fromCharCode(n),t.parentType=i,!0}],["paragraph",function(t,e,r){const o=t.md.block.ruler.getRules("paragraph"),i=t.parentType;let n=e+1;for(t.parentType="paragraph";n<r&&!t.isEmpty(n);n++){if(t.sCount[n]-t.blkIndent>3)continue;if(t.sCount[n]<0)continue;let e=!1;for(let i=0,a=o.length;i<a;i++)if(o[i](t,n,r,!0)){e=!0;break}if(e)break}const a=t.getLines(e,n,t.blkIndent,!1).trim();t.line=n,t.push("paragraph_open","p",1).map=[e,t.line];const s=t.push("inline","",0);return s.content=a,s.map=[e,t.line],s.children=[],t.push("paragraph_close","p",-1),t.parentType=i,!0}]];function go(){this.ruler=new Wr;for(let t=0;t<uo.length;t++)this.ruler.push(uo[t][0],uo[t][1],{alt:(uo[t][2]||[]).slice()})}function ho(t,e,r,o){this.src=t,this.env=r,this.md=e,this.tokens=o,this.tokens_meta=Array(o.length),this.pos=0,this.posMax=this.src.length,this.level=0,this.pending="",this.pendingLevel=0,this.cache={},this.delimiters=[],this._prev_delimiters=[],this.backticks={},this.backticksScanned=!1,this.linkLevel=0}function vo(t){switch(t){case 10:case 33:case 35:case 36:case 37:case 38:case 42:case 43:case 45:case 58:case 60:case 61:case 62:case 64:case 91:case 92:case 93:case 94:case 95:case 96:case 123:case 125:case 126:return!0;default:return!1}}go.prototype.tokenize=function(t,e,r){const o=this.ruler.getRules(""),i=o.length,n=t.md.options.maxNesting;let a=e,s=!1;for(;a<r&&(t.line=a=t.skipEmptyLines(a),!(a>=r))&&!(t.sCount[a]<t.blkIndent);){if(t.level>=n){t.line=r;break}const e=t.line;let l=!1;for(let n=0;n<i;n++)if(l=o[n](t,a,r,!1),l){if(e>=t.line)throw new Error("block rule didn't increment state.line");break}if(!l)throw new Error("none of the block rules matched");t.tight=!s,t.isEmpty(t.line-1)&&(s=!0),a=t.line,a<r&&t.isEmpty(a)&&(s=!0,a++,t.line=a)}},go.prototype.parse=function(t,e,r,o){if(!t)return;const i=new this.State(t,e,r,o);this.tokenize(i,i.line,i.lineMax)},go.prototype.State=io,ho.prototype.pushPending=function(){const t=new Zr("text","",0);return t.content=this.pending,t.level=this.pendingLevel,this.tokens.push(t),this.pending="",t},ho.prototype.push=function(t,e,r){this.pending&&this.pushPending();const o=new Zr(t,e,r);let i=null;return r<0&&(this.level--,this.delimiters=this._prev_delimiters.pop()),o.level=this.level,r>0&&(this.level++,this._prev_delimiters.push(this.delimiters),this.delimiters=[],i={delimiters:this.delimiters}),this.pendingLevel=this.level,this.tokens.push(o),this.tokens_meta.push(i),o},ho.prototype.scanDelims=function(t,e){const r=this.posMax,o=this.src.charCodeAt(t),i=t>0?this.src.charCodeAt(t-1):32;let n=t;for(;n<r&&this.src.charCodeAt(n)===o;)n++;const a=n-t,s=n<r?this.src.charCodeAt(n):32,l=Pr(i)||Xr(String.fromCharCode(i)),b=Pr(s)||Xr(String.fromCharCode(s)),c=Rr(i),d=Rr(s),f=!d&&(!b||c||l),p=!c&&(!l||d||b);return{can_open:f&&(e||!p||l),can_close:p&&(e||!f||b),length:a}},ho.prototype.Token=Zr;const xo=/(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;const wo=[];for(let t=0;t<256;t++)wo.push(0);function yo(t,e){let r;const o=[],i=e.length;for(let n=0;n<i;n++){const i=e[n];if(126!==i.marker)continue;if(-1===i.end)continue;const a=e[i.end];r=t.tokens[i.token],r.type="s_open",r.tag="s",r.nesting=1,r.markup="~~",r.content="",r=t.tokens[a.token],r.type="s_close",r.tag="s",r.nesting=-1,r.markup="~~",r.content="","text"===t.tokens[a.token-1].type&&"~"===t.tokens[a.token-1].content&&o.push(a.token-1)}for(;o.length;){const e=o.pop();let i=e+1;for(;i<t.tokens.length&&"s_close"===t.tokens[i].type;)i++;i--,e!==i&&(r=t.tokens[i],t.tokens[i]=t.tokens[e],t.tokens[e]=r)}}"\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach((function(t){wo[t.charCodeAt(0)]=1}));var ko={tokenize:function(t,e){const r=t.pos,o=t.src.charCodeAt(r);if(e)return!1;if(126!==o)return!1;const i=t.scanDelims(t.pos,!0);let n=i.length;const a=String.fromCharCode(o);if(n<2)return!1;let s;n%2&&(s=t.push("text","",0),s.content=a,n--);for(let e=0;e<n;e+=2)s=t.push("text","",0),s.content=a+a,t.delimiters.push({marker:o,length:0,token:t.tokens.length-1,end:-1,open:i.can_open,close:i.can_close});return t.pos+=i.length,!0},postProcess:function(t){const e=t.tokens_meta,r=t.tokens_meta.length;yo(t,t.delimiters);for(let o=0;o<r;o++)e[o]&&e[o].delimiters&&yo(t,e[o].delimiters)}};function Do(t,e){for(let r=e.length-1;r>=0;r--){const o=e[r];if(95!==o.marker&&42!==o.marker)continue;if(-1===o.end)continue;const i=e[o.end],n=r>0&&e[r-1].end===o.end+1&&e[r-1].marker===o.marker&&e[r-1].token===o.token-1&&e[o.end+1].token===i.token+1,a=String.fromCharCode(o.marker),s=t.tokens[o.token];s.type=n?"strong_open":"em_open",s.tag=n?"strong":"em",s.nesting=1,s.markup=n?a+a:a,s.content="";const l=t.tokens[i.token];l.type=n?"strong_close":"em_close",l.tag=n?"strong":"em",l.nesting=-1,l.markup=n?a+a:a,l.content="",n&&(t.tokens[e[r-1].token].content="",t.tokens[e[o.end+1].token].content="",r--)}}var zo={tokenize:function(t,e){const r=t.pos,o=t.src.charCodeAt(r);if(e)return!1;if(95!==o&&42!==o)return!1;const i=t.scanDelims(t.pos,42===o);for(let e=0;e<i.length;e++){t.push("text","",0).content=String.fromCharCode(o),t.delimiters.push({marker:o,length:i.length,token:t.tokens.length-1,end:-1,open:i.can_open,close:i.can_close})}return t.pos+=i.length,!0},postProcess:function(t){const e=t.tokens_meta,r=t.tokens_meta.length;Do(t,t.delimiters);for(let o=0;o<r;o++)e[o]&&e[o].delimiters&&Do(t,e[o].delimiters)}};const Fo=/^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,Ao=/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;const qo=/^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,jo=/^&([a-z][a-z0-9]{1,31});/i;function Eo(t){const e={},r=t.length;if(!r)return;let o=0,i=-2;const n=[];for(let a=0;a<r;a++){const r=t[a];if(n.push(0),t[o].marker===r.marker&&i===r.token-1||(o=a),i=r.token,r.length=r.length||0,!r.close)continue;e.hasOwnProperty(r.marker)||(e[r.marker]=[-1,-1,-1,-1,-1,-1]);const s=e[r.marker][(r.open?3:0)+r.length%3];let l=o-n[o]-1,b=l;for(;l>s;l-=n[l]+1){const e=t[l];if(e.marker===r.marker&&(e.open&&e.end<0)){let o=!1;if((e.close||r.open)&&(e.length+r.length)%3==0&&(e.length%3==0&&r.length%3==0||(o=!0)),!o){const o=l>0&&!t[l-1].open?n[l-1]+1:0;n[a]=a-l+o,n[l]=o,r.open=!1,e.end=a,e.close=!1,b=-1,i=-2;break}}}-1!==b&&(e[r.marker][(r.open?3:0)+(r.length||0)%3]=b)}}const Ro=[["text",function(t,e){let r=t.pos;for(;r<t.posMax&&!vo(t.src.charCodeAt(r));)r++;return r!==t.pos&&(e||(t.pending+=t.src.slice(t.pos,r)),t.pos=r,!0)}],["linkify",function(t,e){if(!t.md.options.linkify)return!1;if(t.linkLevel>0)return!1;const r=t.pos;if(r+3>t.posMax)return!1;if(58!==t.src.charCodeAt(r))return!1;if(47!==t.src.charCodeAt(r+1))return!1;if(47!==t.src.charCodeAt(r+2))return!1;const o=t.pending.match(xo);if(!o)return!1;const i=o[1],n=t.md.linkify.matchAtStart(t.src.slice(r-i.length));if(!n)return!1;let a=n.url;if(a.length<=i.length)return!1;a=a.replace(/\*+$/,"");const s=t.md.normalizeLink(a);if(!t.md.validateLink(s))return!1;if(!e){t.pending=t.pending.slice(0,-i.length);const e=t.push("link_open","a",1);e.attrs=[["href",s]],e.markup="linkify",e.info="auto";t.push("text","",0).content=t.md.normalizeLinkText(a);const r=t.push("link_close","a",-1);r.markup="linkify",r.info="auto"}return t.pos+=a.length-i.length,!0}],["newline",function(t,e){let r=t.pos;if(10!==t.src.charCodeAt(r))return!1;const o=t.pending.length-1,i=t.posMax;if(!e)if(o>=0&&32===t.pending.charCodeAt(o))if(o>=1&&32===t.pending.charCodeAt(o-1)){let e=o-1;for(;e>=1&&32===t.pending.charCodeAt(e-1);)e--;t.pending=t.pending.slice(0,e),t.push("hardbreak","br",0)}else t.pending=t.pending.slice(0,-1),t.push("softbreak","br",0);else t.push("softbreak","br",0);for(r++;r<i&&Er(t.src.charCodeAt(r));)r++;return t.pos=r,!0}],["escape",function(t,e){let r=t.pos;const o=t.posMax;if(92!==t.src.charCodeAt(r))return!1;if(r++,r>=o)return!1;let i=t.src.charCodeAt(r);if(10===i){for(e||t.push("hardbreak","br",0),r++;r<o&&(i=t.src.charCodeAt(r),Er(i));)r++;return t.pos=r,!0}let n=t.src[r];if(i>=55296&&i<=56319&&r+1<o){const e=t.src.charCodeAt(r+1);e>=56320&&e<=57343&&(n+=t.src[r+1],r++)}const a="\\"+n;if(!e){const e=t.push("text_special","",0);i<256&&0!==wo[i]?e.content=n:e.content=a,e.markup=a,e.info="escape"}return t.pos=r+1,!0}],["backticks",function(t,e){let r=t.pos;if(96!==t.src.charCodeAt(r))return!1;const o=r;r++;const i=t.posMax;for(;r<i&&96===t.src.charCodeAt(r);)r++;const n=t.src.slice(o,r),a=n.length;if(t.backticksScanned&&(t.backticks[a]||0)<=o)return e||(t.pending+=n),t.pos+=a,!0;let s,l=r;for(;-1!==(s=t.src.indexOf("`",l));){for(l=s+1;l<i&&96===t.src.charCodeAt(l);)l++;const o=l-s;if(o===a){if(!e){const e=t.push("code_inline","code",0);e.markup=n,e.content=t.src.slice(r,s).replace(/\n/g," ").replace(/^ (.+) $/,"$1")}return t.pos=l,!0}t.backticks[o]=s}return t.backticksScanned=!0,e||(t.pending+=n),t.pos+=a,!0}],["strikethrough",ko.tokenize],["emphasis",zo.tokenize],["link",function(t,e){let r,o,i,n,a="",s="",l=t.pos,b=!0;if(91!==t.src.charCodeAt(t.pos))return!1;const c=t.pos,d=t.posMax,f=t.pos+1,p=t.md.helpers.parseLinkLabel(t,t.pos,!0);if(p<0)return!1;let m=p+1;if(m<d&&40===t.src.charCodeAt(m)){for(b=!1,m++;m<d&&(r=t.src.charCodeAt(m),Er(r)||10===r);m++);if(m>=d)return!1;if(l=m,i=t.md.helpers.parseLinkDestination(t.src,m,t.posMax),i.ok){for(a=t.md.normalizeLink(i.str),t.md.validateLink(a)?m=i.pos:a="",l=m;m<d&&(r=t.src.charCodeAt(m),Er(r)||10===r);m++);if(i=t.md.helpers.parseLinkTitle(t.src,m,t.posMax),m<d&&l!==m&&i.ok)for(s=i.str,m=i.pos;m<d&&(r=t.src.charCodeAt(m),Er(r)||10===r);m++);}(m>=d||41!==t.src.charCodeAt(m))&&(b=!0),m++}if(b){if(void 0===t.env.references)return!1;if(m<d&&91===t.src.charCodeAt(m)?(l=m+1,m=t.md.helpers.parseLinkLabel(t,m),m>=0?o=t.src.slice(l,m++):m=p+1):m=p+1,o||(o=t.src.slice(f,p)),n=t.env.references[Gr(o)],!n)return t.pos=c,!1;a=n.href,s=n.title}if(!e){t.pos=f,t.posMax=p;const e=[["href",a]];t.push("link_open","a",1).attrs=e,s&&e.push(["title",s]),t.linkLevel++,t.md.inline.tokenize(t),t.linkLevel--,t.push("link_close","a",-1)}return t.pos=m,t.posMax=d,!0}],["image",function(t,e){let r,o,i,n,a,s,l,b,c="";const d=t.pos,f=t.posMax;if(33!==t.src.charCodeAt(t.pos))return!1;if(91!==t.src.charCodeAt(t.pos+1))return!1;const p=t.pos+2,m=t.md.helpers.parseLinkLabel(t,t.pos+1,!1);if(m<0)return!1;if(n=m+1,n<f&&40===t.src.charCodeAt(n)){for(n++;n<f&&(r=t.src.charCodeAt(n),Er(r)||10===r);n++);if(n>=f)return!1;for(b=n,s=t.md.helpers.parseLinkDestination(t.src,n,t.posMax),s.ok&&(c=t.md.normalizeLink(s.str),t.md.validateLink(c)?n=s.pos:c=""),b=n;n<f&&(r=t.src.charCodeAt(n),Er(r)||10===r);n++);if(s=t.md.helpers.parseLinkTitle(t.src,n,t.posMax),n<f&&b!==n&&s.ok)for(l=s.str,n=s.pos;n<f&&(r=t.src.charCodeAt(n),Er(r)||10===r);n++);else l="";if(n>=f||41!==t.src.charCodeAt(n))return t.pos=d,!1;n++}else{if(void 0===t.env.references)return!1;if(n<f&&91===t.src.charCodeAt(n)?(b=n+1,n=t.md.helpers.parseLinkLabel(t,n),n>=0?i=t.src.slice(b,n++):n=m+1):n=m+1,i||(i=t.src.slice(p,m)),a=t.env.references[Gr(i)],!a)return t.pos=d,!1;c=a.href,l=a.title}if(!e){o=t.src.slice(p,m);const e=[];t.md.inline.parse(o,t.md,t.env,e);const r=t.push("image","img",0),i=[["src",c],["alt",""]];r.attrs=i,r.children=e,r.content=o,l&&i.push(["title",l])}return t.pos=n,t.posMax=f,!0}],["autolink",function(t,e){let r=t.pos;if(60!==t.src.charCodeAt(r))return!1;const o=t.pos,i=t.posMax;for(;;){if(++r>=i)return!1;const e=t.src.charCodeAt(r);if(60===e)return!1;if(62===e)break}const n=t.src.slice(o+1,r);if(Ao.test(n)){const r=t.md.normalizeLink(n);if(!t.md.validateLink(r))return!1;if(!e){const e=t.push("link_open","a",1);e.attrs=[["href",r]],e.markup="autolink",e.info="auto";t.push("text","",0).content=t.md.normalizeLinkText(n);const o=t.push("link_close","a",-1);o.markup="autolink",o.info="auto"}return t.pos+=n.length+2,!0}if(Fo.test(n)){const r=t.md.normalizeLink("mailto:"+n);if(!t.md.validateLink(r))return!1;if(!e){const e=t.push("link_open","a",1);e.attrs=[["href",r]],e.markup="autolink",e.info="auto";t.push("text","",0).content=t.md.normalizeLinkText(n);const o=t.push("link_close","a",-1);o.markup="autolink",o.info="auto"}return t.pos+=n.length+2,!0}return!1}],["html_inline",function(t,e){if(!t.md.options.html)return!1;const r=t.posMax,o=t.pos;if(60!==t.src.charCodeAt(o)||o+2>=r)return!1;const i=t.src.charCodeAt(o+1);if(33!==i&&63!==i&&47!==i&&!function(t){const e=32|t;return e>=97&&e<=122}(i))return!1;const n=t.src.slice(o).match(fo);if(!n)return!1;if(!e){const e=t.push("html_inline","",0);e.content=n[0],a=e.content,/^<a[>\s]/i.test(a)&&t.linkLevel++,function(t){return/^<\/a\s*>/i.test(t)}(e.content)&&t.linkLevel--}var a;return t.pos+=n[0].length,!0}],["entity",function(t,e){const r=t.pos,o=t.posMax;if(38!==t.src.charCodeAt(r))return!1;if(r+1>=o)return!1;if(35===t.src.charCodeAt(r+1)){const o=t.src.slice(r).match(qo);if(o){if(!e){const e="x"===o[1][0].toLowerCase()?parseInt(o[1].slice(1),16):parseInt(o[1],10),r=t.push("text_special","",0);r.content=hr(e)?vr(e):vr(65533),r.markup=o[0],r.info="entity"}return t.pos+=o[0].length,!0}}else{const o=t.src.slice(r).match(jo);if(o){const r=fr(o[0]);if(r!==o[0]){if(!e){const e=t.push("text_special","",0);e.content=r,e.markup=o[0],e.info="entity"}return t.pos+=o[0].length,!0}}}return!1}]],Xo=[["balance_pairs",function(t){const e=t.tokens_meta,r=t.tokens_meta.length;Eo(t.delimiters);for(let t=0;t<r;t++)e[t]&&e[t].delimiters&&Eo(e[t].delimiters)}],["strikethrough",ko.postProcess],["emphasis",zo.postProcess],["fragments_join",function(t){let e,r,o=0;const i=t.tokens,n=t.tokens.length;for(e=r=0;e<n;e++)i[e].nesting<0&&o--,i[e].level=o,i[e].nesting>0&&o++,"text"===i[e].type&&e+1<n&&"text"===i[e+1].type?i[e+1].content=i[e].content+i[e+1].content:(e!==r&&(i[r]=i[e]),r++);e!==r&&(i.length=r)}]];function Po(){this.ruler=new Wr;for(let t=0;t<Ro.length;t++)this.ruler.push(Ro[t][0],Ro[t][1]);this.ruler2=new Wr;for(let t=0;t<Xo.length;t++)this.ruler2.push(Xo[t][0],Xo[t][1])}function Go(t){return Array.prototype.slice.call(arguments,1).forEach((function(e){e&&Object.keys(e).forEach((function(r){t[r]=e[r]}))})),t}function Vo(t){return Object.prototype.toString.call(t)}function So(t){return"[object Function]"===Vo(t)}function Oo(t){return t.replace(/[.?*+^$[\]\\(){}|-]/g,"\\$&")}Po.prototype.skipToken=function(t){const e=t.pos,r=this.ruler.getRules(""),o=r.length,i=t.md.options.maxNesting,n=t.cache;if(void 0!==n[e])return void(t.pos=n[e]);let a=!1;if(t.level<i){for(let i=0;i<o;i++)if(t.level++,a=r[i](t,!0),t.level--,a){if(e>=t.pos)throw new Error("inline rule didn't increment state.pos");break}}else t.pos=t.posMax;a||t.pos++,n[e]=t.pos},Po.prototype.tokenize=function(t){const e=this.ruler.getRules(""),r=e.length,o=t.posMax,i=t.md.options.maxNesting;for(;t.pos<o;){const n=t.pos;let a=!1;if(t.level<i)for(let o=0;o<r;o++)if(a=e[o](t,!1),a){if(n>=t.pos)throw new Error("inline rule didn't increment state.pos");break}if(a){if(t.pos>=o)break}else t.pending+=t.src[t.pos++]}t.pending&&t.pushPending()},Po.prototype.parse=function(t,e,r,o){const i=new this.State(t,e,r,o);this.tokenize(i);const n=this.ruler2.getRules(""),a=n.length;for(let t=0;t<a;t++)n[t](i)},Po.prototype.State=ho;const Bo={fuzzyLink:!0,fuzzyEmail:!0,fuzzyIP:!1};const Mo={"http:":{validate:function(t,e,r){const o=t.slice(e);return r.re.http||(r.re.http=new RegExp("^\\/\\/"+r.re.src_auth+r.re.src_host_port_strict+r.re.src_path,"i")),r.re.http.test(o)?o.match(r.re.http)[0].length:0}},"https:":"http:","ftp:":"http:","//":{validate:function(t,e,r){const o=t.slice(e);return r.re.no_http||(r.re.no_http=new RegExp("^"+r.re.src_auth+"(?:localhost|(?:(?:"+r.re.src_domain+")\\.)+"+r.re.src_domain_root+")"+r.re.src_port+r.re.src_host_terminator+r.re.src_path,"i")),r.re.no_http.test(o)?e>=3&&":"===t[e-3]||e>=3&&"/"===t[e-3]?0:o.match(r.re.no_http)[0].length:0}},"mailto:":{validate:function(t,e,r){const o=t.slice(e);return r.re.mailto||(r.re.mailto=new RegExp("^"+r.re.src_email_name+"@"+r.re.src_host_strict,"i")),r.re.mailto.test(o)?o.match(r.re.mailto)[0].length:0}}},Wo="biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split("|");function Zo(t){const e=t.re=function(t){const e={};t=t||{},e.src_Any=Ie.source,e.src_Cc=Ke.source,e.src_Z=Te.source,e.src_P=Je.source,e.src_ZPCc=[e.src_Z,e.src_P,e.src_Cc].join("|"),e.src_ZCc=[e.src_Z,e.src_Cc].join("|");const r="[><｜]";return e.src_pseudo_letter="(?:(?![><｜]|"+e.src_ZPCc+")"+e.src_Any+")",e.src_ip4="(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)",e.src_auth="(?:(?:(?!"+e.src_ZCc+"|[@/\\[\\]()]).)+@)?",e.src_port="(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?",e.src_host_terminator="(?=$|[><｜]|"+e.src_ZPCc+")(?!"+(t["---"]?"-(?!--)|":"-|")+"_|:\\d|\\.-|\\.(?!$|"+e.src_ZPCc+"))",e.src_path="(?:[/?#](?:(?!"+e.src_ZCc+"|"+r+"|[()[\\]{}.,\"'?!\\-;]).|\\[(?:(?!"+e.src_ZCc+"|\\]).)*\\]|\\((?:(?!"+e.src_ZCc+"|[)]).)*\\)|\\{(?:(?!"+e.src_ZCc+'|[}]).)*\\}|\\"(?:(?!'+e.src_ZCc+'|["]).)+\\"|\\\'(?:(?!'+e.src_ZCc+"|[']).)+\\'|\\'(?="+e.src_pseudo_letter+"|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!"+e.src_ZCc+"|[.]|$)|"+(t["---"]?"\\-(?!--(?:[^-]|$))(?:-*)|":"\\-+|")+",(?!"+e.src_ZCc+"|$)|;(?!"+e.src_ZCc+"|$)|\\!+(?!"+e.src_ZCc+"|[!]|$)|\\?(?!"+e.src_ZCc+"|[?]|$))+|\\/)?",e.src_email_name='[\\-;:&=\\+\\$,\\.a-zA-Z0-9_][\\-;:&=\\+\\$,\\"\\.a-zA-Z0-9_]*',e.src_xn="xn--[a-z0-9\\-]{1,59}",e.src_domain_root="(?:"+e.src_xn+"|"+e.src_pseudo_letter+"{1,63})",e.src_domain="(?:"+e.src_xn+"|(?:"+e.src_pseudo_letter+")|(?:"+e.src_pseudo_letter+"(?:-|"+e.src_pseudo_letter+"){0,61}"+e.src_pseudo_letter+"))",e.src_host="(?:(?:(?:(?:"+e.src_domain+")\\.)*"+e.src_domain+"))",e.tpl_host_fuzzy="(?:"+e.src_ip4+"|(?:(?:(?:"+e.src_domain+")\\.)+(?:%TLDS%)))",e.tpl_host_no_ip_fuzzy="(?:(?:(?:"+e.src_domain+")\\.)+(?:%TLDS%))",e.src_host_strict=e.src_host+e.src_host_terminator,e.tpl_host_fuzzy_strict=e.tpl_host_fuzzy+e.src_host_terminator,e.src_host_port_strict=e.src_host+e.src_port+e.src_host_terminator,e.tpl_host_port_fuzzy_strict=e.tpl_host_fuzzy+e.src_port+e.src_host_terminator,e.tpl_host_port_no_ip_fuzzy_strict=e.tpl_host_no_ip_fuzzy+e.src_port+e.src_host_terminator,e.tpl_host_fuzzy_test="localhost|www\\.|\\.\\d{1,3}\\.|(?:\\.(?:%TLDS%)(?:"+e.src_ZPCc+"|>|$))",e.tpl_email_fuzzy='(^|[><｜]|"|\\(|'+e.src_ZCc+")("+e.src_email_name+"@"+e.tpl_host_fuzzy_strict+")",e.tpl_link_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+e.src_ZPCc+"))((?![$+<=>^`|｜])"+e.tpl_host_port_fuzzy_strict+e.src_path+")",e.tpl_link_no_ip_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+e.src_ZPCc+"))((?![$+<=>^`|｜])"+e.tpl_host_port_no_ip_fuzzy_strict+e.src_path+")",e}(t.F),r=t.A.slice();function o(t){return t.replace("%TLDS%",e.src_tlds)}t.onCompile(),t.q||r.push("a[cdefgilmnoqrstuwxz]|b[abdefghijmnorstvwyz]|c[acdfghiklmnoruvwxyz]|d[ejkmoz]|e[cegrstu]|f[ijkmor]|g[abdefghilmnpqrstuwy]|h[kmnrtu]|i[delmnoqrst]|j[emop]|k[eghimnprwyz]|l[abcikrstuvy]|m[acdeghklmnopqrstuvwxyz]|n[acefgilopruz]|om|p[aefghklmnrstwy]|qa|r[eosuw]|s[abcdeghijklmnortuvxyz]|t[cdfghjklmnortvwz]|u[agksyz]|v[aceginu]|w[fs]|y[et]|z[amw]"),r.push(e.src_xn),e.src_tlds=r.join("|"),e.email_fuzzy=RegExp(o(e.tpl_email_fuzzy),"i"),e.link_fuzzy=RegExp(o(e.tpl_link_fuzzy),"i"),e.link_no_ip_fuzzy=RegExp(o(e.tpl_link_no_ip_fuzzy),"i"),e.host_fuzzy_test=RegExp(o(e.tpl_host_fuzzy_test),"i");const i=[];function n(t,e){throw new Error('(LinkifyIt) Invalid schema "'+t+'": '+e)}t.R={},Object.keys(t.X).forEach((function(e){const r=t.X[e];if(null===r)return;const o={validate:null,link:null};if(t.R[e]=o,"[object Object]"===Vo(r))return!function(t){return"[object RegExp]"===Vo(t)}(r.validate)?So(r.validate)?o.validate=r.validate:n(e,r):o.validate=function(t){return function(e,r){const o=e.slice(r);return t.test(o)?o.match(t)[0].length:0}}(r.validate),void(So(r.normalize)?o.normalize=r.normalize:r.normalize?n(e,r):o.normalize=function(t,e){e.normalize(t)});!function(t){return"[object String]"===Vo(t)}(r)?n(e,r):i.push(e)})),i.forEach((function(e){t.R[t.X[e]]&&(t.R[e].validate=t.R[t.X[e]].validate,t.R[e].normalize=t.R[t.X[e]].normalize)})),t.R[""]={validate:null,normalize:function(t,e){e.normalize(t)}};const a=Object.keys(t.R).filter((function(e){return e.length>0&&t.R[e]})).map(Oo).join("|");t.re.schema_test=RegExp("(^|(?!_)(?:[><｜]|"+e.src_ZPCc+"))("+a+")","i"),t.re.schema_search=RegExp("(^|(?!_)(?:[><｜]|"+e.src_ZPCc+"))("+a+")","ig"),t.re.schema_at_start=RegExp("^"+t.re.schema_search.source,"i"),t.re.pretest=RegExp("("+t.re.schema_test.source+")|("+t.re.host_fuzzy_test.source+")|@","i"),function(t){t.G=-1,t.V=""}(t)}function Lo(t,e){const r=t.G,o=t.B,i=t.V.slice(r,o);this.schema=t.M.toLowerCase(),this.index=r+e,this.lastIndex=o+e,this.raw=i,this.text=i,this.url=i}function No(t,e){const r=new Lo(t,e);return t.R[r.schema].normalize(r,t),r}function Ho(t,e){if(!(this instanceof Ho))return new Ho(t,e);var r;e||(r=t,Object.keys(r||{}).reduce((function(t,e){return t||Bo.hasOwnProperty(e)}),!1)&&(e=t,t={})),this.F=Go({},Bo,e),this.G=-1,this.B=-1,this.M="",this.V="",this.X=Go({},Mo,t),this.R={},this.A=Wo,this.q=!1,this.re={},Zo(this)}Ho.prototype.add=function(t,e){return this.X[t]=e,Zo(this),this},Ho.prototype.set=function(t){return this.F=Go(this.F,t),this},Ho.prototype.test=function(t){if(this.V=t,this.G=-1,!t.length)return!1;let e,r,o,i,n,a,s,l,b;if(this.re.schema_test.test(t))for(s=this.re.schema_search,s.lastIndex=0;null!==(e=s.exec(t));)if(i=this.testSchemaAt(t,e[2],s.lastIndex),i){this.M=e[2],this.G=e.index+e[1].length,this.B=e.index+e[0].length+i;break}return this.F.fuzzyLink&&this.R["http:"]&&(l=t.search(this.re.host_fuzzy_test),l>=0&&(this.G<0||l<this.G)&&null!==(r=t.match(this.F.fuzzyIP?this.re.link_fuzzy:this.re.link_no_ip_fuzzy))&&(n=r.index+r[1].length,(this.G<0||n<this.G)&&(this.M="",this.G=n,this.B=r.index+r[0].length))),this.F.fuzzyEmail&&this.R["mailto:"]&&(b=t.indexOf("@"),b>=0&&null!==(o=t.match(this.re.email_fuzzy))&&(n=o.index+o[1].length,a=o.index+o[0].length,(this.G<0||n<this.G||n===this.G&&a>this.B)&&(this.M="mailto:",this.G=n,this.B=a))),this.G>=0},Ho.prototype.pretest=function(t){return this.re.pretest.test(t)},Ho.prototype.testSchemaAt=function(t,e,r){return this.R[e.toLowerCase()]?this.R[e.toLowerCase()].validate(t,r,this):0},Ho.prototype.match=function(t){const e=[];let r=0;this.G>=0&&this.V===t&&(e.push(No(this,r)),r=this.B);let o=r?t.slice(r):t;for(;this.test(o);)e.push(No(this,r)),o=o.slice(this.B),r+=this.B;return e.length?e:null},Ho.prototype.matchAtStart=function(t){if(this.V=t,this.G=-1,!t.length)return null;const e=this.re.schema_at_start.exec(t);if(!e)return null;const r=this.testSchemaAt(t,e[2],e[0].length);return r?(this.M=e[2],this.G=e.index+e[1].length,this.B=e.index+e[0].length+r,No(this,0)):null},Ho.prototype.tlds=function(t,e){return t=Array.isArray(t)?t:[t],e?(this.A=this.A.concat(t).sort().filter((function(t,e,r){return t!==r[e-1]})).reverse(),Zo(this),this):(this.A=t.slice(),this.q=!0,Zo(this),this)},Ho.prototype.normalize=function(t){t.schema||(t.url="http://"+t.url),"mailto:"!==t.schema||/^mailto:/i.test(t.url)||(t.url="mailto:"+t.url)},Ho.prototype.onCompile=function(){};const Co=2147483647,Io=36,Ko=/^xn--/,Jo=/[^\0-\x7F]/,Uo=/[\x2E\u3002\uFF0E\uFF61]/g,To={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},Yo=Math.floor,Qo=String.fromCharCode;function $o(t){throw new RangeError(To[t])}function _o(t,e){const r=t.split("@");let o="";r.length>1&&(o=r[0]+"@",t=r[1]);const i=function(t,e){const r=[];let o=t.length;for(;o--;)r[o]=e(t[o]);return r}((t=t.replace(Uo,".")).split("."),e).join(".");return o+i}function ti(t){const e=[];let r=0;const o=t.length;for(;r<o;){const i=t.charCodeAt(r++);if(i>=55296&&i<=56319&&r<o){const o=t.charCodeAt(r++);56320==(64512&o)?e.push(((1023&i)<<10)+(1023&o)+65536):(e.push(i),r--)}else e.push(i)}return e}const ei=function(t,e){return t+22+75*(t<26)-((0!=e)<<5)},ri=function(t,e,r){let o=0;for(t=r?Yo(t/700):t>>1,t+=Yo(t/e);t>455;o+=Io)t=Yo(t/35);return Yo(o+36*t/(t+38))},oi=function(t){const e=[],r=t.length;let o=0,i=128,n=72,a=t.lastIndexOf("-");a<0&&(a=0);for(let r=0;r<a;++r)t.charCodeAt(r)>=128&&$o("not-basic"),e.push(t.charCodeAt(r));for(let l=a>0?a+1:0;l<r;){const a=o;for(let e=1,i=Io;;i+=Io){l>=r&&$o("invalid-input");const a=(s=t.charCodeAt(l++))>=48&&s<58?s-48+26:s>=65&&s<91?s-65:s>=97&&s<123?s-97:Io;a>=Io&&$o("invalid-input"),a>Yo((Co-o)/e)&&$o("overflow"),o+=a*e;const b=i<=n?1:i>=n+26?26:i-n;if(a<b)break;const c=Io-b;e>Yo(Co/c)&&$o("overflow"),e*=c}const b=e.length+1;n=ri(o-a,b,0==a),Yo(o/b)>Co-i&&$o("overflow"),i+=Yo(o/b),o%=b,e.splice(o++,0,i)}var s;return String.fromCodePoint(...e)},ii=function(t){const e=[],r=(t=ti(t)).length;let o=128,i=0,n=72;for(const r of t)r<128&&e.push(Qo(r));const a=e.length;let s=a;for(a&&e.push("-");s<r;){let r=Co;for(const e of t)e>=o&&e<r&&(r=e);const l=s+1;r-o>Yo((Co-i)/l)&&$o("overflow"),i+=(r-o)*l,o=r;for(const r of t)if(r<o&&++i>Co&&$o("overflow"),r===o){let t=i;for(let r=Io;;r+=Io){const o=r<=n?1:r>=n+26?26:r-n;if(t<o)break;const i=t-o,a=Io-o;e.push(Qo(ei(o+i%a,0))),t=Yo(i/a)}e.push(Qo(ei(t,0))),n=ri(i,l,s===a),i=0,++s}++i,++o}return e.join("")},ni=function(t){return _o(t,(function(t){return Jo.test(t)?"xn--"+ii(t):t}))},ai=function(t){return _o(t,(function(t){return Ko.test(t)?oi(t.slice(4).toLowerCase()):t}))};const si={default:{options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:100},components:{core:{},block:{},inline:{}}},zero:{options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["paragraph"]},inline:{rules:["text"],rules2:["balance_pairs","fragments_join"]}}},commonmark:{options:{html:!0,xhtmlOut:!0,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["blockquote","code","fence","heading","hr","html_block","lheading","list","reference","paragraph"]},inline:{rules:["autolink","backticks","emphasis","entity","escape","html_inline","image","link","newline","text"],rules2:["balance_pairs","emphasis","fragments_join"]}}}},li=/^(vbscript|javascript|file|data):/,bi=/^data:image\/(gif|png|jpeg|webp);/;function ci(t){const e=t.trim().toLowerCase();return!li.test(e)||bi.test(e)}const di=["http:","https:","mailto:"];function fi(t){const e=Ne(t,!0);if(e.hostname&&(!e.protocol||di.indexOf(e.protocol)>=0))try{e.hostname=ni(e.hostname)}catch(t){}return je(Ee(e))}function pi(t){const e=Ne(t,!0);if(e.hostname&&(!e.protocol||di.indexOf(e.protocol)>=0))try{e.hostname=ai(e.hostname)}catch(t){}return Ae(Ee(e),Ae.defaultChars+"%")}function mi(t,e){if(!(this instanceof mi))return new mi(t,e);e||pr(t)||(e=t||{},t="default"),this.inline=new Po,this.block=new go,this.core=new oo,this.renderer=new Mr,this.linkify=new Ho,this.validateLink=ci,this.normalizeLink=fi,this.normalizeLinkText=pi,this.utils=Sr,this.helpers=ur({},Or),this.options={},this.configure(t),e&&this.set(e)}mi.prototype.set=function(t){return ur(this.options,t),this},mi.prototype.configure=function(t){const e=this;if(pr(t)){const e=t;if(!(t=si[e]))throw new Error('Wrong `markdown-it` preset "'+e+'", check name')}if(!t)throw new Error("Wrong `markdown-it` preset, can't be empty");return t.options&&e.set(t.options),t.components&&Object.keys(t.components).forEach((function(r){t.components[r].rules&&e[r].ruler.enableOnly(t.components[r].rules),t.components[r].rules2&&e[r].ruler2.enableOnly(t.components[r].rules2)})),this},mi.prototype.enable=function(t,e){let r=[];Array.isArray(t)||(t=[t]),["core","block","inline"].forEach((function(e){r=r.concat(this[e].ruler.enable(t,!0))}),this),r=r.concat(this.inline.ruler2.enable(t,!0));const o=t.filter((function(t){return r.indexOf(t)<0}));if(o.length&&!e)throw new Error("MarkdownIt. Failed to enable unknown rule(s): "+o);return this},mi.prototype.disable=function(t,e){let r=[];Array.isArray(t)||(t=[t]),["core","block","inline"].forEach((function(e){r=r.concat(this[e].ruler.disable(t,!0))}),this),r=r.concat(this.inline.ruler2.disable(t,!0));const o=t.filter((function(t){return r.indexOf(t)<0}));if(o.length&&!e)throw new Error("MarkdownIt. Failed to disable unknown rule(s): "+o);return this},mi.prototype.use=function(t){const e=[this].concat(Array.prototype.slice.call(arguments,1));return t.apply(t,e),this},mi.prototype.parse=function(t,e){if("string"!=typeof t)throw new Error("Input data should be a String");const r=new this.core.State(t,this,e);return this.core.process(r),r.tokens},mi.prototype.render=function(t,e){return e=e||{},this.renderer.render(this.parse(t,e),this.options,e)},mi.prototype.parseInline=function(t,e){const r=new this.core.State(t,this,e);return r.inlineMode=!0,this.core.process(r),r.tokens},mi.prototype.renderInline=function(t,e){return e=e||{},this.renderer.render(this.parseInline(t,e),this.options,e)};const ui=new mi({html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!0,typographer:!0,quotes:"\"\"''",highlight:function(t,e){return""}});!function(t,e,r,o){const i=t.renderer.rules.table_open||function(t,e,r,o,i){return i.renderToken(t,e,r)};t.renderer.rules[`${e}_open`]=(t,e,n,a,s)=>{const l=t[e],b=l.attrIndex(r);return b<0?l.attrPush([r,o]):l.attrs&&(l.attrs[b][1]+=` ${o}`),i(t,e,n,a,s)}}(ui,"table","class","table table-striped table-responsive"),function(t,e,r){const o=t.renderer.rules.image||function(t,e,r,o,i){return i.renderToken(t,e,r)};t.renderer.rules.image=function(t,i,n,a,s){const l=t[i];return l.attrGet("width")||l.attrSet("width",`${e}`),l.attrGet("height")||l.attrSet("height",`${r}`),o(t,i,n,a,s)}}(ui,100,100);let gi=class extends Lt{markdown="";static styles=[...super.styles,l`
            blockquote {
                padding: 10px 20px;
                margin: 0 0 20px;
                font-size: 17.5px;
        ...
        `];render(){const t=ui.render(this.markdown);return T`<div>
            ${ze(t)}
        </div>`}};t([q({attribute:"markdown",type:String,reflect:!0}),e("design:type",String)],gi.prototype,"markdown",void 0),gi=t([r("markdown-it")],gi);let hi=class extends It{renderInput(){return T``}renderField(){return T`
            <div class="form-group row"><markdown-it .markdown="${this.value}"></markdown-it></div>
        `}convertToInput(t){return t}convertToValue(t){return"string"!=typeof t?"":t}};hi=t([r("fz-markdown")],hi);let vi=class extends It{renderInput(){return T`<div class="input-group" >${this.value}</div>`}convertToInput(t){return null==t||""==t?null:t}convertToValue(t){return Vt(t)?this.empty:t}connectedCallback(){super.connectedCallback(),null==this.value&&(this.value=we())}};vi=t([r("fz-uuid")],vi);let xi=class extends Kt{renderEnum(){return T`
            <div class="dropdown">
                <input  
                    id="query"
                    class="form-control" 
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const{I:Di}=dt,zi=()=>document.createComment(""),Fi=(t,e,r)=>{const o=t._$AA.parentNode,i=void 0===e?t._$AB:e._$AA;if(void 0===r){const e=o.insertBefore(zi(),i),n=o.insertBefore(zi(),i);r=new Di(e,n,t,t.options)}else{const e=r._$AB.nextSibling,n=r._$AM,a=n!==t;if(a){let e;r._$AQ?.(t),r._$AM=t,void 0!==r._$AP&&(e=t._$AU)!==n._$AU&&r._$AP(e)}if(e!==i||a){let t=r._$AA;for(;t!==e;){const e=t.nextSibling;o.insertBefore(t,i),t=e}}}return r},Ai=(t,e,r=t)=>(t._$AI(e,r),t),qi={},ji=t=>{t._$AP?.(!1,!0);let e=t._$AA;const r=t._$AB.nextSibling;for(;e!==r;){const t=e.nextSibling;e.remove(),e=t}},Ei=(t,e,r)=>{const o=new Map;for(let i=e;i<=r;i++)o.set(t[i],i);return o},Ri=Tt(class extends Yt{constructor(t){if(super(t),t.type!==Ut)throw Error("repeat() can only be used in text expressions")}dt(t,e,r){let o;void 0===r?r=e:void 0!==e&&(o=e);const i=[],n=[];let a=0;for(const e of t)i[a]=o?o(e,a):a,n[a]=r(e,a),a++;return{values:n,keys:i}}render(t,e,r){return this.dt(t,e,r).values}update(t,[e,r,o]){const i=(t=>t._$AH)(t),{values:n,keys:a}=this.dt(e,r,o);if(!Array.isArray(i))return this.ut=a,n;const s=this.ut??=[],l=[];let b,c,d=0,f=i.length-1,p=0,m=n.length-1;for(;d<=f&&p<=m;)if(null===i[d])d++;else if(null===i[f])f--;else if(s[d]===a[p])l[p]=Ai(i[d],n[p]),d++,p++;else if(s[f]===a[m])l[m]=Ai(i[f],n[m]),f--,m--;else if(s[d]===a[m])l[m]=Ai(i[d],n[m]),Fi(t,l[m+1],i[d]),d++,m--;else if(s[f]===a[p])l[p]=Ai(i[f],n[p]),Fi(t,i[d],i[f]),f--,p++;else if(void 0===b&&(b=Ei(a,p,m),c=Ei(s,d,f)),b.has(s[d]))if(b.has(s[f])){const e=c.get(a[p]),r=void 0!==e?i[e]:null;if(null===r){const e=Fi(t,i[d]);Ai(e,n[p]),l[p]=e}else l[p]=Ai(r,n[p]),Fi(t,i[d],r),i[e]=null;p++}else ji(i[f]),f--;else ji(i[d]),d++;for(;p<=m;){const e=Fi(t,l[m+1]);Ai(e,n[p]),l[p++]=e}for(;d<=f;){const t=i[d++];null!==t&&ji(t)}return this.ut=a,((t,e=qi)=>{t._$AH=e})(t,l),Y}});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Xi=class extends wi{content;validator;renderField(){return T`
            <div class="form-group row">
                ${this.renderLabel}
                <div class="col-sm">
                    <ul id="content" class="list-group"   style="max-height: 300px; overflow-y: scroll">
                            ${Ri(this.getItems(),(t=>t),(t=>T`
            ...
            </div>`}check(){if(this.validator){switch(this.valid=!0,this.message="",!0){case this.required&&null==this.value:this.valid=!1,this.message=Bt("valueMissing");break;case!this.required&&null==this.value:break;default:this.valid=this.validator.validate(this.value);const t=this.validator.errors()?.filter((t=>1===t.instancePath.match(/\//g)?.length));0==this.valid&&t&&t.length>0&&(this.message=this.validator.errorsText(t))}this.content=this.shadowRoot?.getElementById("content")??void 0,this.content?.classList.add(this.valid?"valid":"invalid"),this.content?.classList.remove(this.valid?"invalid":"valid")}}connectedCallback(){super.connectedCallback(),this.addEventListener("update",(()=>{this.check()}))}update(t){if(!this.validator&&t.has("schema")&&0!==Object.keys(this.schema).length){const t=JSON.stringify(this.schema,Gt);this.validator=new wt(JSON.parse(t)),this.check()}super.update(t)}toggle(t){if(null==this.value&&(this.value=[]),this.value.includes(t)){const e=this.value.indexOf(t);e>=0&&this.value.splice(e,1)}else this.value.push(t)}convertToInput(t){throw new Error("IMPOSSIBLE : PAS D'INPUT POUR LES ENUM-ARRAY!")}convertToValue(t){return Vt(t)?this.empty:t}getItems(){const t=this.schema.items?.enum;if(t)return t.reduce(((t,e)=>(this.evalExpr("filter",this.schema.items,e,this.data[this.key],-1)&&t.push({label:String(e),value:e}),t)),[]);const e=this.schema.items?.oneOf;return e?e.reduce(((t,e)=>(this.evalExpr("filter",e,e.const,this.data[this.key],-1)&&t.push({label:e.title??e.description??e.const,value:e.const}),t)),[]):[]}};Xi=t([r("fz-enum-array")],Xi);let Pi=class extends Lt{modal;backdrop;validable=!1;#f="Dialogue";get modalTitle(){return this.#f}set modalTitle(t){this.#f=t}#p="Valider";get okLabel(){return this.#p}set okLabel(t){this.#p=t}#m="Annuler";get dismissLabel(){return this.#m}set dismissLabel(t){this.#m=t}static get styles(){return[...super.styles,l`
            .modal-body {
            ...
            `}stopEvent(t){t.preventDefault(),t.stopPropagation()}close(t){this.video&&(this.video?.pause(),this.video.srcObject=null);const e=t.detail;t.detail.dismissed||(t.detail.code=this.code),this.dispatchEvent(new CustomEvent("close",{detail:e})),this.modal?.valid(!1)}firstUpdated(){BarcodeDetector&&(this.detector=new BarcodeDetector({formats:Vi})),this.modal=this.shadowRoot?.querySelector("fz-dialog"),this.video=this.shadowRoot?.querySelector("video"),this.video?.addEventListener("play",(t=>this.scan()))}async initCamera(){try{const t=await navigator.mediaDevices.getUserMedia({video:{facingMode:{exact:"environment"}}});this.video&&(this.video.srcObject=t)}catch(t){this.status=`Unable to initialize Camera : ${String(t)}`}}scan(){this.setState(Gi.scanning);const t=async()=>{try{(await this.detector.detect(this.video)).filter((t=>t.rawValue)).forEach((t=>{this.code=t.rawValue,this.setState(Gi.done)}))}catch(t){console.error(String(t))}},e=()=>{this.state===Gi.scanning&&(requestAnimationFrame(e),t())};e()}async open(){this.setState(Gi.notready),this.modal&&this.modal.open(),await this.initCamera()}setState(t){switch(this.state=t,this.modal?.valid(!1),t){case Gi.fail:this.status=`${this.state} ⇨ Pas de flux video`;break;case Gi.notready:this.status=`${this.state} ⇨ En initialisation`;break;case Gi.scanning:this.status=`${this.state} ⇨ Scannez`;break;case Gi.done:this.status=`${this.state} ⇨ Resultat: ${this.code}`,this.modal?.valid(!0)}}};var Oi;t([j(),e("design:type",Number)],Si.prototype,"state",null),Si=t([r("fz-barcode-dlg")],Si),function(t){t[t.notready=0]="notready",t[t.video=1]="video",t[t.lowres=2]="lowres",t[t.hires=3]="hires"}(Oi||(Oi={}));let Bi=class extends Lt{#l=Oi.video;get state(){return this.#l}set state(t){this.#l=t}modal;video;canvas;imageCapture;imageBitmap;status="Initializing";get isVideo(){return this.state===Oi.video}static get styles(){return[...super.styles,l`
            div {
                color: black
            }
            `]}render(){return T`
            ...
            `}stopEvent(t){t.preventDefault(),t.stopPropagation()}close(t){this.video&&(this.video?.pause(),this.video.srcObject=null,this.imageCapture?.track.stop());const e=t.detail;this.canvas?.toBlob((r=>{if(!r)return;const o=URL.createObjectURL(r);t.detail.dismissed||(t.detail.imageBitmap=this.imageBitmap,t.detail.url=o,t.detail.blob=r),this.dispatchEvent(new CustomEvent("close",{detail:e})),this.imageBitmap=void 0,this.modal?.valid(!1)}),"image/png",.8)}firstUpdated(){this.modal=this.shadowRoot?.querySelector("fz-dialog"),this.video=this.shadowRoot?.querySelector("video"),this.canvas=this.shadowRoot?.querySelector("canvas")}getUserMedia(){navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}).then((t=>{if(this.video){this.video.srcObject=t;const e=t.getVideoTracks()[0];this.imageCapture=new ImageCapture(e),this.setState(Oi.video)}})).catch((t=>this.status=`Unable to initialize Camera : ${String(t)}`))}retry(t){t.preventDefault(),t.stopPropagation(),this.imageBitmap=void 0,this.modal?.valid(!1),this.setState(Oi.video)}takePhotoLowres(t){t.preventDefault(),t.stopPropagation(),this.imageCapture&&this.imageCapture.grabFrame().then((t=>{this.imageBitmap=t,this.modal?.valid(!0),this.drawCanvas(),this.setState(Oi.lowres)})).catch((t=>this.status=`Unable to grab Lowres photo : ${String(t)}`))}takePhotoHires(t){t.preventDefault(),t.stopPropagation(),this.imageCapture&&this.imageCapture.takePhoto().then((t=>createImageBitmap(t))).then((t=>{this.imageBitmap=t,this.modal?.valid(!0),this.drawCanvas(),this.setState(Oi.hires)})).catch((t=>this.status=`Unable to grab Hires photo : ${String(t)}`))}drawCanvas(){if(!this.canvas||!this.video||!this.imageBitmap)return;this.canvas.width=this.video.offsetWidth,this.canvas.height=this.video.offsetHeight;const t=Math.min(this.canvas.width/this.imageBitmap.width,this.canvas.height/this.imageBitmap.height),e=(this.canvas.width-this.imageBitmap.width*t)/2,r=(this.canvas.height-this.imageBitmap.height*t)/2;this.canvas.getContext("2d")?.clearRect(0,0,this.canvas.width,this.canvas.height),this.canvas.getContext("2d")?.drawImage(this.imageBitmap,0,0,this.imageBitmap.width,this.imageBitmap.height,e,r,this.imageBitmap.width*t,this.imageBitmap.height*t)}open(){this.setState(Oi.notready),this.modal&&this.modal.open(),this.getUserMedia()}setState(t){if(this.video&&this.canvas)switch(t){case Oi.notready:this.video.style.display="block",this.canvas.style.display="none",this.status="NOTREADY";break;case Oi.video:this.video.style.display="block",this.canvas.style.display="none",this.status="VIDEO";break;case Oi.lowres:this.video.style.display="none",this.canvas.style.display="block",this.status=`IMAGE LOWRES : ${this.imageBitmap?.width} x ${this.imageBitmap?.height} px`;break;case Oi.hires:this.video.style.display="none",this.canvas.style.display="block",this.status=`IMAGE HIRES : ${this.imageBitmap?.width} x ${this.imageBitmap?.height} px`}this.state=t}};t([j(),e("design:type",Number)],Bi.prototype,"state",null),Bi=t([r("fz-photo-dlg")],Bi);let Mi=class extends Lt{#u=null;get reference(){return this.#u}set reference(t){this.#u=t}modal;arraySchema;itemSchema;array;index;pointer;refname;static get styles(){return[...super.styles,l`
            div {
                color: black
            }
            `]}render(){return T`
            ...
            </fz-dialog>`}updated(t){this.reference?(this.pointer=this.reference?.pointer,this.array=this.reference?.refarray,this.refname=this.reference?.refname,this.arraySchema=Rt(this.array)):(this.pointer=void 0,this.array=void 0,this.refname=void 0,this.arraySchema=void 0,this.itemSchema=void 0)}toggleDropdown(){const t=this.shadowRoot?.querySelector(".dropdown-menu");t?.style.setProperty("display","block"==t?.style.display?"none":"block")}addItem(t){this.itemSchema=t;const e=vt(this.array,this.itemSchema);this.index=this.array?.length,this.array?.push(e),this.modal?.valid(),this.requestUpdate()}stopEvent(t){t.preventDefault(),t.stopPropagation()}close(t){const e=t.detail;if(!t.detail.dismissed){const e=this.shadowRoot?.getElementById("form-object");t.detail.value=e.value[this.refname??"id"],t.detail.abstract=e.abstract()}this.reference=null,this.stopEvent(t),this.dispatchEvent(new CustomEvent("close",{detail:e})),this.modal?.valid(!1)}firstUpdated(){this.modal=this.shadowRoot?.querySelector("fz-dialog")}open(){this.modal&&this.modal.open(),this.arraySchema?.homogeneous&&void 0===this.index&&this.addItem(this.arraySchema?.items)}};function Wi(t,e,r){if(!t||!e)return;const o=/\$\`([^`]+)`/g;let i;for(;null!=(i=o.exec(r));){const r=yt(t,e,i[1]);r&&!r.observers.includes(e.pointer)&&r.observers.push(e.pointer)}}t([q({type:Object}),e("design:type",Object)],Mi.prototype,"reference",null),Mi=t([r("fz-item-dlg")],Mi);class Zi{root;steps_pass1;steps_pass2;errors=[];constructor(t,e,r){this.root=t,this.steps_pass1=[new Ni(this.root),new Hi(this.root),new Ci(this.root,e),new Ii(this.root),new Ki(this.root),new Ji(this.root),new Ui(this.root),new Ti(this.root),new Yi(this.root),new Qi(this.root),new $i(this.root),new _i(this.root),new tn(this.root)],this.steps_pass2=[new en(this.root,r),new rn(this.root,"abstract",Ot),new on(this.root,"case",(()=>!1)),new on(this.root,"visible",(()=>!0)),new on(this.root,"readonly",(()=>!1)),new on(this.root,"requiredWhen",(()=>!1)),new on(this.root,"collapsed",(()=>!1)),new on(this.root,"filter",(()=>!0)),new nn(this.root,"orderBy",(()=>!0)),new nn(this.root,"expression",(()=>"")),new nn(this.root,"change",(()=>""))]}compile(){return this.errors=[],this.walkSchema(this.steps_pass1,this.root),this.walkSchema(this.steps_pass2,this.root),this.errors}walkSchema(t,e,r,o){for(const i of t)try{i.appliable(e,r,o)&&i.apply(e,r,o)}catch(t){this.errors.push(String(t))}return e.properties?Object.entries(e.properties).forEach((([r,o])=>this.walkSchema(t,o,e,r))):e.items?(e.items.oneOf||e.items.allOf||e.items.anyOf,this.walkSchema(t,e.items,e,"*")):e.oneOf?e.oneOf.forEach((e=>this.walkSchema(t,e,r,o))):e.allOf?e.allOf.forEach((e=>this.walkSchema(t,e,r,o))):e.anyOf?e.anyOf.forEach((e=>this.walkSchema(t,e,r,o))):void 0}}class Li{static sourceCount=1;root;property;constructor(t,e){this.root=t,this.property=e}appliable(t,e,r){return!0}sourceURL(t){let e=`_FZ_${this.property}_${t??""}_${Li.sourceCount++}.js`.replace(/ +/g,"_");return e=e.replace(/[^a-z0-9_]/gi,""),console.log(`builded source :${e}`),`\n    //# sourceURL=${e}\n`}error(t){return Error(`Compilation step ${this.property}: ${t} `)}}class Ni extends Li{constructor(t){super(t,"$ref")}apply(t){const e=t.properties;e&&Object.entries(e).forEach((([t,r])=>r.$ref&&(e[t]=this.definition(r)))),t.items&&t.items.$ref&&(t.items=this.definition(t.items)),t.items&&t.items.oneOf&&(t.items.oneOf=t.items.oneOf.map((t=>t.$ref?this.definition(t):t)))}definition(t){const e=t.$ref;if(!e.startsWith("#/definitions/"))throw this.error(`only '#/definitions/<name>' allowed => ${e}]`);if(!this.root.definitions)throw this.error('No "definitions" property in root schema');const r=e.split("/")[2];if(r in this.root.definitions){const e=this.root.definitions[r],o=Object.assign({},e);return Object.entries(t).forEach((([t,e])=>"$ref"!==t&&(o[t]=e))),o}throw this.error(`No definitions found in schema for ${e}`)}}class Hi extends Li{constructor(t){super(t,"basetype")}appliable(t){return!(this.property in t)}apply(t,e,r){if(Array.isArray(t.type)&&e&&r){if(t.type.length>2)throw Error(`multiple types not implemented : ${Dt(e,r)}`);if(!t.type.includes("null"))throw Error(`Second type must be "null" : ${Dt(e,r)}`);t.basetype=t.type.find((t=>"null"!==t))??"null",t.nullAllowed=!0}else t.basetype=t.type,t.nullAllowed=!1}}class Ci extends Li{options;constructor(t,e){super(t,"enumRef"),this.options=e}appliable(t){return this.property in t}apply(t){if(!this.options.ref)throw Error("missing 'enumRef' function in options");const e=this.options.ref(t.enumRef).map((t=>({const:t.value,title:t.title})));t.oneOf=e}}class Ii extends Li{constructor(t){super(t,"isenum")}appliable(t){return!(this.property in t)}apply(t){switch(t.isenum=!1,!0){case!gt(t.basetype):break;case!!t.enum:case t.oneOf&&t.oneOf.every((t=>"const"in t)):case t.anyOf&&t.anyOf.every((t=>"const"in t)):t.filter||(t.filter=()=>!0),t.isenum=!0}}}class Ki extends Li{constructor(t){super(t,"isenumarray")}appliable(t){return!(this.property in t)}apply(t){t.isenumarray=gt(t.basetype)&&function(t){if("array"===t.basetype&&t.uniqueItems){if(t.items.oneOf)return!!t.items.oneOf.every((t=>"const"in t));if(t.items.anyOf)return!!t.anyOf.every((t=>"const"in t))}return!1}(t)}}class Ji extends Li{constructor(t){super(t,"homogeneous")}appliable(t){return!(this.property in t)&&"array"===t.basetype}apply(t){t.homogeneous=!t.items.oneOf}}class Ui extends Li{constructor(t){super(t,"observers")}appliable(t){return!(this.property in t)}apply(t){t.observers=[]}}class Ti extends Li{constructor(t){super(t,"parent")}appliable(t){return!(this.property in t)}apply(t,e){t.parent=e}}class Yi extends Li{constructor(t){super(t,"pointer")}appliable(t){return!(this.property in t)}apply(t,e,r){t.pointer=e?`${e.pointer}/${r}`:"#"}}class Qi extends Li{constructor(t){super(t,"root")}appliable(t){return!(this.property in t)}apply(t){t.root=this.root}}class $i extends Li{constructor(t){super(t,"requiredWhen")}appliable(t){return"object"===t.basetype&&null!=t.properties&&null!=t.required}apply(t){t.required.forEach((e=>{e in t.properties&&(t.properties[e].requiredWhen="true")}))}}class _i extends Li{constructor(t){super(t,"field")}appliable(t){return!(this.property in t)}apply(t){if("const"in t)return t.field="fz-constant";if(t.refTo&&gt(t.basetype))return t.filter||(t.filter=()=>!0),t.field="fz-enum";if(t.isenum)switch(t.filter||(t.filter=()=>!0),!0){case t.enum?.length<=3:case t.oneOf?.length<=3:case t.anyOf?.length<=3:return t.field="fz-enum-check";case t.enum?.length<=20:case t.oneOf?.length<=20:case t.anyOf?.length<=20:return t.field="fz-enum";default:return t.field="fz-enum-typeahead"}switch(t.basetype){case"object":return t.field="fz-object";case"array":return t.isenumarray?(t.filter||(t.filter=()=>!0),t.field="fz-enum-array"):t.field="fz-array";case"integer":return t.minimum&&t.maximum&&t.maximum-t.minimum<=10?t.field="fz-range":t.field="fz-integer";case"number":return t.field="fz-float";case"boolean":return t.field="fz-boolean";case"string":switch(t.format){case"uuid":return t.field="fz-uuid";case"signature":return t.field="fz-signature";case"date":return t.field="fz-date";case"time":return t.field="fz-time";case"date-time":return t.field="fz-datetime";case"geo":return t.field="fz-geolocation";case"doc":return t.field="fz-document";case"markdown":return t.field="fz-markdown";case"asset":return t.field="fz-asset"}return!t.format&&t.maxLength>256?t.field="fz-textarea":t.field="fz-string"}return t.field="fz-error"}}class tn extends Li{constructor(t){super(t,"order")}appliable(t){return!(this.property in t)&&"object"===t.basetype&&null!=t.properties}apply(t){const e=t.properties,r=new Map,o=new Map;let i=0;const n=Object.entries(e).map((([t,e])=>{e.tab&&!o.has(e.tab)&&o.set(e.tab,i);const n=e.tab?o.get(e.tab):i;e.group&&!r.has(e.group)&&r.set(e.group,i);return{tabnum:n,groupnum:e.group?r.get(e.group):i,fieldnum:i++,fieldname:t,schema:e,tabname:e.tab,groupname:e.group}}));n.sort(((t,e)=>{const r=Math.min(t.tabnum,t.groupnum,t.fieldnum)-Math.min(e.tabnum,e.groupnum,e.fieldnum);return 0===r?t.fieldnum-e.fieldnum:r})),t.order=n}}class en extends Li{data;constructor(t,e){super(t,"enumRef"),this.data=e}appliable(t){return this.property in t&&"function"!=typeof t.refTo}apply(t){const e=t.refTo;t.refTo=()=>null;const r=e.replace(/\/[^/]+$/,""),o=e.substr(r.length+1);Wi(this.root,t,`$\`${r}\``),t.refTo=(t,e,i,n,a)=>{const s=kt(this.data.content,i,n,r);return s?Array.isArray(s)?{pointer:r,refname:o,refarray:s}:(console.error(`reference list must be an array ${r}`),null):null}}}class rn extends Li{defunc;constructor(t,e,r){super(t,e),this.defunc=r}appliable(t){return this.property in t&&"string"==typeof t[this.property]}apply(t,e,r){const o=t[this.property];if(t[this.property]=this.defunc,"string"==typeof o){const e=`\n                ${this.sourceURL(r)}\n                try { \n                    return nvl\`${o}\`\n                } catch(e) { \n                    console.error(\`unable to produce ${this.property} property due to :\${e.toString()}\`)\n                }\n                return ''\n            `;try{Wi(this.root,t,o),t[this.property]=new Function("schema","value","parent","property","$","userdata",e),t[this.property].expression=o}catch(t){throw Error(`unable to compile ${this.property} expression "${o}" due to ::\n\t=>${String(t)}`)}}}}class on extends Li{defunc;constructor(t,e,r){super(t,e),this.defunc=r}appliable(t){return this.property in t&&["string","boolean"].includes(typeof t[this.property])}apply(t,e,r){const o=t[this.property];if(t[this.property]=this.defunc,"boolean"==typeof o||null===o)t[this.property]=null===o?()=>null:()=>o;else if("string"==typeof o){const e=`\n            ${this.sourceURL(r)}\n            try {  \n                    const result = (${o}) \n\n                    return result === null ? result : !!result\n                }\n                catch(e) {  console.error(\`unable to produce ${this.property} property due to :\n\t=>\${e.toString()}\`) }\n                return true\n            `;try{Wi(this.root,t,o),t[this.property]=new Function("schema","value","parent","property","$","userdata",e),t[this.property].expression=o}catch(t){throw Error(`unable to compile ${this.property} expression "${o}" due to ::\n\t=>${String(t)}`)}}}}class nn extends Li{defunc;constructor(t,e,r){super(t,e),this.defunc=r}appliable(t){return this.property in t&&"function"!=typeof t[this.property]}apply(t,e,r){const o=t[this.property];t[this.property]=this.defunc;let i="return null";switch(!0){case"boolean"==typeof o:i=o?"return true ;":"return false ;";break;case"string"==typeof o:i=`return ${o} ;`;break;case Array.isArray(o):const t=o.map(((t,e)=>`    const cst${e} = \`${t}\n\``));t.push(`return ( ${o.map(((t,e)=>`cst${e}`)).join(" + ")} );`),i=t.join(";\n")}const n=`\n            try {  \n                ${i} \n            }\n            catch(e) {  console.error(\`unable to produce ${this.property} property due to :\n\t=>\${e.toString()}\`) }\n            return null\n            ${this.sourceURL(r)}\n        `;try{Array.isArray(o)&&o.forEach((e=>Wi(this.root,t,e))),"string"==typeof o&&Wi(this.root,t,o),t[this.property]=new Function("schema","value","parent","property","$","userdata",n),t[this.property].expression=o}catch(t){console.error(`unable to compile ${this.property} expression "${o}" due to ::\n\t=>${String(t)}`)}}}class an{data;schema;steps;errors=[];constructor(t,e){this.data=t,this.schema=e,this.steps=[(t,e,r,o)=>{Et(t,e),Xt(t,r),Pt(t,this.data.content)}]}compile(){return this.errors=[],this.walkData(this.data.content,this.schema),this.errors}walkData(t,e,r,o){if(null!=e&&null!=t){try{this.steps.forEach((i=>i(t,e,r,o)))}catch(t){this.errors.push(String(t))}if(Array.isArray(t))e.homogeneous?t.forEach((r=>this.walkData(r,e.items,t,e))):t.forEach(((r,o)=>{e.items.oneOf.forEach((e=>{e.case&&e.case(null,r,t,o,(()=>null))&&this.walkData(r,e,t,e)}))}));else if("object"!=typeof t);else for(const r in t){const o=e.properties[r];this.walkData(t[r],o,t,e)}}}}class sn{store;constructor(t){this.store=t}async put(t,e,r,o){try{return this.store.put?.(t,e,r,o)}catch(e){console.error(`storage: unable to put blob for uuid=${t} ptr=${o}\n    - ${String(e)}`)}}async remove(t){try{return this.store.remove?.(t)}catch(e){console.error(`storage: unable to remove blob for uuid=${t}\n    - ${String(e)}`)}}async get(t){try{return this.store.get?.(t)??null}catch(e){return console.error(`storage: unable to get blob for uuid=${t}\n    - ${String(e)}`),null}}}class ln{cacheName;cache;constructor(t){this.cacheName=t}available(){return"caches"in self}async open(){this.available()&&(this.cache=await caches.open(this.cacheName))}async findKey(t){const e=await(this.cache?.keys())??[];for(const r of e)if(r.url.includes(t)){const e=new URL(r.url),o=e.searchParams.get("name")??"",i=await(this.cache?.match(e,{ignoreSearch:!0})),n=await(i?.blob());if(null!=n)return{uuid:t,blob:n,filename:o}}return null}async put(t,e,r,o){const i=`/${t}?name=${r}`;await this.open(),await(this.cache?.put(i,new Response(e)))}async remove(t){await this.open(),await(this.cache?.delete(`/${t}`,{ignoreSearch:!0}))}async get(t){await this.open();const e=await this.findKey(t);return e||null}}let bn=class extends Lt{#g={};get i_options(){return this.#g}set i_options(t){this.#g=t}#h={content:{}};get obj(){return this.#h}set obj(t){this.#h=t}#v={type:"object",properties:[]};get i_schema(){return this.#v}set i_schema(t){this.#v=t}#x="Ok";get submitlabel(){return this.#x}set submitlabel(t){this.#x=t}#w="Cancel";get cancellabel(){return this.#w}set cancellabel(t){this.#w=t}#y=!1;get buttonsVisible(){return this.#y}set buttonsVisible(t){this.#y=t}#k="";get idData(){return this.#k}set idData(t){this.#k=t}#D=!1;get readonly(){return this.#D}set readonly(t){this.#D=t}#z=!1;get notValidate(){return this.#z}set notValidate(t){this.#z=t}#F=null;get _errors(){return this.#F}set _errors(t){this.#F=t}store=new ln("FZ-FORM");asset;validator;dataPointerFieldMap=new Map;schemaPointerFieldMap=new Map;message="";observedChangedHandler;constructor(){super(),this.observedChangedHandler=t=>this.observedChange(t)}get root(){return this.obj.content}get schema(){return this.i_schema}set schema(t){this.i_schema=JSON.parse(JSON.stringify(t)),this.validator=new wt(this.i_schema),this.validator.validate(this.obj.content)?(this._errors=null,this.message="",this.compile(),this.requestUpdate()):(this._errors=[],this.message="L'attribut 'data' n'est plus valide vis à vis du schema")}get options(){return this.i_options}set options(t){this.i_options=t,this.i_options?.storage&&(this.store=new sn(this.i_options.storage)),this.i_options?.asset&&(this.asset=this.i_options.asset)}get data(){return function(t){const e=JSON.stringify(t,(function(t,e){const r=Rt(e),o=Rt(this);if(!o?.properties?.[t]?.transient)return r&&Array.isArray(e)&&0===e.length||r&&null!=e&&"object"==typeof e&&Object.keys(e).every((t=>null==e[t]))?r.nullAllowed?null:void 0:e}));return null==e?null:JSON.parse(e)}(this.obj.content)}set data(t){this.validator?this.notValidate||this.validator.validate(t)?(this.message="",this._errors=null,this.obj.content=t,this.compile(),this.requestUpdate()):(this._errors=this.validator?.errors()||null,this.message="L'attribut 'data' n'est pas un JSON valide vis à vis de l'attribut schema."):this.message="L'attribut 'schema' n'est pas un JSON Schema Form valide."}get valid(){return!!this.validator&&this.validator.validate(this.obj.content)}attributeChangedCallback(t,e,r){if(super.attributeChangedCallback(t,e,r),"schema"===t){const t=ht.fromAttribute(r);this.schema=t}}static get styles(){return[...super.styles]}render(){return T`
            ${this._errors?.length?T`Error(s): <hr><p class="error-message"> ${this.message}</p><pre><ol>
                ${this._errors.map((t=>T`<li>Dans la propriété : ${null==t.dataPath?t.instancePath:t.dataPath} : ${t.keyword} ➜ ${t.message}</li>`))}</ol></pre>`:T`
                    ...
                    ${!this._errors&&this.buttonsVisible?T`<hr><div class="d-flex justify-content-end">
                        ...
                        </div>`:T``}`}`}connectedCallback(){super.connectedCallback(),this.addEventListener("observed-changed",this.observedChangedHandler)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("observed-changed",this.observedChangedHandler)}addField(t,e,r){this.schemaPointerFieldMap.set(t,r),this.dataPointerFieldMap.set(e,r)}removeField(t,e){this.schemaPointerFieldMap.delete(t),this.dataPointerFieldMap.delete(e)}getfieldFromSchema(t){return this.schemaPointerFieldMap.get(t)}getfieldFromData(t){return this.dataPointerFieldMap.get(t)}updateField(t){this.getfieldFromData(t)?.requestUpdate()}observedChange(t){if(this===t.composedPath()[0])return;t.detail.observers.forEach((t=>{const e=this.getfieldFromSchema(t);e?.requestUpdate()}))}confirm(t){const e=new CustomEvent("submit",{detail:{data:this.data,schema:this.schema}});this.dispatchEvent(e),t.preventDefault(),t.stopPropagation()}cancel(t){const e=new CustomEvent("cancel",{detail:{data:this.data,schema:this.schema}});this.dispatchEvent(e),t.preventDefault(),t.stopPropagation()}compile(){const t=new Zi(this.schema,this.options,this.obj.content).compile();if(t.length>0)return this.message=`Schema compilation failed: \n    - ${t.join("\n    - ")}`,void console.error(this.message);const e=new an(this.obj.content,this.schema).compile();e.length>0&&(this.message=`Data compilation failed: \n    - ${e.join("\n    - ")}`,console.error(this.message))}};t([j(),e("design:type",Object)],bn.prototype,"i_options",null),t([j(),e("design:type",Object)],bn.prototype,"obj",null),t([q({type:Object,attribute:"schema",converter:ht}),e("design:type",Object)],bn.prototype,"i_schema",null),t([q({type:String,attribute:"submit-label"}),e("design:type",Object)],bn.prototype,"submitlabel",null),t([q({type:String,attribute:"cancel-label"}),e("design:type",Object)],bn.prototype,"cancellabel",null),t([q({type:Boolean,attribute:"buttons-visible"}),e("design:type",Object)],bn.prototype,"buttonsVisible",null),t([q({type:String,attribute:"id-data"}),e("design:type",Object)],bn.prototype,"idData",null),t([q({type:Boolean,attribute:"readonly"}),e("design:type",Object)],bn.prototype,"readonly",null),t([q({type:Boolean,attribute:"not-validate"}),e("design:type",Object)],bn.prototype,"notValidate",null),t([j(),e("design:type",Object)],bn.prototype,"_errors",null),bn=t([r("fz-form"),e("design:paramtypes",[])],bn);export{bn as FzForm,gi as FzMarkdownIt};
